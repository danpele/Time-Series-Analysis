% Capitolul 8: Extensii Moderne în Analiza Seriilor de Timp
...
% TITLE INFORMATION
%=============================================================================
\title[Capitolul 8: Extensii Moderne]{Capitolul 8: Extensii Moderne}
...
\begin{frame}{Obiective de Învățare}
    \begin{block}{La finalul acestui capitol, veți fi capabili să:}
        \begin{enumerate}
            ...
            \item Aplicați \textbf{Random Forest} pentru prognoza seriilor de timp
            \item Construiți rețele \textbf{LSTM} pentru serii temporale
            \item Comparați performanța modelelor clasice vs ML
...
\begin{frame}{Pregătirea Datelor pentru Random Forest}
    \begin{block}{Feature Engineering pentru Serii de Timp}
        \begin{enumerate}
            ...
            \item \textbf{Variabile exogene}: indicatori economici, evenimente
        \end{enumerate}
    \end{block}
...
\begin{frame}{Time Series Cross-Validation}
    ...
    \begin{tikzpicture}[scale=0.7, transform shape]
        % Fold 1
        \fill[MainBlue!60] (0,4) rectangle (4,4.5);
        \fill[IDAred!60] (4,4) rectangle (5,4.5);
        \node[left] at (0,4.25) {Fold 1};

        % Fold 2
        \fill[MainBlue!60] (0,3) rectangle (5,3.5);
        \fill[IDAred!60] (5,3) rectangle (6,3.5);
        \node[left] at (0,3.25) {Fold 2};

        % Fold 3
        \fill[MainBlue!60] (0,2) rectangle (6,2.5);
        \fill[IDAred!60] (6,2) rectangle (7,2.5);
        \node[left] at (0,2.25) {Fold 3};

        % Fold 4
        \fill[MainBlue!60] (0,1) rectangle (7,1.5);
        \fill[IDAred!60] (7,1) rectangle (8,1.5);
        \node[left] at (0,1.25) {Fold 4};

        % Legend
        \fill[MainBlue!60] (2,0) rectangle (2.5,0.3);
        \node[right] at (2.5,0.15) {Train};
        \fill[IDAred!60] (5,0) rectangle (5.5,0.3);
        \node[right] at (5.5,0.15) {Test};

        % Arrow
        \draw[->, thick] (0,-0.5) -- (9,-0.5);
        \node[below] at (4.5,-0.5) {Timp};
    \end{tikzpicture}
    \end{center}
