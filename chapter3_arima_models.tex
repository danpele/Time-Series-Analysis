...
\begin{frame}{Random Walk with Drift: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{charts/ch3_def_random_walk_drift.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{First Difference: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{charts/ch3_def_difference.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Quiz Question 1: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch3_quiz1_rw_variance.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Quiz Question 2: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch3_quiz2_differencing.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Quiz Question 3: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch3_quiz3_adf_test.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Quiz Question 4: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch3_quiz4_acf_decay.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Quiz Question 5: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch3_quiz5_forecast_ci.pdf}
    \end{center}
\end{frame}
