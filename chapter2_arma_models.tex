...
\begin{frame}{Motivating Example: Stationary Processes}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch2_motivation_stationary.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Real-World Applications of ARMA}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch2_motivation_realworld.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Model Identification via ACF Patterns}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch2_motivation_acf.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{AR(p): Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{charts/ch2_def_arp.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Quiz: AR Stationarity -- Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch2_quiz_ar_stationarity.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{MA(q): Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{charts/ch2_def_maq.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Quiz: ACF/PACF Pattern Recognition -- Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch2_quiz_acf_pacf_patterns.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Quiz: Information Criteria -- Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch2_quiz_information_criteria.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Ljung-Box Test: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{charts/ch2_def_ljungbox.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Quiz: Ljung-Box Test -- Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch2_quiz_ljung_box.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Quiz: Forecast Properties -- Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch2_quiz_forecast_properties.pdf}
    \end{center}
\end{frame}
