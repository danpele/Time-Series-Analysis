...
\begin{frame}{Lag Operator: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{lag_operator.pdf}
    \end{center}
...
\begin{frame}{AR(1) Simulations: Effect of $\phi$}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{ar1_comparison.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{AR(2) Stationarity: Unit Circle Visualization}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{unit_circle_stationarity.pdf}
    \end{center}
...
\begin{frame}{AR(2) Stationarity Triangle}
    \begin{center}
        \includegraphics[width=0.75\textwidth]{ar2_stationarity_triangle.pdf}
    \end{center}

    \textbf{The stationarity region forms a triangle in the $(\phi_1, \phi_2)$ parameter space}
\end{frame}

\begin{frame}{Characteristic Polynomial Roots}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{characteristic_roots.pdf}
    \end{center}

    \textbf{Stationarity:} All roots must lie \textbf{outside} the unit circle (shaded region)
\end{frame}
...
\begin{frame}{MA(1) Simulations: Effect of $\theta$}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{ma1_comparison.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Invertibility: Visualization}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{invertibility.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{ARMA Model Structure}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{arma_structure.pdf}
    \end{center}
\end{frame}

\begin{frame}{How ARMA Simulation Works}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{arma_simulation_steps.pdf}
    \end{center}
\end{frame}

\begin{frame}{ARMA Examples}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{arma_examples.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{ACF/PACF Patterns: AR vs MA vs ARMA}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{acf_pacf_patterns.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Impulse Response Functions}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{impulse_response.pdf}
    \end{center}
...
\begin{frame}{Wold's Decomposition Theorem}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{wold_representation.pdf}
    \end{center}
...
\begin{frame}{The Box-Jenkins Methodology}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{box_jenkins_flowchart.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{AIC vs BIC: Model Selection}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{aic_bic_comparison.pdf}
    \end{center}
...
\begin{frame}{Parsimony Principle: Bias-Variance Trade-off}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{parsimony_principle.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Estimation Methods Comparison}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{estimation_comparison.pdf}
    \end{center}
\end{frame}

\begin{frame}{Yule-Walker Equations for AR(p)}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{yule_walker.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Residual Diagnostics: Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{arma_residual_diagnostics.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Ljung-Box Test: Good vs Bad Model Fit}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{ljung_box_test.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{ARMA Forecasting with Confidence Intervals}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{arma_forecast.pdf}
    \end{center}
\end{frame}

\begin{frame}{Forecast Error Variance Over Horizon}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{forecast_error_decomposition.pdf}
    \end{center}
\end{frame}
