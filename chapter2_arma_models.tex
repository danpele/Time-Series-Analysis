...
\begin{frame}[plain]
    ...
    \begin{center}
        ...
        {\LARGE\textbf{\textcolor{MainBlue}{Chapter 2: ARMA Models}}}\\[0.5cm]
...
\begin{frame}{AR(1) Simulations: Effect of $\phi$}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{ar1_comparison.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{AR(2) Stationarity Triangle}
    \begin{center}
        \includegraphics[width=0.60\textwidth]{ar2_stationarity_triangle.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{MA(1) Simulations: Effect of $\theta$}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{ma1_comparison.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Residual Diagnostics: Example}
    \begin{center}
        \includegraphics[width=0.65\textwidth]{arma_residual_diagnostics.pdf}
    \end{center}
\end{frame}
