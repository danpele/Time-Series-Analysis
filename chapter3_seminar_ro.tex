...
\begin{frame}{Test 11: Staționaritate în Trend vs Staționaritate în Diferențe}
    ...
    \begin{exampleblock}{Răspuns: B -- Eliminarea trendului determinist prin regresie}
        ...
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Staționar în trend}: Detrendare prin regresie (șocurile sunt temporare). \textbf{Staționar în diferențe}: Diferențiere (șocurile sunt permanente). Tratamentul greșit afectează modelul!
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Staționaritate Prin Diferențiere}
    ...
    \begin{itemize}
        ...
        \item Prima diferențiere a log PIB elimină trendul stocastic
...
\begin{frame}{Discuție: Trenduri Deterministe vs Stocastice}
    \begin{block}{Întrebare Cheie}
        De ce este important să distingem între trendurile deterministe și stocastice?
    \end{block}
    ...
    \begin{block}{Puncte de Discuție}
        \begin{itemize}
            \item \textbf{Consecințele tratamentului greșit}:
                \begin{itemize}
                    \item Detrendarea unei rădăcini unitare $\Rightarrow$ staționaritate falsă
            ...
            \item \textbf{Interpretare economică}:
                \begin{itemize}
                    ...
                    \item Trend stocastic: șocurile au efecte permanente
                \end{itemize}
    ...
    \begin{block}{Considerații}
        \begin{itemize}
            \item \textbf{AIC}: Minimizează eroarea de predicție, poate supraajusta
                ...
                \end{itemize}
            \item \textbf{BIC}: Selecție consistentă a modelului, mai parsimonios
                \begin{itemize}
