...
\begin{frame}[plain]
    ...
    \begin{center}
        ...
        {\Large\textcolor{MainBlue}{Fundamentals and Concepts}}
    \end{center}
    \vfill
...
\begin{frame}{STL Decomposition: Visual Illustration}
    ...
    \end{center}
    \vspace{-0.2cm}
    \small STL separates the original series into trend, seasonal, and remainder components using locally weighted regression.
\end{frame}
...
\begin{frame}{Moving Average Smoothing}
    ...
    {\footnotesize
    \begin{itemize}
        \item \textbf{Small window} (e.g., 5): Responsive to changes but noisy
        \item \textbf{Large window} (e.g., 30): Smoother but slower to react
        \item Trade-off between noise reduction and lag in detecting changes
    \end{itemize}
    }
\end{frame}
