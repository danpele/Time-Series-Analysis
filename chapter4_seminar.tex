...
\begin{frame}{Quiz 2: SARIMA Notation}
    ...
    \begin{exampleblock}{Answer: C -- ARIMA(1,1,1) with seasonal ARIMA(1,1,1) at period 12}
        \vspace{-0.4cm}
        \begin{center}
            \includegraphics[width=0.82\textwidth, height=0.3\textheight, keepaspectratio]{charts/sem4_sarima_notation.pdf}
        \end{center}
        \vspace{-0.4cm}
        {\scriptsize
...
\begin{frame}{Quiz 3: The Airline Model}
    ...
    \begin{exampleblock}{Answer: A -- 2 parameters ($\theta_1$ and $\Theta_1$)}
        \vspace{-0.4cm}
        \begin{center}
            \includegraphics[width=0.82\textwidth, height=0.27\textheight, keepaspectratio]{charts/sem4_airline_model.pdf}
        \end{center}
        \vspace{-0.4cm}
        {\scriptsize
        \textbf{Airline}: $(1-L)(1-L^{12})Y_t = (1+\theta_1 L)(1+\Theta_1 L^{12})\varepsilon_t$ -- fits many seasonal series!
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Quiz 7: Detecting Seasonality from ACF}
    ...
    \begin{exampleblock}{Answer: C -- Seasonal unit root requiring $D=1$}
        \vspace{-0.4cm}
        \begin{center}
            \includegraphics[width=0.8\textwidth, height=0.3\textheight, keepaspectratio]{charts/sem4_seasonal_acf.pdf}
        \end{center}
        \vspace{-0.4cm}
        {\scriptsize
        \textbf{Left}: Stationary seasonal (fast decay) \quad
        \textbf{Right}: Seasonal unit root (slow decay $\Rightarrow D=1$)
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Quiz 8: Multiplicative vs Additive Seasonality}
    ...
    \begin{exampleblock}{Answer: B -- Multiplicative seasonality, use $\log$ transformation}
        \vspace{-0.4cm}
        \begin{center}
            \includegraphics[width=0.8\textwidth, height=0.3\textheight, keepaspectratio]{charts/sem4_mult_add.pdf}
        \end{center}
        \vspace{-0.4cm}
        {\scriptsize
