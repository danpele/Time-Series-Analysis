...
\begin{frame}[plain]
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=south] at ([xshift=-2cm, yshift=0.8cm]current page.south) {
...
\begin{frame}{Python VAR Analysis: Key Functions}
    {\small
    \begin{block}{Essential Libraries and Functions}
        \begin{itemize}
            \item \texttt{from statsmodels.tsa.api import VAR}
            \item \texttt{from statsmodels.tsa.stattools import grangercausalitytests}
        \end{itemize}
    \end{block}
