...
\begin{frame}{Quiz 2: Number of Parameters}
    ...
    \begin{exampleblock}{Answer: C -- 7 parameters per equation}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{charts/sem5_var_parameters.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 3: Granger Causality}
    ...
    \begin{exampleblock}{Answer: B -- Past $X$ helps predict future $Y$}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.5\textheight, keepaspectratio]{charts/sem5_granger_diagram.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 5: VAR Stability}
    ...
    \begin{exampleblock}{Answer: C -- All eigenvalues of $\bA_1$ inside unit circle}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.48\textheight, keepaspectratio]{charts/sem5_var_stability.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 6: Impulse Response Functions}
    ...
    \begin{exampleblock}{Answer: B -- Effect of shock on all variables over time}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.5\textheight, keepaspectratio]{charts/sem5_irf_example.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 9: Forecast Error Variance Decomposition}
    ...
    \begin{exampleblock}{Answer: B -- Proportion of forecast error variance from each shock}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.48\textheight, keepaspectratio]{charts/sem5_fevd_example.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 11: Cholesky Decomposition}
    ...
    \begin{exampleblock}{Answer: B -- Variables ordered first affect later ones contemporaneously}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{charts/sem5_cholesky_ordering.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 12: VAR Residual Diagnostics}
    ...
    \begin{exampleblock}{Answer: B -- White noise (no autocorrelation)}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{charts/sem5_var_diagnostics.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
