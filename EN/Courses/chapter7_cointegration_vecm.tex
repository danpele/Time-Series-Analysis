...
\begin{frame}{Question 1: Answer}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item Pair B's spread is non-stationary $\succ$ not cointegrated
    \end{itemize}
    \end{exampleblock}
    }
...
\begin{frame}{Question 4: Answer}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item Cannot reject $H_0: r \leq 2$ (3.1 < 3.8) $\succ$ rank is $r = 2$
    \end{itemize}
    \end{exampleblock}
    }
...
\begin{frame}{Question 5: Answer}
    ...
    \begin{exampleblock}{Answer: (B)}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item VAR($\Delta$) loses the level relationship $\succ$ spread diverges
        \item VECM incorporates long-run equilibrium $\succ$ forecast stays coherent
    \end{itemize}
    \end{exampleblock}
    }
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        ...
        \begin{itemize}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch7} $\succ$ Python code for this chapter
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
