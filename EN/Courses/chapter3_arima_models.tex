...
\begin{frame}{Motivating Example: Non-Stationary Data Is Everywhere}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_motivation_nonstationary.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{The Solution: Differencing}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_motivation_differencing.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{ACF Diagnostic: Detecting Non-Stationarity}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_acf_nonstationary.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Differencing in Practice: GDP Example}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_differencing.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Rolling Window Illustration}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_rolling_forecast.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Case Study: US Real GDP (FRED)}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_raw_data.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Step 1: ADF Test for Stationarity}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_adf_test.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Step 2: ACF/PACF Before and After Differencing}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_acf_diff.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Step 3: ARIMA Model Comparison}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_model_comparison.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Step 4: Diagnostic Checking}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_diagnostics.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Step 5: Out-of-Sample Forecasting}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_forecast.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Step 6: Rolling Forecast with Train/Val/Test}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_rolling_forecast.pdf}
        \end{center}
    \end{columns}
\end{frame}
