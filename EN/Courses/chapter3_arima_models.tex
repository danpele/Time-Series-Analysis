...
\begin{frame}{Step 1: ADF Test for Stationarity}
    ...
    {\footnotesize
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_adf_test.pdf}
    \end{center}
...
\begin{frame}{Step 3: ARIMA Model Comparison}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch3_case_model_comparison.pdf}
    \end{center}
