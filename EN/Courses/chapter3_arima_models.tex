...
\begin{frame}{Motivating Example: Non-Stationary Data Is Everywhere}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_motivation_nonstationary.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Key Observations}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch3\_motivation\_nonstationary}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_motivation}
\end{frame}

\begin{frame}{Real-World Applications}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_motivation_realworld.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{alertblock}{The Challenge}
        Financial/economic data are typically I(1): stock prices, exchange rates, interest rates.
    \end{alertblock}
    \quantlet{TSA\_ch3\_motivation\_realworld}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_motivation}
\end{frame}

\begin{frame}{The Solution: Differencing}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_motivation_differencing.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch3\_motivation\_differencing}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_motivation}
\end{frame}
...
\begin{frame}{Visualizing the Difference}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_trend_comparison.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Random Walk: Visual Illustration}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_def_random_walk.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{alertblock}
    \quantlet{TSA\_ch3\_def\_random\_walk}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_random_walk}
\end{frame}
...
\begin{frame}{Random Walk with Drift: Visual Illustration}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_def_random_walk_drift.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch3\_def\_random\_walk\_drift}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_random_walk_drift}
\end{frame}

\begin{frame}{Simulating Random Walks}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_random_walk.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Variance Growth: Why Random Walks Are Non-Stationary}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_variance_growth.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Key Observations}
        \begin{itemize}
...
\begin{frame}{Integrated Process: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.6\textheight, keepaspectratio]{ch3_def_integrated.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{First Difference: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.6\textheight, keepaspectratio]{ch3_def_difference.pdf}
    \end{center}
    \vspace{-0.2cm}
    \small Left: non-stationary series. Right: after first difference, the series becomes stationary.
    \quantlet{TSA\_ch3\_def\_difference}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_differencing}
\end{frame}
...
\begin{frame}{ACF Diagnostic: Detecting Non-Stationarity}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_acf_nonstationary.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{ARIMA: Visual Illustration}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_def_arima.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{ADF Test: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.6\textheight, keepaspectratio]{ch3_def_adf.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Rolling Window Illustration}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Case Study: US Real GDP (FRED)}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_case_raw_data.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Step 1: ADF Test for Stationarity}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_case_adf_test.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Step 2: ACF/PACF Before and After Differencing}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_case_acf_diff.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Step 3: ARIMA Model Comparison}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_case_model_comparison.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Step 4: Diagnostic Checking}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_case_diagnostics.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Step 5: Out-of-Sample Forecasting}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_case_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Step 6: Rolling Forecast with Train/Val/Test}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_case_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{block}
    \quantlet{TSA\_ch3\_case\_rolling\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_rolling_forecast}
\end{frame}
...
\begin{frame}{Quiz Question 1: Answer}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_quiz1_rw_variance.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch3\_quiz1\_rw\_variance}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_variance_growth}
\end{frame}
...
\begin{frame}{Quiz Question 2: Answer}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_quiz2_differencing.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{exampleblock}{Correct Answer: (C) 2 times}
        I($d$) means ``integrated of order $d$'' --- requires $d$ differences for stationarity.
    \end{exampleblock}
    \quantlet{TSA\_ch3\_quiz2\_differencing}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_differencing}
\end{frame}
...
\begin{frame}{Quiz Question 3: Answer}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_quiz3_adf_test.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch3\_quiz3\_adf\_test}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_adf_test}
\end{frame}
...
\begin{frame}{Quiz Question 4: Answer}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_quiz4_acf_decay.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch3\_quiz4\_acf\_decay}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_acf_nonstationary}
\end{frame}
...
\begin{frame}{Quiz Question 5: Answer}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_quiz5_forecast_ci.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch3\_quiz5\_forecast\_ci}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3/TSA_ch3_arima_forecast}
\end{frame}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        {\small
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Quantlet}: \url{https://quantlet.com} $\rightarrow$ Statistical code repository
            \item \textbf{Quantinar}: \url{https://quantinar.com} $\rightarrow$ Quantitative methods learning platform
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch3}
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
