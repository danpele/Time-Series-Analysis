...
\begin{frame}{Random Walk with Drift}
    ...
    \begin{block}{$Y_t = \mu + Y_{t-1} + \varepsilon_t$ \quad $\Leftrightarrow$ \quad $Y_t = Y_0 + \mu t + \sum_{i=1}^{t} \varepsilon_i$}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Without drift} (blue): wanders around zero; \textbf{With drift} $\mu > 0$ (red): systematic upward trend
...
\begin{frame}{Summary}
    ...
    \begin{block}{What we learned in this chapter}
        \begin{itemize}\setlength{\itemsep}{1pt}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item ADF, PP, KPSS; Box-Jenkins: identify $\succ$ estimate $\succ$ validate
            \end{itemize}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        \begin{itemize}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch3} $\succ$ Python code for this chapter
        \end{itemize}
    \end{exampleblock}
    }
    \end{cminipage}
