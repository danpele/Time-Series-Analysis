...
\begin{frame}{Quiz Question 1}
    ...
    \begin{enumerate}[(A)]
        \item ARIMA --- captures trends and autocorrelations
        \item GARCH --- models conditional variance
        \item Prophet --- detects changepoints and seasonality
        \item VAR --- multivariate model for interdependencies
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 1: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (B) GARCH --- models conditional variance}
...
\begin{frame}{Quiz Question 2}
    \begin{cminipage}{0.95\textwidth}
    \begin{alertblock}{Question}
        A SARIMA model achieves RMSE = 0.05 on training but RMSE = 2.30 on test. What does this indicate?
    \end{alertblock}

    \vspace{0.3cm}

    \begin{enumerate}[(A)]
        \item The model is excellent --- low training error confirms quality
        \item The model suffers from overfitting --- it memorizes noise
        \item The test set is faulty and should be replaced
        \item The difference is normal --- all models have higher test error
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 2: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (B) Overfitting --- memorizes noise}
...
\begin{frame}{Quiz Question 3}
    ...
    \begin{enumerate}[(A)]
        \item To have more training data
        \item To prevent overfitting and evaluate correctly
        \item It is just a convention with no real importance
...
\begin{frame}{Quiz Question 3: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (B) Prevent overfitting and evaluate correctly}
...
\begin{frame}{Quiz Question 4}
    ...
    \begin{enumerate}[(A)]
        \item Yes --- if $X$ predicts $Y$, then $X$ causes $Y$
        \item No --- it only tests predictive content, not causation
        \item It depends on the number of lags selected
        \item Yes, if the p-value is below 0.05
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 4: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (B) No --- only predictive content, not causation}
...
\begin{frame}{Quiz Question 5}
    ...
    \begin{enumerate}[(A)]
        ...
        \item GARCH --- models variation
        \item ARIMA + Fourier terms or Prophet/TBATS
        \item VAR with 365 lags
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 5: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (C) Fourier terms / Prophet / TBATS}
        SARIMA$_{365}$ needs $\sim$730 seasonal parameters --- infeasible. Fourier terms with $K=3$ use only 6 parameters. Prophet and TBATS handle multiple seasonalities automatically.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        ...
        \begin{itemize}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA} --- Python code for this course
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
