    ...
    \begin{columns}[T]
        ...
        \begin{block}{Our results}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $K = 4$ increases error $\succ$ overfitting
            \end{itemize}
        \end{block}
    \end{columns}
\end{frame}
...
\begin{frame}{Granger Causality: Empirical Results}
    ...
    \begin{block}{Interpretation}
        ...
        \begin{exampleblock}{Economic Findings}
            \begin{itemize}
                \item Unemp $\succ$ GDP ($p=0.045$): Okun's Law
                \item Fed $\succ$ Inflation ($p=0.087$): Monetary policy transmission
                \item GDP $\succ$ Unemp: Weak evidence
            \end{itemize}
        \end{exampleblock}
    }
\end{frame}
...
\begin{frame}{Key Takeaways}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item Financial volatility $\succ$ GARCH
            \item Long seasonality $\succ$ Fourier terms
            \item Structural breaks $\succ$ Prophet
            \item Multiple series $\succ$ VAR
        \end{itemize}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch10} $\succ$ Python code for this chapter
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
