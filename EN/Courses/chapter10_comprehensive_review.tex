...
\begin{frame}{Unemployment: SARIMA Diagnostics}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Residual Checks}
            Histogram, ACF, Q-Q plot for normality.
        \end{block}

        \column{0.5\textwidth}
        \begin{exampleblock}{Ljung-Box: $p = 0.66$}
            Fail to reject $H_0$ $\Rightarrow$ No remaining autocorrelation.
        \end{exampleblock}
    \end{columns}
...
\begin{frame}{Unemployment: SARIMA Rolling Forecast}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{../charts/sarima_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Granger Causality: Empirical Results}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{../charts/granger_heatmap.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Impulse Response Functions (IRF)}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{../charts/irf_gdp_shock.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{IRF: Unemployment Shock}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{../charts/irf_unemp_shock.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Effects}
...
\begin{frame}{IRF: Fed Rate Shock}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{../charts/irf_fed_shock.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Summary: Model Comparison}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{../charts/model_comparison.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Results}
        \begin{center}
