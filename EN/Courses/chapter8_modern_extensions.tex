...
\begin{frame}{Bitcoin: Price Evolution and Returns}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.50\textheight, keepaspectratio]{ch10_bitcoin_overview.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Energy: Prophet Decomposition and Results}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.44\textheight, keepaspectratio]{ch9_prophet_vs_tbats.pdf}
    \end{center}
\end{frame}
