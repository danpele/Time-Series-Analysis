...
\begin{frame}{Foundation Models: EUR/RON Preview}
    ...
    \begin{alertblock}{For a comprehensive treatment, see Chapter 11}
        Chapter 11 provides a deep dive into foundation model architectures (Chronos, TimesFM, Lag-Llama, Moirai, TimeGPT), tokenization strategies, zero-shot vs fine-tuning, and extended use cases across multiple domains.
    \end{alertblock}
    }
    \end{cminipage}
