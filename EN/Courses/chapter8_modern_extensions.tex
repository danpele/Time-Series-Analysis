...
\begin{frame}{ACF Comparison: Short Memory vs Long Memory}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_acf_comparison.pdf}
    \end{center}
...
\begin{frame}{Effect of Parameter $d$ on ACF}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_arfima_d_effect.pdf}
    \end{center}
...
\begin{frame}{Hurst Exponent: Visual Interpretation}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_hurst_interpretation.pdf}
    \end{center}
...
\begin{frame}{ARIMA vs ARFIMA: Memory Decay Patterns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_arima_vs_arfima.pdf}
    \end{center}
...
\begin{frame}{EUR/RON Long Memory Analysis}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_eurron_long_memory.pdf}
    \end{center}
...
\begin{frame}{ARFIMA Example: S\&P 500 Realized Volatility}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_arfima_real_data.pdf}
    \end{center}
...
\begin{frame}{Real Example: Long Memory in Volatility}
    \begin{cminipage}{0.95\textwidth}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_volatility_long_memory.pdf}
    \end{center}
...
\begin{frame}{ARFIMA Example in Python}
    ...
    \begin{alertblock}{Note}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item ARFIMA estimation requires specialized packages. In practice, the \texttt{arch} or \texttt{fracdiff} packages are commonly used in Python.
        \end{itemize}
    \end{alertblock}
\end{frame}
...
\begin{frame}{Feature Engineering: Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_feature_engineering.pdf}
    \end{center}
...
\begin{frame}{Random Forest: Forecast Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_rf_prediction.pdf}
    \end{center}
...
\begin{frame}{Researcher Spotlight: Hochreiter \& Schmidhuber}
    ...
    \begin{columns}[T]
        \begin{column}{0.22\textwidth}
            \centering
            \includegraphics[width=0.95\textwidth, height=0.22\textheight, keepaspectratio]{photo_sepp_hochreiter.jpg}
            \\[0.05cm]
    ...
    \begin{columns}[T]
        \begin{column}{0.22\textwidth}
            \centering
            \includegraphics[width=0.95\textwidth, height=0.22\textheight, keepaspectratio]{photo_juergen_schmidhuber.jpg}
            \\[0.05cm]
...
\begin{frame}{From Biological to Artificial Neurons}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_neuron_comparison.pdf}
    \end{center}
...
\begin{frame}{LSTM Cell: Detailed Diagram}
    ...
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_lstm_cell.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{columns}[T]
...
\begin{frame}{LSTM Cell Architecture}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_lstm_architecture.pdf}
    \end{center}
...
\begin{frame}{LSTM: Python Implementation with Keras}
    \begin{cminipage}{0.95\textwidth}
    \begin{block}{Python Code}
        \begin{itemize}\setlength{\itemsep}{0pt}
        \item {\footnotesize
...
\begin{frame}{Data Preparation for LSTM}
    \begin{cminipage}{0.95\textwidth}
    \begin{block}{Essential Steps}
        \begin{enumerate}\setlength{\itemsep}{0pt}
            \item \textbf{Normalization/Scaling}: MinMaxScaler or StandardScaler
            \item \textbf{Create sequences}: Sliding window for input
            \item \textbf{Reshape}: 3D format (samples, timesteps, features)
            \item \textbf{Train/Test split}: Temporal, not random!
        \end{enumerate}
    \end{block}

    \vspace{0.2cm}

    \begin{block}{Sequence Creation Example}
        \begin{itemize}\setlength{\itemsep}{0pt}
        \item {\footnotesize
...
\begin{frame}{Time Series Cross-Validation}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_timeseries_cv.pdf}
    \end{center}
...
\begin{frame}{Model Comparison: Accuracy vs Computational Cost}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_case_comparison.pdf}
    \end{center}
...
\begin{frame}{Bitcoin: Price Evolution and Returns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch10_bitcoin_overview.pdf}
    \end{center}
\end{frame}
...
\begin{frame}[fragile]{Bitcoin: ARFIMA Estimation and Model Comparison}
    \vspace{-0.3cm}
    \begin{block}{Python Code -- Bitcoin Long Memory Estimation}
        {\scriptsize
\begin{verbatim}
...
\end{verbatim}
    ...
    \vspace{-0.2cm}
    {\footnotesize
    \begin{exampleblock}{Typical Bitcoin Results (RMSE on returns)}
        \begin{tabular}{lccc}
            \toprule
            \textbf{Model} & \textbf{RMSE} & \textbf{MAE} & \textbf{Interpretable?} \\
            \midrule
...
\begin{frame}{Energy: Demand Visualization and Multiple Seasonality}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch9_electricity_demand.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Energy: Prophet Decomposition and Results}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch9_prophet_vs_tbats.pdf}
    \end{center}
\end{frame}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{ARFIMA(p,d,q)}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item {\footnotesize $d \in (-0.5, 0.5)$: long memory}
                \end{itemize}
            \end{block}
            ...
            \begin{block}{Long Memory}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item {\footnotesize $H > 0.5$: persistence}
                \end{itemize}
            \end{block}
            ...
            \begin{block}{Random Forest}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item {\footnotesize $B$ trees, random features}
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{block}{Time Series CV}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item Train $\rightarrow$ Test (temporal split)
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
...
\begin{frame}[fragile]{Step 1: Loading and Visualizing the Data}
    \begin{block}{Python Code -- Data Download}
        {\footnotesize
\begin{verbatim}
import yfinance as yf
import pandas as pd
...
\begin{frame}{EUR/RON Exchange Rate Visualization}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_case_raw_data.pdf}
    \end{center}
...
\begin{frame}{ACF Analysis: Returns vs Squared Returns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_case_acf_analysis.pdf}
    \end{center}
    \quantlet{TSA\_ch8\_case\_acf\_analysis}{https://github.com/QuantLet/TSA/tree/main/TSA_ch8/TSA_ch8_case_acf_analysis}
\end{frame}

\begin{frame}[fragile]{Step 2: Testing for Long Memory}
    \vspace{-0.2cm}
    \begin{block}{Python Code -- Estimating $d$ and the Hurst Test}
        {\scriptsize
\begin{verbatim}
...
\begin{frame}[fragile]{Step 3: ARIMA Model}
    \vspace{-0.3cm}
    \begin{block}{Python Code -- ARIMA with Automatic Selection}
        {\scriptsize
\begin{verbatim}
...
\begin{frame}[fragile]{Step 4: ARFIMA Model (Long Memory)}
    \begin{block}{Python Code -- ARFIMA with arch package}
        {\footnotesize
\begin{verbatim}
...
\begin{frame}[fragile]{Step 5: Random Forest -- Training and Evaluation}
    \vspace{-0.2cm}
    \begin{block}{Python Code -- Random Forest Model}
        {\scriptsize
\begin{verbatim}
# Split data
...
\begin{frame}{Random Forest: Feature Importance}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_case_feature_importance.pdf}
    \end{center}
...
\begin{frame}[fragile]{Step 6: LSTM -- Data Preparation}
    \vspace{-0.3cm}
    \begin{block}{Python Code -- Sequences for LSTM}
        {\tiny
\begin{verbatim}
...
\begin{frame}[fragile]{Step 6: LSTM -- Architecture and Training}
    \vspace{-0.4cm}
    \begin{block}{Python Code -- LSTM Model}
        {\tiny
\begin{verbatim}
...
\begin{frame}{LSTM: Learning Curve}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_case_lstm_training.pdf}
    \end{center}
...
\begin{frame}{Visualization: Predictions vs Actual Values}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_case_predictions.pdf}
    \end{center}
...
\begin{frame}{Case Study: Data Overview}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_data_split.pdf}
    \end{center}
...
\begin{frame}{Case Study: Model Predictions}
    \begin{cminipage}{0.95\textwidth}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch8_model_predictions.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{center}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{ARIMA/ARFIMA}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item Interpretation important
                    \item Suspected long memory
                    \item Quick baseline
                \end{itemize}
            \end{block}
...
\begin{frame}{Quiz Question 1}
    ...
    \begin{enumerate}[(A)]
        \item The series needs 0.3 differences to become stationary
        \item Long memory: stationary but ACF decays hyperbolically (slowly)
        \item The series is non-stationary with a unit root
        \item Short memory: ACF decays exponentially (fast)
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 1: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (B) Long memory with hyperbolic ACF decay}
        For $0 < d < 0.5$: stationary but ACF $\sim k^{2d-1}$ decays much slower than exponential. This ``long memory'' means distant observations still matter.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch8_quiz1_long_memory.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 2}
    ...
    \begin{enumerate}[(A)]
        \item k-fold is computationally more expensive
        \item Time Series CV uses more training data
        \item k-fold violates temporal order, causing data leakage
        \item There is no difference; both methods are equivalent
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 2: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (C) k-fold violates temporal order}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch8_quiz2_timeseries_cv.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 3}
    ...
    \begin{enumerate}[(A)]
        \item LSTM uses fewer parameters
        \item LSTM solves the vanishing gradient problem via gating mechanisms
        \item LSTM is faster to train
        \item LSTM does not require sequential data
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 3: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (B) Solves vanishing gradient via gates}
        LSTM's forget, input, and output gates control information flow, preserving gradients across long sequences. Simple RNNs lose gradient signal after $\sim$10--20 steps.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch8_quiz3_lstm_gates.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 4}
    ...
    \begin{enumerate}[(A)]
        \item LSTM --- deep learning captures all patterns
        \item Random Forest --- handles any relationship
        \item ARIMA/ARFIMA --- parsimonious and effective with small data
        \item Ensemble of all models for best accuracy
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 4: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (C) ARIMA/ARFIMA --- parsimonious for small data}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch8_quiz4_model_complexity.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 5}
    ...
    \begin{enumerate}[(A)]
        \item Missing values in the dataset
        \item Using future information in features or during training
        \item Having too many features relative to observations
        \item The model memorizing the training data
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Quiz Question 5: Answer}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Correct Answer: (B) Using future information in features or training}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch8_quiz5_data_leakage.pdf}
    \end{center}
