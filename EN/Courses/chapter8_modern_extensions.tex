...
\begin{frame}{From Biological to Artificial Neurons}
    \begin{columns}[T]
        ...
        \begin{column}{0.63\textwidth}
            \begin{center}
                \includegraphics[height=0.78\textheight, keepaspectratio]{ch8_neuron_comparison.pdf}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Activation Functions: Why Do We Need Them?}
    \begin{columns}[T]
        ...
        \begin{column}{0.63\textwidth}
            \begin{center}
                \includegraphics[height=0.78\textheight, keepaspectratio]{ch8_activation_functions.pdf}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
