    ...
    \begin{block}{Short Memory (ARMA)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Finite sum: $\sum_{k=0}^{\infty} |\rho_k| < \infty$ (more precisely, the condition is on autocovariances: $\sum_{k=0}^{\infty} |\gamma(k)| < \infty$)
            \end{itemize}
...
\begin{frame}{Interpreting the Parameter $d$}
    ...
    \begin{tabular}{c|l|l}
        ...
        $d = 1$ & Sample ACF decays very slowly (nonstationary process) & Random walk \\
        \bottomrule
    \end{tabular}
    \end{center}
...
\begin{frame}{Comparison: Results on EUR/RON}
    ...
    \end{tabular}
    \end{center}
    {\scriptsize \textit{Note: MLP: Multi-Layer Perceptron; LSTM: Long Short-Term Memory --- grouped due to similar performance on these data.}}
