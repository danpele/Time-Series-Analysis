...
\begin{frame}{Bitcoin: ACF and Evidence for Long Memory}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{btc_acf_squared.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Energy: Why Prophet and TBATS?}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{ch9_multiple_seasonality.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
