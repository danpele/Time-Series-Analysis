...
\begin{frame}{Box-Cox Transformation}
    ...
    \begin{defn}[Box-Cox Transformation]
        The Box-Cox transformation with parameter $\lambda$ is defined as:
        \[
    ...
    \begin{exampleblock}{Purpose}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Common values: $\lambda = 0$ (log), $\lambda = 0.5$ (square root), $\lambda = 1$ (no transform)
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{TBATS Model Structure}
    ...
    \begin{block}{State Space Representation}
        \begin{align*}
            y_t^{(\lambda)} &= \ell_{t-1} + \phi b_{t-1} + \sum_{i=1}^{T} s_{t-m_i}^{(i)} + d_t \\
    ...
    \begin{columns}[T]
        \column{0.5\textwidth}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $y_t^{(\lambda)}$: Box-Cox transformed observation
...
\begin{frame}{TBATS: Key Features}
    ...
    \begin{block}{Automatic Model Selection}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Box-Cox parameter $\lambda$ for variance stabilization
...
\begin{frame}{Prophet: Overview}
    ...
    \begin{block}{What is Prophet?}
        Forecasting procedure developed at Facebook (now Meta) in 2017 for \textbf{business time series}:
        \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Prophet: Seasonality Component}
    ...
    {\small
        ...
        \begin{exampleblock}{Default Settings}
            ...
            \end{center}
            \vspace{-0.1cm}
            Higher $N$ = more flexibility but risk of overfitting
        \end{exampleblock}
    }
    \vspace{-0.1cm}
    \begin{center}
...
\begin{frame}{Prophet: Trend Component}
    ...
    \begin{alertblock}{Continuity Constraint}
        The offset $\gamma_j = -\tau_j \cdot \delta_j$ ensures $g(t)$ is continuous at each changepoint $\tau_j$.
    \end{alertblock}
    }
    \end{cminipage}
\end{frame}
...
\begin{frame}{Prophet: Advantages and Limitations}
    ...
    \begin{columns}[T]
        ...
        \begin{alertblock}{Limitations}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Not ARIMA-based}: does not explicitly model residual autocorrelation
...
\begin{frame}{Question 1: Answer}
    ...
    \hfill\quantlet{TSA\_ch9\_multiple\_seasonality}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_multiple_seasonality}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Question 2: Answer}
    ...
    \hfill\quantlet{TSA\_ch9\_tbats\_decomposition}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_tbats_decomposition}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Question 3: Answer}
    ...
    \hfill\quantlet{TSA\_ch9\_fourier\_approximation}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_fourier_approximation}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Question 4: Answer}
    ...
    \hfill\quantlet{TSA\_ch9\_prophet\_components}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_prophet_components}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Question 5: Answer}
    ...
    \hfill\quantlet{TSA\_ch9\_prophet\_vs\_tbats}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_prophet_vs_tbats}
    \end{cminipage}
\end{frame}
