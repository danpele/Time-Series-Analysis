...
\begin{frame}{Researcher Spotlight: Rob J. Hyndman}
    ...
    \begin{columns}[T]
        \begin{column}{0.28\textwidth}
            \centering
            \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{photo_rob_hyndman.jpg}
            \\[0.2cm]
            {\footnotesize\textcolor{MediumGray}{*1967}}\\[0.1cm]
...
\begin{frame}{Quiz 1: Multiple Seasonality}
    \begin{cminipage}{0.95\textwidth}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch9_quiz1_multiple_seasonality.pdf}
    \end{center}
...
\begin{frame}{Quiz 2: TBATS Components}
    \begin{cminipage}{0.95\textwidth}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch9_quiz2_tbats_components.pdf}
    \end{center}
...
\begin{frame}{Quiz 3: Fourier Harmonics}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch9_quiz3_fourier_harmonics.pdf}
    \end{center}
...
\begin{frame}{Quiz 4: Prophet Decomposition}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch9_quiz4_prophet_decomposition.pdf}
    \end{center}
...
\begin{frame}{Quiz 5: Model Comparison}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch9_quiz5_prophet_vs_tbats.pdf}
    \end{center}
