...
\begin{frame}{Stability Condition: Visual Interpretation}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_stability_roots.pdf}
        \end{center}
...
\begin{frame}{Historical Decomposition: Example}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_historical_decomp.pdf}
        \end{center}
...
\begin{frame}{GDP and Unemployment: Data}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_gdp_unemployment.pdf}
        \end{center}
