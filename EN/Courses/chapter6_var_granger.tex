...
\begin{frame}{Motivating Example: Macroeconomic Dynamics}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_motivation_econ.pdf}
    \end{center}
...
\begin{frame}{The Key Insight: Variables Interact}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_motivation_scatter.pdf}
    \end{center}
...
\begin{frame}{Lead-Lag Relationships}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_motivation_leadlag.pdf}
    \end{center}
...
\begin{frame}{Why Univariate Models Are Not Enough}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_motivation_univariate.pdf}
    \end{center}
...
\begin{frame}{What We'll Learn Today}
    ...
    \begin{exampleblock}{Recurring Example: GDP Growth and Unemployment}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Central question: Does GDP cause unemployment, or vice versa, or both?
        \end{itemize}
    \end{exampleblock}
    }
    \vspace{-0.05cm}
...
\begin{frame}{VAR Process: GDP and Unemployment (FRED)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_var_simulation.pdf}
    \end{center}
...
\begin{frame}{Lag Selection: Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_lag_selection.pdf}
    \end{center}
...
\begin{frame}{Cross-Correlation: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_def_ccf.pdf}
    \end{center}
...
\begin{frame}{Impulse Response Functions: Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_irf.pdf}
    \end{center}
...
\begin{frame}{Structural IRF Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_structural_irf.pdf}
    \end{center}
...
\begin{frame}{FEVD: Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_fevd.pdf}
    \end{center}
...
\begin{frame}{Historical Decomposition: Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_historical_decomp.pdf}
    \end{center}
...
\begin{frame}{VAR Forecasts: Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_var_forecast.pdf}
    \end{center}
...
\begin{frame}{Out-of-Sample Evaluation: VAR vs.\ AR}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_var_rolling_forecast.pdf}
    \end{center}
...
\begin{frame}{GDP and Unemployment: Data}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_gdp_unemployment.pdf}
    \end{center}
...
\begin{frame}{Estimated VAR Results}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_var_results.pdf}
    \end{center}
...
\begin{frame}{Monetary Policy VAR: IRFs}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_monetary_irf.pdf}
    \end{center}
...
\begin{frame}{Case Study: The Relationship between GDP and Unemployment}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_raw_data.pdf}
    \end{center}
...
\begin{frame}{Step 1: Preliminary Analysis}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_stationarity.pdf}
    \end{center}
...
\begin{frame}{Step 2: VAR Order Selection}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_lag_selection.pdf}
    \end{center}
...
\begin{frame}{Step 3: Granger Causality Test}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_granger.pdf}
    \end{center}
...
\begin{frame}{Step 4: Impulse Response Functions (IRF)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_irf.pdf}
    \end{center}
...
\begin{frame}{Step 5: Variance Decomposition (FEVD)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_fevd.pdf}
    \end{center}
...
\begin{frame}{Step 6: Residual Diagnostics}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_diagnostics.pdf}
    \end{center}
...
\begin{frame}{Step 7: VAR Forecasting}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_forecast.pdf}
    \end{center}
...
\begin{frame}{Step 9: Out-of-Sample Comparison -- AR vs VAR}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch6_case_oos_comparison.pdf}
    \end{center}
...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{\footnotesize Prompt to test in ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Download quarterly GDP and unemployment data for the US. Test for Granger causality, estimate a VAR model, and analyze impulse response functions. Give me complete Python code.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
...
\begin{frame}{Quiz Question 1: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_quiz1_var_stability.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 2: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_quiz2_granger_causality.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 3: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_quiz3_cholesky_ordering.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 5: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_quiz5_fevd.pdf}
    \end{center}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online resources and code}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch6} $\rightarrow$ Python code for this chapter
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
