...
\begin{itemize}
    \item Model multivariate time series using Vector Autoregression (VAR)
    \item Test for Granger causality between economic variables
    \item Compute and interpret Impulse Response Functions (IRFs)
    \item Analyze Forecast Error Variance Decomposition (FEVD)
\end{itemize}
\end{block}
\end{frame}
...
\begin{frame}{Motivating Example: Macroeconomic Dynamics}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.62\textheight, keepaspectratio]{ch5_motivation_econ.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{VAR Process: GDP and Unemployment (FRED)}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_var_simulation.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Stability Condition: Visual Interpretation}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_stability_roots.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Derivation: The Lyapunov Equation}
    \begin{block}{Starting Point: VAR(1) Model}
        Consider the stationary VAR(1): $\bY_t = \mathbf{c} + \bA\bY_{t-1} + \bepsilon_t$

        \vspace{0.1cm}
        Without loss of generality, assume $\mathbf{c} = \mathbf{0}$ (mean-centered):
        $$\bY_t = \bA\bY_{t-1} + \bepsilon_t$$
    \end{block}

    \vspace{0.15cm}

    \begin{block}{Step 1: Definition of Variance-Covariance Matrix}
        The unconditional variance-covariance matrix is:
        $$\boldsymbol{\Gamma}(0) = \E[\bY_t \bY_t']$$

        By stationarity: $\boldsymbol{\Gamma}(0) = \E[\bY_{t-1} \bY_{t-1}']$
    \end{block}
\end{frame}

\begin{frame}{Derivation: The Lyapunov Equation (cont.)}
    \begin{block}{Step 2: Substitute VAR(1) into Variance Expression}
        $$\boldsymbol{\Gamma}(0) = \E[\bY_t \bY_t'] = \E[(\bA\bY_{t-1} + \bepsilon_t)(\bA\bY_{t-1} + \bepsilon_t)']$$

        Expanding:
        $$= \E[\bA\bY_{t-1}\bY_{t-1}'\bA' + \bA\bY_{t-1}\bepsilon_t' + \bepsilon_t\bY_{t-1}'\bA' + \bepsilon_t\bepsilon_t']$$
    \end{block}

    \vspace{0.1cm}

    \begin{block}{Step 3: Apply Expectations}
        Since $\bepsilon_t$ is independent of $\bY_{t-1}$: $\E[\bY_{t-1}\bepsilon_t'] = \mathbf{0}$ and $\E[\bepsilon_t\bY_{t-1}'] = \mathbf{0}$

        \vspace{0.1cm}
        Therefore:
        $$\boldsymbol{\Gamma}(0) = \bA\E[\bY_{t-1}\bY_{t-1}']\bA' + \E[\bepsilon_t\bepsilon_t'] = \bA\boldsymbol{\Gamma}(0)\bA' + \bSigma$$
    \end{block}

    \vspace{0.1cm}

    \begin{alertblock}{The Discrete Lyapunov Equation}
        $$\boxed{\boldsymbol{\Gamma}(0) = \bA\boldsymbol{\Gamma}(0)\bA' + \bSigma}$$
    \end{alertblock}
\end{frame}

\begin{frame}{Solving the Lyapunov Equation}
    \begin{block}{The Vectorization Approach}
        The Lyapunov equation $\boldsymbol{\Gamma}(0) = \bA\boldsymbol{\Gamma}(0)\bA' + \bSigma$ is a matrix equation.

        \vspace{0.1cm}
        To solve it, we use the \textbf{vec operator} which stacks columns of a matrix into a vector.
    \end{block}

    \vspace{0.1cm}

    \begin{block}{Key Property: Kronecker Product}
        For matrices $\mathbf{A}$, $\mathbf{B}$, $\mathbf{X}$: $\text{vec}(\mathbf{AXB}) = (\mathbf{B}' \otimes \mathbf{A})\text{vec}(\mathbf{X})$

        \vspace{0.1cm}
        Applying to $\bA\boldsymbol{\Gamma}(0)\bA'$:
        $$\text{vec}(\bA\boldsymbol{\Gamma}(0)\bA') = (\bA \otimes \bA)\text{vec}(\boldsymbol{\Gamma}(0))$$
    \end{block}
    ...
    \begin{alertblock}{Solution}
        ...
        $$\text{vec}(\boldsymbol{\Gamma}(0)) = (\bA \otimes \bA)\text{vec}(\boldsymbol{\Gamma}(0)) + \text{vec}(\bSigma)$$
        $$\boxed{\text{vec}(\boldsymbol{\Gamma}(0)) = (\mathbf{I}_{K^2} - \bA \otimes \bA)^{-1} \text{vec}(\bSigma)}$$
        This solution exists when VAR is stable (eigenvalues of $\bA \otimes \bA$ inside unit circle).
    \end{alertblock}
\end{frame}
...
\begin{frame}{Lag Selection: Example}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_lag_selection.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Impulse Response Functions: Example}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_irf.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Structural IRF Example}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_structural_irf.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{FEVD: Example}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_fevd.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Historical Decomposition: Example}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_historical_decomp.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Diagnostic Summary Plot}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_diagnostics.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{VAR Forecasts: Example}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_var_forecast.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{GDP and Unemployment: Data}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_gdp_unemployment.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Estimated VAR Results}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_var_results.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Monetary Policy VAR: IRFs}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch5_monetary_irf.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Quiz Question 1: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch5_quiz1_var_stability.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 2: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch5_quiz2_granger_causality.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 3: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch5_quiz3_cholesky_ordering.pdf}
    \end{center}
...
\begin{frame}{Quiz Question 5: Answer}
    ...
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch5_quiz5_fevd.pdf}
    \end{center}
...
\begin{frame}{Step 1: Data Visualization}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_raw_data.pdf}
    \end{center}
...
\begin{frame}{Step 2: Stationarity Tests}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_stationarity.pdf}
    \end{center}
...
\begin{frame}{Step 3: Lag Selection and VAR Estimation}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_lag_selection.pdf}
    \end{center}
...
\begin{frame}{Step 4: Granger Causality Tests}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_granger.pdf}
    \end{center}
...
\begin{frame}{Step 5: Impulse Response Functions}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_irf.pdf}
    \end{center}
    \quantlet{TSA\_ch6\_case\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6/TSA_ch6_case_irf}
\end{frame}

\begin{frame}{Step 6: Forecast Error Variance Decomposition}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_fevd.pdf}
    \end{center}
    \quantlet{TSA\_ch6\_case\_fevd}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6/TSA_ch6_case_fevd}
\end{frame}

\begin{frame}{Step 7: Residual Diagnostics}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_diagnostics.pdf}
    \end{center}
    \quantlet{TSA\_ch6\_case\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6/TSA_ch6_case_diagnostics}
\end{frame}

\begin{frame}{Step 8: Forecasting}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_forecast.pdf}
    \end{center}
    \quantlet{TSA\_ch6\_case\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6/TSA_ch6_case_forecast}
\end{frame}

\begin{frame}{Step 9: Rolling Forecast -- VAR vs AR}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_rolling_forecast.pdf}
    \end{center}
    \quantlet{TSA\_ch6\_case\_rolling\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6/TSA_ch6_case_rolling_forecast}
\end{frame}

\begin{frame}{Step 10: Out-of-Sample Comparison -- AR vs VAR}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.70\textheight, keepaspectratio]{ch6_case_oos_comparison.pdf}
    \end{center}
...
\begin{frame}{Online Resources and Code}
    \begin{exampleblock}{}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA\_ch6}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch6}
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
