...
\begin{frame}{Stability Condition: Visual Interpretation}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_stability_roots.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{cminipage}{0.95\textwidth}
...
\begin{frame}{Lag Selection: Example}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_lag_selection.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Structural IRF Example}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_structural_irf.pdf}
        \end{center}
...
\begin{frame}{FEVD: Example}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_fevd.pdf}
        \end{center}
...
\begin{frame}{Historical Decomposition: Example}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_historical_decomp.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{block}{Definition}
...
\begin{frame}{VAR Forecasts: Example}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_var_forecast.pdf}
        \end{center}
...
\begin{frame}{GDP and Unemployment: Data}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_gdp_unemployment.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Estimated VAR Results}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_var_results.pdf}
        \end{center}
...
\begin{frame}{Monetary Policy VAR: IRFs}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch6_monetary_irf.pdf}
        \end{center}
...
\begin{frame}{Step 8: Rolling Forecast -- VAR vs AR}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch6_case_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
