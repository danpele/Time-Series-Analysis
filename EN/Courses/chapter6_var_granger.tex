...
\begin{frame}{Why Univariate Models Are Not Enough}
    ...
    {\footnotesize
        \begin{alertblock}{The Problem}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item ARIMA models each variable \textbf{in isolation}---ignoring valuable information from other variables!
            \end{itemize}
        \end{alertblock}
        \vspace{-0.1cm}
        \begin{exampleblock}{The Solution}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{VAR models} capture the joint dynamics and feedback effects between multiple time series
            \end{itemize}
        \end{exampleblock}
    }
    \vspace{-0.1cm}
...
\begin{frame}{GDP and Unemployment: Data}
    ...
    \begin{block}{Okun's Law}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item $\bar{g}$ is trend GDP growth and $\beta \approx 0.4$
        \end{itemize}
    \end{block}
    \vspace{-0.1cm}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online resources and code}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch6} $\succ$ Python code for this chapter
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
