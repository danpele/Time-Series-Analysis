...
\begin{frame}{Lag Selection: Example}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.30\textheight, keepaspectratio]{ch6_lag_selection.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\scriptsize
...
\begin{frame}{Historical Decomposition: Example}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.28\textheight, keepaspectratio]{ch6_historical_decomp.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\scriptsize
    \begin{block}{Definition}
...
\begin{frame}{GDP and Unemployment: Data}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.30\textheight, keepaspectratio]{ch6_gdp_unemployment.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\scriptsize
...
\begin{frame}{Step 8: Rolling Forecast -- VAR vs AR}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.41\textheight, keepaspectratio]{ch6_case_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\scriptsize
