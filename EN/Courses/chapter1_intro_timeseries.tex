...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{\footnotesize Prompt to test in ChatGPT / Claude / Copilot}
        {\small
        ``Using yfinance, download EUR/RON exchange rate data. Is the series stationary? Fit a model and forecast next week's rate. Tell me if the forecast is reliable.''
        }
    \end{block}
    \vspace{-1mm}
    {\small
...
\begin{frame}{References}
    ...
    \begin{columns}[T]
        ...
        \begin{alertblock}{Online Resources}
            {\scriptsize
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Quantlet}: \url{https://quantlet.com} $\rightarrow$ statistics code
                \item \textbf{Quantinar}: \url{https://quantinar.com} $\rightarrow$ tutorials
