...
\begin{frame}{Experiment: ChatGPT vs Fundamentals}
    ...
    \begin{enumerate}\setlength{\itemsep}{2pt}
        \item Identify at least three methodological errors in the AI's analysis above.
        \item Download EUR/RON data and reproduce the AI's claims. Which ones hold up?
        \item Compare the ARMA(2,1) forecast accuracy against a na\"ive benchmark using the Diebold--Mariano test.
        \item Explain: if prices follow a random walk, can \textit{any} model beat $\hat{X}_{t+1} = X_t$?
    \end{enumerate}
    }
    \vspace{-1mm}
    \begin{alertblock}{}
        {\small \textbf{Discussion}: The AI reports low RMSE and significant coefficients. \textit{Is that enough to trust the forecast?}}
    \end{alertblock}
\end{frame}
