...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{\footnotesize Prompt to test in ChatGPT / Claude / Copilot}
        {\small
        ``I have daily EUR/RON exchange rate data for the last 5 years. Test for stationarity, fit an appropriate model, and forecast the next week. Evaluate forecast accuracy.''
        }
    \end{block}
    \vspace{-1mm}
    {\small
