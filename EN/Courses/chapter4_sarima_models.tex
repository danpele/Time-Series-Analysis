    ...
    \begin{block}{What does this test do?}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Conclusion}: if one season consistently has higher/lower ranks $\Rightarrow$ seasonality
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Example: if summer always has high ranks $\Rightarrow$ seasonal energy consumption
                \end{itemize}
        \end{itemize}
    \end{block}
    ...
    \begin{alertblock}{HEGY tests multiple frequencies}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Quarterly}: tests at 0, $\pi$, $\pm\pi/2$
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item 3 frequencies $\Rightarrow$ one regular root + two seasonal roots
                \end{itemize}
            \item \textbf{Monthly}: tests at 0, $\pi$, $\pm\pi/6$, $\pm\pi/3$, $\pm\pi/2$, $\pm 2\pi/3$, $\pm 5\pi/6$
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item 6 frequencies $\Rightarrow$ one regular root + five seasonal roots
                \end{itemize}
        \end{itemize}
    \end{alertblock}
    }
