...
\begin{frame}{Example: Airline Passengers Data}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.57\textheight, keepaspectratio]{ch4_airline_data.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{exampleblock}{}
...
\begin{frame}{The Seasonal Difference Operator}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{ch4_def_seasonal_diff.pdf}
        \end{center}
