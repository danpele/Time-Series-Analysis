...
\begin{frame}{Seasonality: Visual Illustration}
    \begin{columns}[T]
        ...
        \begin{column}{0.63\textwidth}
            \begin{center}
                \includegraphics[height=0.78\textheight, keepaspectratio]{ch4_def_seasonality.pdf}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Seasonal Difference: Visual Illustration}
    \begin{columns}[T]
        ...
        \begin{column}{0.63\textwidth}
            \begin{center}
                \includegraphics[height=0.78\textheight, keepaspectratio]{ch4_def_seasonal_diff.pdf}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{SARIMA: Visual Illustration}
    \begin{columns}[T]
        ...
        \begin{column}{0.63\textwidth}
            \begin{center}
                \includegraphics[height=0.78\textheight, keepaspectratio]{ch4_def_sarima.pdf}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
