...
\begin{frame}{Example: Bitcoin $\succ$ Evidence for ARCH Effects}
    ...
    \begin{block}{Interpretation}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Top}: $r_t^2$ (volatility proxy) $\succ$ peaks coincide with market crises
            \item \textbf{Bottom}: ACF($r_t^2$) significant $\succ$ ARCH effects present, variance is predictable
        \end{itemize}
    \end{block}
    }
    \end{cminipage}
