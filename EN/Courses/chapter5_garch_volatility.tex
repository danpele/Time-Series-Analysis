...
\begin{frame}{Stylized Facts of Financial Returns}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.41\textheight, keepaspectratio]{garch_stylized_facts.pdf}
    \end{center}
...
\begin{frame}{Leverage Effect}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.50\textheight, keepaspectratio]{garch_leverage_effect.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Step 1: Data --- S\&P 500 Daily Returns}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.22\textheight, keepaspectratio]{garch_sp500_returns.pdf}
    \end{center}
...
\begin{frame}{Step 5: Diagnostics --- EGARCH(1,1)-t}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.46\textheight, keepaspectratio]{garch_diagnostics.pdf}
    \end{center}
...
\begin{frame}{Step 1: Data --- Bitcoin Daily Returns}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.18\textheight, keepaspectratio]{btc_returns.pdf}
    \end{center}
...
\begin{frame}{Question 5}
    ...
    \begin{alertblock}{Question}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item What does the \textit{half-life} of volatility represent in a GARCH(1,1) model?
        \end{itemize}
    \end{alertblock}
    ...
    \begin{block}{Answer Choices}
        ...
        \textcolor{MainBlue}{\textbf{(A)}} The time needed for the price to return to its mean\\[3pt]

        \textcolor{MainBlue}{\textbf{(B)}} The number of periods until volatility becomes zero\\[3pt]

        \textcolor{MainBlue}{\textbf{(C)}} The number of periods for a volatility shock to decay to half its initial impact\\[3pt]

        \textcolor{MainBlue}{\textbf{(D)}} The average duration of a high-volatility episode
...
\begin{frame}{Question 5: Answer}
    ...
    \begin{exampleblock}{Answer: (C)}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item $HL = \frac{\ln(0.5)}{\ln(\alpha+\beta)}$. Example: S\&P 500 with $\alpha+\beta=0.988$ gives $HL \approx 58$ days (shocks persist $\sim$3 months).
    \end{itemize}
    \end{exampleblock}
    }
