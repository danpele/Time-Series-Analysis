...
\begin{frame}{Understanding Time Series Structure}
    ...
    \begin{exampleblock}{Decomposition}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Most time series can be decomposed into: \textbf{trend-cycle} + \textbf{seasonality} + \textbf{noise}
        \end{itemize}
    \end{exampleblock}
    }
\end{frame}
...
\begin{frame}{HP Filter: Limitations}
    ...
    \begin{alertblock}{Hamilton's Critique (2018)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Hamilton (2018) shows that the HP filter introduces \textbf{spurious cyclical components}
            \item Proposes alternative: regression of $y_{t+h}$ on $y_t, y_{t-1}, \ldots, y_{t-p}$ (default $h=8, p=4$ quarterly)
            \item Advantage: no $\lambda$ selection required; no end-of-sample problem
        \end{itemize}
    \end{alertblock}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch0} -- Python code for this chapter
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
