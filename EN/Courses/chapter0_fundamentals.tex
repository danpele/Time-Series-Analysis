...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{\footnotesize Prompt to test in ChatGPT / Claude / Copilot}
        {\small
        ``I have monthly airline passenger data from 1949 to 1960. Write Python code that decomposes the series, identifies trend and seasonality, then forecasts the next 24 months. Evaluate model quality.''
        }
    \end{block}
    \vspace{-1mm}
    {\small
    ...
    \vspace{-1mm}
    \begin{alertblock}{}
        {\small \textbf{Warning}: AI-generated code may run without errors and look professional. \textit{That does not mean it is correct.}}
    \end{alertblock}
\end{frame}
