...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{\footnotesize Prompt to test in ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Using yfinance, download monthly closing prices for Apple (AAPL) from 2015-01 to 2024-12 (120 observations). Decompose the series into trend, seasonality, and residuals. Determine if additive or multiplicative decomposition is more appropriate and forecast the price for the next 12 months. Give me complete Python code with professional charts.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch0} $\succ$ Python code for this chapter
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
