...
\begin{frame}{Experiment: ChatGPT vs Fundamentals}
    ...
    \begin{enumerate}\setlength{\itemsep}{2pt}
        \item Identify at least three methodological errors in the analysis above.
        \item Explain why the reported MAPE $= 4.2\%$ is misleading.
        \item Rewrite the code correctly and compare results with a seasonal naïve benchmark.
    \end{enumerate}
    }
    \vspace{-1mm}
    \begin{alertblock}{}
