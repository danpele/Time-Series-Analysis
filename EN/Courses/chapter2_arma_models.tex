...
\vfuzz=3pt  % Suppress tiny vertical overfull warnings (<3pt)
...
\begin{frame}{White Noise: Visual Illustration}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.48\textheight, keepaspectratio]{ch2_white_noise.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{AR(2) Stationarity: Unit Circle Visualization}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.55\textheight, keepaspectratio]{unit_circle_stationarity.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{ACF/PACF Patterns: Visual Guide}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.55\textheight, keepaspectratio]{ch2_acf_pacf_patterns.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{block}{Identification Rules}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{AR}: ACF decays, PACF cuts off $\succ$ use PACF for order $p$
            \item \textbf{MA}: ACF cuts off, PACF decays $\succ$ use ACF for order $q$
            \item \textbf{ARMA}: Both decay $\succ$ requires information criteria
        \end{itemize}
    \end{block}
    }
    \quantlet{TSA\_ch2\_acf\_pacf\_patterns}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_acf_pacf_patterns}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        ...
        \begin{itemize}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA} $\succ$ Python code for this course
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{}
    ...
    \normalsize
    \textit{Charts were generated using Python (statsmodels, matplotlib)}

    \vspace{0.3cm}

    Course materials are available at: \url{https://danpele.github.io/Time-Series-Analysis/}
