    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Key Characteristics}
            \begin{itemize}\setlength{\itemsep}{2pt}
                ...
                \item \textbf{Right}: ACF only a spike at lag 0; others within significance bounds $\succ$ no linear dependence
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
...
\begin{frame}{Residual Diagnostics}
    ...
    \begin{block}{If the model is correctly specified, residuals must be white noise}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Q-Q plot}: points on the diagonal $\succ$ normal distribution; heavy tails $\succ$ non-normal errors
        \end{itemize}
    \end{block}
    \vspace{-0.4cm}
    \begin{alertblock}{Decision}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textcolor{Forest}{$\checkmark$ All checks OK} $\succ$ adequate model \qquad \textcolor{Crimson}{$\times$ Not satisfied} $\succ$ return to identification
        \end{itemize}
    \end{alertblock}
    }
    \end{cminipage}
...
\begin{frame}{Bibliography II}
    ...
    \begin{exampleblock}{Online Resources and Code}
        ...
        \begin{itemize}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch2} $\succ$ Python code for this chapter
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
