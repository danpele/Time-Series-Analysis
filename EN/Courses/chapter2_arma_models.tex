    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Durbin-Levinson Recursion}
            ...
            \begin{enumerate}\setlength{\itemsep}{1pt}
                ...
                \]
                \item \textbf{Update coefficients}: $\phi_{k,j} = \phi_{k-1,j} - \pi_k\, \phi_{k-1,k-j}$ for $j = 1, \ldots, k-1$; $\phi_{k,k} = \pi_k$
            ...
            \begin{column}{0.48\textwidth}
                \begin{exampleblock}{Complexity}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item Exploits the Toeplitz structure of $\boldsymbol{\Gamma}_k$
                        \item Guarantees $v_k > 0$ if the process is stationary
                    \end{itemize}
                \end{exampleblock}
            \end{column}
            \begin{column}{0.48\textwidth}
                \begin{alertblock}{AR($p$) Identification}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item Confidence interval: $|\pi_k| > 1.96/\sqrt{T}$ $\Rightarrow$ significant
                        \item Equivalent to $t$-test on last OLS coefficient
                    \end{itemize}
                \end{alertblock}
            \end{column}
        \end{columns}
...
\begin{frame}{ARMA: Visual Illustration}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.58\textheight, keepaspectratio]{ch2_def_arma.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{ACF/PACF Identification Rules}
    ...
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.28\textheight, keepaspectratio]{model_identification_table.pdf}
    \end{center}
    \quantlet{TSA\_ch2\_acf\_pacf\_patterns}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_acf_pacf_patterns}
\end{frame}
...
\begin{frame}{Residual Diagnostics}
    ...
    \begin{block}{If the model is correctly specified, residuals must be white noise}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Q-Q plot}: points on the diagonal $\Rightarrow$ normal distribution; heavy tails $\Rightarrow$ non-normal errors
        \end{itemize}
    \end{block}
    \vspace{-0.4cm}
...
\begin{frame}{Question 12: Answer}
    ...
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.60\textheight, keepaspectratio]{ch2_quiz_ar2_check.pdf}
    \end{center}
    \vspace{-3mm}
    {\small
    \begin{exampleblock}{Answer: (B)}
