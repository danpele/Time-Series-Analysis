...
plt.tight_layout()
plt.savefig('ch6_data.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_data.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_data.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch6_irf.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_irf.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_irf.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch6_fevd.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_fevd.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_fevd.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch6_forecast.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_forecast.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch6_forecast.pdf', bbox_inches='tight', transparent=True)
plt.close()
