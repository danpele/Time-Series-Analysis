...
plt.tight_layout()
plt.savefig('ch5_stylized_facts.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_stylized_facts.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_stylized_facts.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch5_news_impact.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_news_impact.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_news_impact.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch5_forecast.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_forecast.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_forecast.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch5_diagnostics.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_diagnostics.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch5_diagnostics.pdf', bbox_inches='tight', transparent=True)
plt.close()
