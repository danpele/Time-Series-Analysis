...
plt.tight_layout()
plt.savefig('../../charts/ch2_ma1_acf_pacf.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('../../charts/ch2_ma1_acf_pacf.pdf', bbox_inches='tight', transparent=True)
plt.show()
