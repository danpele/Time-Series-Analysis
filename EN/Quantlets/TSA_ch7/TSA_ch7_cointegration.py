...
plt.tight_layout()
plt.savefig('ch7_spurious.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_spurious.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_spurious.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch7_cointegration.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_cointegration.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_cointegration.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch7_vecm_irf.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_vecm_irf.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_vecm_irf.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch7_error_correction.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_error_correction.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch7_error_correction.pdf', bbox_inches='tight', transparent=True)
plt.close()
