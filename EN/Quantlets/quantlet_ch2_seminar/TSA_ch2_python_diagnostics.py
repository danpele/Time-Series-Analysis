...
plt.tight_layout()
plt.savefig('../../charts/ch2_python_diagnostics.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('../../charts/ch2_python_diagnostics.pdf', bbox_inches='tight', transparent=True)
plt.show()
