...
plt.tight_layout()
plt.savefig('../../charts/ch2_python_selection.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('../../charts/ch2_python_selection.pdf', bbox_inches='tight', transparent=True)
plt.show()
