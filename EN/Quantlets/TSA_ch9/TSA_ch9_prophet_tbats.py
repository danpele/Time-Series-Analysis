...
plt.tight_layout()
plt.savefig('ch9_multiple_seasonality.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_multiple_seasonality.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_multiple_seasonality.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch9_fourier_terms.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_fourier_terms.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_fourier_terms.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
if HAS_PROPHET:
    ...
    plt.savefig('ch9_prophet_components.pdf', dpi=150, bbox_inches='tight', transparent=True)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('ch9_prophet_forecast.pdf', dpi=150, bbox_inches='tight', transparent=True)
    plt.savefig('ch9_prophet_forecast.png', dpi=150, bbox_inches='tight', transparent=True)
    plt.savefig('ch9_prophet_forecast.pdf', bbox_inches='tight', transparent=True)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('ch9_prophet_components.pdf', dpi=150, bbox_inches='tight', transparent=True)
    plt.savefig('ch9_prophet_components.png', dpi=150, bbox_inches='tight', transparent=True)
    plt.savefig('ch9_prophet_components.pdf', bbox_inches='tight', transparent=True)
    plt.close()
...
plt.tight_layout()
plt.savefig('ch9_tbats_decomposition.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_tbats_decomposition.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_tbats_decomposition.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch9_changepoints.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_changepoints.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch9_changepoints.pdf', bbox_inches='tight', transparent=True)
plt.close()
