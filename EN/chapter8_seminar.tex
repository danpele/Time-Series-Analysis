...
\begin{frame}{Quiz 1: Answer}
    \begin{exampleblock}{Answer: B -- Long memory and persistence}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch8_quiz3_hurst.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        ...
        \begin{itemize}
            ...
            \item $0.5 < H < 1$: \textbf{Persistence} -- trends continue
...
\begin{frame}{Quiz 2: Answer}
    \begin{exampleblock}{Answer: C -- Any real value}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{charts/ch8_quiz2_arfima_d.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Interpretation of $d$ values:}
        \begin{itemize}
            \item $d = 0$: Stationary (ARMA)
            \item $0 < d < 0.5$: Long memory, stationary
            \item $0.5 \leq d < 1$: Long memory, non-stationary
            \item $d = 1$: Unit root (classic ARIMA)
        \end{itemize}
...
\begin{frame}{Quiz 3: Answer}
    \begin{exampleblock}{Answer: C -- Volatility}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{charts/ch8_quiz1_long_memory.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Stylized facts in finance:}
        \begin{itemize}
            \item \textbf{Returns}: Approximately memoryless ($H \approx 0.5$)
            \item \textbf{Volatility}: Pronounced long memory ($H \approx 0.7-0.9$)
        \end{itemize}
        \textbf{Why?} Volatility clustering -- turbulent periods follow turbulent periods. This is the basis for FIGARCH and HAR-RV models.
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Quiz 4: Answer}
    \begin{exampleblock}{Answer: B -- Lag features and rolling statistics}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{charts/ch8_quiz4_rf_features.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        ...
        \begin{itemize}
            ...
            \item \textbf{Rolling statistics}: moving average, moving std, min/max
            \item \textbf{Calendar features}: day of week, month, etc.
        \end{itemize}
        Transforms forecasting into supervised regression!
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Quiz 5: Answer}
    \begin{exampleblock}{Answer: B -- Violates temporal order}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{charts/ch8_quiz5_cv_comparison.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Problem with standard k-fold:}
        \begin{itemize}
            \item Shuffles observations randomly
            \item Trains on future data, tests on past
            \item \textbf{Data leakage} $\Rightarrow$ overestimated performance
        \end{itemize}
        \textbf{Solution}: Time Series Split (Walk-Forward Validation)
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Quiz 7: Answer}
    \begin{exampleblock}{Answer: B -- Solves the gradient problem}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.40\textheight, keepaspectratio]{charts/ch8_quiz6_lstm_advantage.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Simple RNN Problem}: Gradients decay exponentially with sequence length.
...
\begin{frame}{Quiz 8: Answer}
    \begin{exampleblock}{Answer: B -- Normalized/scaled}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.40\textheight, keepaspectratio]{charts/ch8_quiz8_data_leakage.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        ...
        \end{itemize}
        \textbf{Common methods}: Min-Max $\rightarrow$ [0,1] or Standard $\rightarrow$ mean 0, std 1
...
\begin{frame}{Quiz 10: Answer}
    \begin{exampleblock}{Answer: C -- Depends on data and requirements}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.40\textheight, keepaspectratio]{charts/ch8_quiz7_model_selection.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Model Selection Guidelines:}
        \begin{itemize}
            \item \textbf{ARFIMA}: Long memory, interpretability needed
            \item \textbf{Random Forest}: Nonlinear relations, feature importance
            \item \textbf{LSTM}: Long sequences, complex patterns, sufficient data
        \end{itemize}
        Always validate with time series cross-validation!
        }
    \end{exampleblock}
\end{frame}
