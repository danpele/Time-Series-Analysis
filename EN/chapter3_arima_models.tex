...
\begin{frame}{Real-World Applications}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.55\textheight, keepaspectratio]{ch3_motivation_realworld.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Random Walk: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.6\textheight, keepaspectratio]{ch3_def_random_walk.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
...
\begin{frame}{Case Study: US Real GDP (FRED)}
    ...
    \quantlet{TSA\_ch3\_case\_raw\_data}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3_case_raw_data}
\end{frame}
...
\begin{frame}{Step 1: ADF Test for Stationarity}
    ...
    \end{alertblock}
    \quantlet{TSA\_ch3\_case\_adf\_test}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3_case_adf_test}
\end{frame}

\begin{frame}{Step 2: ACF/PACF Before and After Differencing}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch3_case_acf_diff.pdf}
    \end{center}
    \vspace{-0.2cm}
    \begin{exampleblock}{Top: Slow ACF decay (non-stationary) | Bottom: After differencing, low-order ARMA}
    \end{exampleblock}
    \quantlet{TSA\_ch3\_case\_acf\_diff}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3_case_acf_diff}
\end{frame}
...
\begin{frame}{Step 3: ARIMA Model Comparison}
    ...
    \end{block}
    \quantlet{TSA\_ch3\_case\_model\_comparison}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3_case_model_comparison}
\end{frame}

\begin{frame}{Step 4: Diagnostic Checking}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch3_case_diagnostics.pdf}
    \end{center}
    \vspace{-0.4cm}
    {\footnotesize
    ...
    \quantlet{TSA\_ch3\_case\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3_case_diagnostics}
\end{frame}

\begin{frame}{Step 5: Out-of-Sample Forecasting}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.52\textheight, keepaspectratio]{ch3_case_forecast.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
    ...
    \quantlet{TSA\_ch3\_case\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3_case_forecast}
\end{frame}

\begin{frame}{Step 6: Rolling Forecast with Train/Val/Test}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{ch3_case_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
    ...
    \quantlet{TSA\_ch3\_case\_rolling\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch3_case_rolling_forecast}
\end{frame}
...
\begin{frame}{Key Takeaways}
    ...
    \begin{block}{Main Points}
        \begin{enumerate}\setlength{\itemsep}{0pt}
            \item \textbf{Non-stationarity} common in economic data -- use differencing to transform I(d) to I(0)
            \item \textbf{ARIMA(p,d,q)} combines differencing with ARMA modeling
            \item \textbf{Unit root tests} (ADF, KPSS) help determine integration order $d$
            \item \textbf{Box-Jenkins}: Identify $\to$ Estimate $\to$ Diagnose $\to$ Forecast
            \item \textbf{Forecasts} for I(1) series have growing uncertainty over horizon
        \end{enumerate}
    \end{block}
    \vspace{-0.1cm}
    \begin{alertblock}{Next: Chapter 4 extends ARIMA to handle seasonality (SARIMA)}
    \end{alertblock}
    }
\end{frame}
