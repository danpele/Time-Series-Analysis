...
\begin{frame}{Random Walk: Visual Illustration}
    ...
    \end{center}
    \vspace{-0.2cm}
    \small Left: multiple random walk paths wander unpredictably. Right: variance grows linearly with time.
\end{frame}
...
\begin{frame}{Random Walk with Drift: Visual Illustration}
    ...
    \end{center}
    \vspace{-0.2cm}
    \small Random walk without drift (blue) wanders around zero. With drift (red), there's a systematic trend.
\end{frame}
...
\begin{frame}{ARIMA: Visual Illustration}
    ...
    \end{center}
    \vspace{-0.2cm}
    \small Top: original ARIMA series. Bottom left/right: after differencing, ACF/PACF help identify AR and MA orders.
\end{frame}
...
\begin{frame}{Unit Root Test Results}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.7\textwidth, height=0.55\textheight, keepaspectratio]{ch3_adf_test.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\small
    \begin{itemize}
...
\begin{frame}{ACF/PACF: Levels vs Differenced}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.72\textwidth, height=0.6\textheight, keepaspectratio]{ch3_acf_pacf.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{ARIMA Forecasting: Actual vs Predicted}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.78\textwidth, height=0.55\textheight, keepaspectratio]{ch3_arima_forecast.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\small
    \begin{itemize}
...
\begin{frame}{Model Diagnostics}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.72\textwidth, height=0.6\textheight, keepaspectratio]{ch3_diagnostics.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
