...
\begin{frame}{Seminar Outline}
    ...
    \begin{enumerate}
        ...
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{7.}}] \textbf{AI-Assisted Exercise} -- Critical thinking
    \end{enumerate}
\end{frame}
...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{\footnotesize Prompt to test in ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Using yfinance, download BTC-USD data. Is it stationary? If not, make it stationary. Can I use the returns to predict future prices? Show me.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
