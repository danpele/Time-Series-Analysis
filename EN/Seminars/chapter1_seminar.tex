...
\begin{frame}{Seminar Outline}
    ...
    \begin{enumerate}
        \item[\textcolor{MainBlue}{\textbf{1.}}] \textbf{Overview} -- Key concepts summary
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{2.}}] \textbf{Review Quiz} -- Knowledge check
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{3.}}] \textbf{True/False Questions} -- Conceptual checks
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{4.}}] \textbf{Practice Problems} -- Applied practice
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{5.}}] \textbf{Worked Examples} -- Coding practice
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{6.}}] \textbf{Discussion Topics} -- Critical thinking
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{7.}}] \textbf{AI-Assisted Exercises} -- Critical thinking
    \end{enumerate}
\end{frame}
