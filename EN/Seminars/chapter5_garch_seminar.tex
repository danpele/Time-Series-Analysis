...
\begin{frame}{Seminar Outline}
    ...
    \begin{enumerate}
        ...
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{4.}}] \textbf{Python Workflow} -- Hands-on coding
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{5.}}] \textbf{Summary} -- Key takeaways
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{6.}}] \textbf{AI-Assisted Exercises} -- Critical thinking
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{Test this prompt in ChatGPT/Claude/Copilot}
        \textit{``Download BTC-USD daily data from Yahoo Finance (last 5 years). Fit a GARCH(1,1) model to log returns. Show the news impact curve, forecast volatility for the next 30 days, and calculate 1-day 99\% VaR.''}
    \end{block}
    \vspace{-2mm}
    {\footnotesize
