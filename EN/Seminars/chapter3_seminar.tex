...
\begin{frame}{Quiz 1: Answer}
    ...
    \end{block}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} What is the order of integration if two differences are needed?
...
\begin{frame}{Quiz 2: Random Walk Properties}
    ...
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.15\textheight, keepaspectratio]{sem3_rw_variance.pdf}
    \end{center}
    \vspace{-2mm}
...
\begin{frame}{Quiz 4: Answer}
    ...
    \end{block}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} What does ARIMA(2,1,1) mean?
...
\begin{frame}{Quiz 6: Answer}
    ...
    \end{block}
        ...
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Solutions}: Larger sample, PP or ERS tests, or sequential procedure --- difference and re-test.
        \end{itemize}
        }
    \end{exampleblock}
...
\begin{frame}{Quiz 7: Answer}
    ...
    \begin{exampleblock}{Answer: B -- Artificial negative autocorrelation}
        ...
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Diagnostic}: ACF at lag 1 $\approx -0.5$ signals overdifferencing. Reduce $d$ by 1!
        \end{itemize}
        }
    \end{exampleblock}
...
\begin{frame}{Quiz 10: Answer}
    ...
    \begin{exampleblock}{Answer: B -- ARIMA(0,1,1)}
        ...
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Pattern}: ACF cuts off at lag 1, PACF decays $\Rightarrow$ MA(1) for differenced series. Full model: ARIMA(0,1,1) = IMA(1,1)
        \end{itemize}
        }
    \end{exampleblock}
...
\begin{frame}{Quiz 11: Answer}
    ...
    \begin{exampleblock}{Answer: B -- Removing deterministic trend via regression}
        ...
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Trend-stationary}: Detrend (shocks are temporary). \textbf{Difference-stationary}: Difference (shocks are permanent). Wrong treatment affects the model!
        \end{itemize}
        }
    \end{exampleblock}
...
\begin{frame}{Quiz 13: Answer}
    ...
    \end{block}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} Regressing one random walk on another independent random walk shows?
...
\begin{frame}{Exercise 2: Model Identification}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Suggested model: ARIMA(0,1,1) or IMA(1,1)}
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Exercise 3: ARIMA Equation}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Expanding $(1-\phi_1 L)(1-L) = 1 - L - \phi_1 L + \phi_1 L^2 = 1 - (1+\phi_1)L + \phi_1 L^2$:
...
\begin{frame}{Exercise 5: Confidence Intervals}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item For IMA(1,1), the MA($\infty$) weights are $\psi_0 = 1$, $\psi_j = 1 + \theta_1$ for $j \geq 1$.
            \item \textbf{1-step:} $\Var(e_{T+1}) = \sigma^2 \psi_0^2 = 4$, so $SE = 2$

            $100.6 \pm 1.96(2) = \mathbf{[96.68, 104.52]}$
            \item \textbf{2-step:} $\Var(e_{T+2}) = \sigma^2(\psi_0^2 + \psi_1^2) = 4(1 + 1.3^2) = 10.76$, $SE = 3.28$
