...
\begin{frame}{Quiz 1: Answer}
    ...
    \end{block}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} What does the operator $(1-L^{12})$ do?
...
\begin{frame}{Exercise 1: Expanding the Seasonal Difference}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Therefore: $(1-L)(1-L^{12})Y_t = Y_t - Y_{t-1} - Y_{t-12} + Y_{t-13}$
...
\begin{frame}{Exercise 2: Airline Model Expansion}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Expand the MA side: $(1+\theta_1 L)(1+\Theta_1 L^{12}) = 1 + \theta_1 L + \Theta_1 L^{12} + \theta_1 \Theta_1 L^{13}$
            \item Full model: $Y_t - Y_{t-1} - Y_{t-12} + Y_{t-13} = \varepsilon_t + \theta_1 \varepsilon_{t-1} + \Theta_1 \varepsilon_{t-12} + \theta_1 \Theta_1 \varepsilon_{t-13}$
...
\begin{frame}{Exercise 3: Parameter Count}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Total: 5 parameters}
            \item Note: The differencing orders ($d=1$, $D=0$) don't add parameters -- they're transformations applied to the data.
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Exercise 4: SARIMA Forecasting}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item From the model: $Y_{T+1} = Y_T + Y_{T-11} - Y_{T-12} + \varepsilon_{T+1} + \theta_1 \varepsilon_T + \Theta_1 \varepsilon_{T-11} + \theta_1 \Theta_1 \varepsilon_{T-12}$
            \item Setting $\E[\varepsilon_{T+1}] = 0$:
...
\begin{frame}{Exercise 5: Identifying Seasonal Period}
    ...
    \begin{exampleblock}{Solution}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Note}: Some series have multiple seasonal patterns (e.g., daily data may have weekly AND annual cycles).
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Example: ACF/PACF Interpretation for Seasonal Data}
    ...
    \begin{exampleblock}{Interpretation}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Regular component}: ACF cuts off at 1 $\Rightarrow$ MA(1)
            \item \textbf{Seasonal component}: ACF significant only at lag 12 $\Rightarrow$ seasonal MA(1)
            \item \textbf{Suggested model}: SARIMA$(0,d,1) \times (0,D,1)_{12}$ -- the airline model!
            \item \textbf{Alternative check}: If PACF showed cutoff at seasonal lags instead of ACF, consider seasonal AR terms.
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
\end{frame}
