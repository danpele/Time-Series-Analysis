...
\begin{frame}{Quiz 9: Answer}
    ...
    \end{block}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item {\footnotesize \textbf{Note}: (B) describes the null hypothesis $H_0: r \leq 1$, which is what the test ``tests whether''. (C) describes the alternative $H_1: r > 1$, not what the test tests.}
...
\begin{frame}{Quiz 10: Answer}
    ...
    \end{block}
        ...
        \vspace{0.1cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Bottom line}: Differencing removes the long-run relationship that cointegration represents!
        \end{itemize}
    \end{exampleblock}
    }
    \end{cminipage}
...
\begin{frame}{Discussion: Cointegration vs Correlation}
    ...
    \begin{exampleblock}{Example}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Two independent random walks can have correlation $> 0.9$ purely by chance (spurious correlation). But they're NOT cointegrated---their spread is also I(1).
            \item \textbf{Cointegration} implies a meaningful long-run equilibrium relationship.
        \end{itemize}
    \end{exampleblock}
    }
    \end{cminipage}
...
\begin{frame}{Discussion: Choosing Deterministic Components}
    ...
    \begin{exampleblock}{Practical Advice}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Start with Case 3 (constant unrestricted). Check sensitivity to specification. Use economic reasoning: do levels have trends?
        \end{itemize}
    \end{exampleblock}
    }
    \end{cminipage}
