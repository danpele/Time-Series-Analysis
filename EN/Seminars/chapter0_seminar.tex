...
\begin{frame}{Quiz 1: Answer}
    ...
    \begin{exampleblock}{Answer: C -- Observations are independent and identically distributed}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} Which is NOT a characteristic of time series data?
        \end{itemize}
...
\begin{frame}{Quiz 3: Answer}
    ...
    \begin{exampleblock}{Answer: C -- Forecasts react quickly to recent changes}
        \begin{itemize}
            \item With $\alpha = 0.9$: $\hat{X}_{t+1} = 0.9 X_t + 0.1 \hat{X}_t$
...
\begin{frame}{Quiz 5: Answer}
    ...
    \begin{exampleblock}{Answer: C -- Mean Absolute Percentage Error (MAPE)}
        \begin{itemize}
            \item MAPE $= \frac{100}{n}\sum\left|\frac{e_t}{X_t}\right|$ expresses errors as \textbf{percentages}.
...
\begin{frame}{Quiz 6: Answer}
    ...
    \begin{exampleblock}{Answer: B -- It would violate temporal ordering}
        ...
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Principle}: future data cannot be used to predict the past! Rolling/expanding window CV is recommended.
        \end{itemize}
        }
    \end{exampleblock}
