...
\begin{frame}{Seminar Structure}
    ...
    \begin{enumerate}
        ...
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{4.}}] \textbf{AI-Assisted Exercise} -- Critical thinking
        \vspace{0.15cm}
...
\begin{frame}{AI Exercise: Critical Thinking}
    ...
    \begin{block}{\footnotesize Prompt to test in ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Using yfinance, download SPY data. Decompose it and forecast the next year using exponential smoothing. Which model is best? Show me the results.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
    ...
    \begin{enumerate}\setlength{\itemsep}{0pt}
        ...
        \item Check how it evaluates the models --- does it use train or test RMSE?
        \item Look at the smoothing parameters ($\alpha$, $\beta$, $\gamma$). Are values near 1.0 a problem?
