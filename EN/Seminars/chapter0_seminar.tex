...
\begin{frame}{AI Exercise 1: Decomposition Audit}
    ...
    \begin{enumerate}\setlength{\itemsep}{1pt}
        \item What type of decomposition is appropriate for this data? Justify based on the figures above.
        \item What transformation should you apply to the series before using additive STL?
        \item How would you verify whether the residuals have constant variance?
        \item What are the consequences of choosing the wrong decomposition type for forecasting?
    \end{enumerate}
    }
\end{frame}
...
\end{verbatim}
    ...
    \textbf{Tasks}:
    \begin{enumerate}\setlength{\itemsep}{1pt}
        \item Identify at least three critical errors in the code above.
        \item Explain why the reported MAPE of 1.1\% is misleading.
        \item Rewrite the code correctly and compare results with a seasonal na\"ive benchmark.
    \end{enumerate}
    }
\end{frame}
...
\begin{frame}{AI Exercise 3: Smoothing Parameter Forensics}
    ...
    \textbf{Tasks}:
    \begin{enumerate}\setlength{\itemsep}{1pt}
        \item What do the very large values of $\alpha$, $\beta$ signal about the models?
        \item The AI conclusion is based on training RMSE. Is this correct? Justify.
        \item Analyze the value $\gamma = 0.01$. What are the implications for time-varying seasonality?
        \item Which model would you select and why? Justify using an appropriate selection criterion.
    \end{enumerate}
    }
\end{frame}
