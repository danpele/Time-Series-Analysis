...
\begin{frame}{Quiz 9: Answer}
    ...
    \end{block}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Note: by default, Prophet uses MAP estimation. Prediction intervals come from simulating future trend changepoints and adding historical residual variability, not from full posterior sampling (MCMC is optional via \texttt{mcmc\_samples > 0}).
        \end{itemize}
    \end{exampleblock}
