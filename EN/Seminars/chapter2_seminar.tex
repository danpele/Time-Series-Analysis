...
\begin{frame}{Seminar Outline}
    ...
    \begin{enumerate}
        \item[\textcolor{MainBlue}{\textbf{1.}}] \textbf{Multiple Choice Quiz} --- Checking understanding of ARMA concepts
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{2.}}] \textbf{True/False Questions} --- Conceptual checks
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{3.}}] \textbf{Calculation Exercises} --- Practice with AR/MA
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{4.}}] \textbf{Python Exercises} --- Fitting and diagnostics
        \vspace{0.15cm}
...
\begin{frame}{Quiz 1: Answer}
    \begin{columns}[T]
        ...
        \begin{column}{0.45\textwidth}
            ...
            {\tiny Lag operator: $L^k X_t = X_{t-k}$}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_lag\_operator}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_lag\_operator}
\end{frame}
...
\begin{frame}{Quiz 2: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \textbf{AR(1) stationarity condition:}
            $$|\phi| < 1$$
            ...
            \begin{itemize}
                ...
                \item B: $|1.0| = 1$ (unit root) \incorrect
        ...
        \begin{column}{0.45\textwidth}
            ...
            {\tiny AR(1): stationary region $|\phi| < 1$}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ar1}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ar1}
\end{frame}
...
\begin{frame}{Quiz 3: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}
                \item ACF cuts off after lag $q$ $\Rightarrow$ MA($q$)
                \item PACF cuts off after lag $p$ $\Rightarrow$ AR($p$)
            \end{itemize}

            \vspace{0.2cm}

            Here: ACF cuts off at lag 1, PACF decays

            $\Rightarrow$ \textbf{MA(1)}
        \end{column}
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_def_ma1.pdf}
            {\tiny MA(1): ACF cuts off after lag 1}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ma1}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ma1}
\end{frame}
...
\begin{frame}{Quiz 4: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \textbf{MA(1) invertibility:}

            Requires $|\theta| < 1$

            \vspace{0.2cm}

            Equivalently: the root of $\theta(z) = 1 + \theta z = 0$ must be outside the unit circle.

            Here: $z = -1/1.5 = -0.67$ is \textbf{inside}!

            \vspace{0.2cm}

            $\Rightarrow$ \textcolor{Crimson}{\textbf{Not invertible}}
        \end{column}
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_def_ma1.pdf}
            {\tiny Invertibility: root outside the unit circle}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ma1}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ma1}
\end{frame}
...
\begin{frame}{Quiz 5: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            Special cases:
            \begin{itemize}
                \item $\theta(L) = 1$: Pure AR
                \item $\phi(L) = 1$: Pure MA
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_def_arma.pdf}
            {\tiny ARMA(1,1): combines AR and MA}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_arma}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_arma}
\end{frame}
...
\begin{frame}{Quiz 6: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            BIC penalizes complexity \textbf{more} than AIC (for $n > 7$).
        ...
        \begin{column}{0.45\textwidth}
            ...
            {\tiny Model selection: AIC vs BIC}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_model\_selection}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_model\_selection}
\end{frame}
...
\begin{frame}{Quiz 7: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}
                \item $H_0$: Residuals are white noise
                \item $H_1$: Autocorrelation present
            \end{itemize}
            ...
            $\Rightarrow$ \textcolor{Crimson}{\textbf{Reject $H_0$}}

            The model is \textbf{inadequate} --- try other orders.
        \end{column}
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_diagnostics.pdf}
            {\tiny Diagnostics: ACF should be white noise}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_diagnostics}
\end{frame}
...
\begin{frame}{Quiz 8: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \textbf{AR(1) forecast formula:}
            $$\hat{X}_{n+h|n} = \mu + \phi^h(X_n - \mu)$$

            Since $|\phi| = 0.6 < 1$:
            $$\lim_{h \to \infty} \phi^h = 0$$

            $\Rightarrow$ Forecasts converge to $\mu$.

            \textbf{Mean reversion!}
        \end{column}
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_ar1_forecast.pdf}
            {\tiny AR(1) forecasts: mean reversion}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_forecasting}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_forecasting}
\end{frame}
...
\begin{frame}{Quiz 9: Answer}
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            The roots of $\phi(z) = 0$ must be \textbf{outside} the unit circle ($|z| > 1$).
            ...
            Both inside $\Rightarrow$ \textcolor{Crimson}{\textbf{Non-stationary}}
        \end{column}
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_ar2_stationarity.pdf}
            {\tiny AR(2): roots and the stationarity triangle}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ar2}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ar2}
\end{frame}
...
\begin{frame}{Quiz 10: Answer}
    \begin{columns}[T]
        ...
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_def_ma1.pdf}
            {\tiny MA: ACF cutoff is the signature}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ma1}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ma1}
\end{frame}
...
\begin{frame}{True or False? --- Answers}
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \includegraphics[width=\textwidth]{ch2_ar2_stationarity.pdf}
            {\tiny AR(2): complex roots $\Rightarrow$ cycles}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ar2}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ar2}
\end{frame}
...
\begin{frame}{Exercise 1: Solution}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \textbf{1. Mean:} $\mu = \frac{c}{1-\phi} = \frac{2}{0.3} = \textbf{6.67}$
        ...
        \begin{column}{0.43\textwidth}
            ...
            {\tiny AR(1) simulation and ACF}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ex1\_ar1}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ex1\_ar1}
\end{frame}
...
\begin{frame}{Exercise 2: Solution}
    \begin{columns}[T]
        ...
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ex2\_ma1}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ex2\_ma1}
\end{frame}
...
\begin{frame}{Exercise 3: Solution}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \vspace{0.2cm}
            \textbf{2. Roots (quadratic formula):}
            ...
            Both outside the unit circle $\Rightarrow$ \textcolor{Forest}{\textbf{Stationary}}
        \end{column}
        \begin{column}{0.43\textwidth}
            \includegraphics[width=\textwidth]{ch2_ar2_stationarity.pdf}
            {\tiny Roots outside the circle $\Rightarrow$ stationary}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ex3\_roots}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ex3\_roots}
\end{frame}
...
\begin{frame}{Exercise 4: Solution}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \textbf{Mean:} $\mu = \frac{3}{1-0.8} = \textbf{15}$
        ...
        \begin{column}{0.43\textwidth}
            \includegraphics[width=\textwidth]{ch2_ar1_forecast.pdf}
            {\tiny Forecast converges to the mean}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch2\_ex4\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_ex4\_forecast}
\end{frame}
...
print(model.summary())
    ...
    \quantlet{TSA\_ch2\_python\_simulate}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_python\_simulate}
\end{frame}
...
\begin{frame}{Python Exercise 2: Model Selection}
    ...
    \quantlet{TSA\_ch2\_python\_selection}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_python\_selection}
\end{frame}
...
\begin{frame}{Python Exercise 3: Diagnostic Checking}
    ...
    \quantlet{TSA\_ch2\_python\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch2/TSA\_ch2\_python\_diagnostics}
\end{frame}
