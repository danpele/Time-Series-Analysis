...
\begin{frame}{Quiz 1: Answer}
    ...
    \begin{exampleblock}{Answer: B -- $X_t - 2X_{t-1} + X_{t-2}$}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} What is the result of applying $(1-L)^2$ to $X_t$?
        \end{itemize}
...
\begin{frame}{Quiz 2: Answer}
    ...
    \begin{exampleblock}{Answer: C -- $\phi = -0.8$ (Stationary)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} For which value of $\phi$ is the AR(1) process stationary?
        \end{itemize}
...
\begin{frame}{Quiz 3: Answer}
    ...
    \begin{exampleblock}{Answer: B -- MA(1)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} ACF cuts off at lag 1, PACF decays. What model?
        \end{itemize}
...
\begin{frame}{Quiz 4: Answer}
    ...
    \begin{exampleblock}{Answer: C -- Not invertible ($|\theta| = 1.5 > 1$)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} Is the MA(1) process $X_t = \varepsilon_t + 1.5\varepsilon_{t-1}$ invertible?
        \end{itemize}
...
\begin{frame}{Quiz 5: Answer}
    ...
    \begin{exampleblock}{Answer: C -- ARMA model}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} The compact form $\phi(L)X_t = \theta(L)\varepsilon_t$ represents which model?
        \end{itemize}
...
\begin{frame}{Quiz 6: Answer}
    ...
    \begin{exampleblock}{Answer: C -- The model with lower BIC is preferred}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} When comparing ARMA(1,1) and ARMA(2,1) using BIC, which statement is correct?
        \end{itemize}
...
\begin{frame}{Quiz 7: Answer}
    ...
    \begin{exampleblock}{Answer: C -- Significant autocorrelation in residuals}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} Ljung-Box test on ARMA(2,1) residuals gives p-value = 0.02. What do you conclude?
        \end{itemize}
...
\begin{frame}{Quiz 8: Answer}
    ...
    \begin{exampleblock}{Answer: C -- Forecasts converge to $\mu = 10$}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} AR(1) with $\phi = 0.6$, $\mu = 10$. What happens as $h \to \infty$?
        \end{itemize}
...
\begin{frame}{Quiz 9: Answer}
    ...
    \begin{exampleblock}{Answer: C -- Roots must be outside the unit circle}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} AR(2) has roots $z_1 = 0.8$ and $z_2 = -0.5$. Is it stationary?
        \end{itemize}
...
\begin{frame}{Quiz 10: Answer}
    ...
    \begin{exampleblock}{Answer: B -- Cuts off after lag 2}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Question:} For an MA(2) process, the ACF:
        \end{itemize}
...
\begin{frame}{Exercise 1: AR(1) Properties}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Given: $c = 2$, $\phi = 0.7$, $\sigma^2 = 9$
...
\begin{frame}{Exercise 2: MA(1) Properties}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Given: $\mu = 5$, $\theta = -0.4$, $\sigma^2 = 4$
...
\begin{frame}{Exercise 4: Forecasting}
    ...
    \begin{exampleblock}{Solution}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Given: $c = 3$, $\phi = 0.8$, $\sigma^2 = 4$, $X_{100} = 20$. \textbf{Mean:} $\mu = \frac{3}{1-0.8} = \textbf{15}$
