...
\begin{frame}{Lag Operator: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{lag_operator.pdf}
    \end{center}
...
\begin{frame}{AR(1): Visual Illustration}
    ...
    \end{center}
    \vspace{-0.2cm}
    \small Left: positive $\phi$ creates persistent, smooth patterns. Right: negative $\phi$ creates oscillating behavior around the mean.
\end{frame}
...
\begin{frame}{AR(1) Variance as Function of $\phi$}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{ar1_variance.pdf}
    \end{center}
...
\begin{frame}{AR(1) Theoretical ACF}
    ...
    \end{center}
    \vspace{-0.2cm}
    {\small \textbf{Pattern:} $\rho(h) = \phi^h$ --- exponential decay (or alternating for $\phi < 0$)}
\end{frame}
...
\begin{frame}{AR(p): Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{ch2_def_arp.pdf}
    \end{center}
    \vspace{-0.2cm}
    \small AR(2) can exhibit cyclic behavior. ACF shows damped decay pattern characteristic of AR processes.
\end{frame}

\begin{frame}{AR(2) Stationarity: Unit Circle Visualization}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{unit_circle_stationarity.pdf}
    \end{center}
...
\begin{frame}{Characteristic Polynomial Roots}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{characteristic_roots.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{ARMA Model Structure}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{arma_structure.pdf}
    \end{center}
\end{frame}

\begin{frame}{How ARMA Simulation Works}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{arma_simulation_steps.pdf}
    \end{center}
\end{frame}

\begin{frame}{ARMA Examples}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{arma_examples.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Impulse Response Functions}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{impulse_response.pdf}
    \end{center}
...
\begin{frame}{Wold's Decomposition Theorem}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.70\textheight, keepaspectratio]{wold_representation.pdf}
    \end{center}
...
\begin{frame}{The Box-Jenkins Methodology}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.70\textheight, keepaspectratio]{box_jenkins_flowchart.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{AIC vs BIC: Model Selection}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{aic_bic_comparison.pdf}
    \end{center}
...
\begin{frame}{Parsimony Principle: Bias-Variance Trade-off}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{parsimony_principle.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Estimation Methods Comparison}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{estimation_comparison.pdf}
    \end{center}
\end{frame}

\begin{frame}{Yule-Walker Equations for AR(p)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{yule_walker.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{ARMA Forecasting with Confidence Intervals}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{arma_forecast.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Forecast Error Variance Over Horizon}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{forecast_error_decomposition.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Train/Validation/Test Forecasting Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{forecast_train_val_test.pdf}
    \end{center}
\end{frame}
