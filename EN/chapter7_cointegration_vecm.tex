...
\defbeamertemplate*{title page}{hybrid}[1][]
{
    ...
    \begin{center}
        \href{https://www.ase.ro}{\includegraphics[height=0.95cm]{ase_logo.png}}\hspace{0.2cm}%
        \href{https://theida.net}{\includegraphics[height=0.95cm]{ida_logo.png}}\hspace{0.2cm}%
        \href{https://blockchain-research-center.com}{\includegraphics[height=0.95cm]{brc_logo.png}}\hspace{0.2cm}%
        \href{https://www.ai4efin.ase.ro}{\includegraphics[height=0.95cm]{ai4efin_logo.png}}\hspace{0.2cm}%
        \href{https://ipe.ro/new}{\includegraphics[height=0.95cm]{acad_logo.png}}\hspace{0.2cm}%
    ...
    \hspace{0.4cm}{\usebeamerfont{author}\insertauthor}

    \vspace{0.3cm}

    % Institute/Affiliations (left aligned)
    \hspace{0.5cm}\begin{minipage}[t]{0.88\textwidth}
...
\begin{frame}{Spurious Regression: Visual Example}
    ...
    \quantlet{TSA\_charts/spurious\_regression}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/spurious_regression}
\end{frame}
...
\begin{frame}{Cointegration: Visual Example}
    ...
    \quantlet{TSA\_charts/cointegrated\_series}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/cointegrated_series}
\end{frame}
...
\begin{frame}{Johansen Test: Visual Interpretation}
    \begin{center}
        \includegraphics[width=0.9\textwidth, height=0.7\textheight, keepaspectratio]{charts/johansen_eigenvalues.pdf}
    \end{center}

    {\footnotesize
    Significant eigenvalues (above threshold) indicate cointegrating relationships. First eigenvalue significant $\Rightarrow$ $r = 1$.
    }
    \quantlet{TSA\_charts/johansen\_eigenvalues}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/johansen_eigenvalues}
\end{frame}
...
\begin{frame}{Error Correction Mechanism: Visual}
    ...
    \quantlet{TSA\_charts/error\_correction}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/error_correction}
\end{frame}
...
\begin{frame}{VECM Impulse Response Functions}
    ...
    \quantlet{TSA\_charts/vecm\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/vecm_irf}
\end{frame}
...
\begin{frame}{Example 1: Term Structure of Interest Rates}
    ...
    \quantlet{TSA\_charts/interest\_rates\_coint}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/interest_rates_coint}
\end{frame}
...
\begin{frame}{Example 2: Pairs Trading in Finance}
    ...
    \quantlet{TSA\_charts/pairs\_trading}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/pairs_trading}
\end{frame}
...
\begin{frame}{Example 3: Purchasing Power Parity (PPP)}
    ...
    \quantlet{TSA\_charts/ppp\_cointegration}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ppp_cointegration}
\end{frame}
...
\begin{frame}{Step 1: Data Visualization}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch7\_case\_raw\_data}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch7_case_raw_data}
\end{frame}
...
\begin{frame}{Step 2: Unit Root Tests}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch7\_case\_unit\_root}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch7_case_unit_root}
\end{frame}
...
\begin{frame}{Step 3: Engle-Granger Cointegration Test}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch7\_case\_cointegration}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch7_case_cointegration}
\end{frame}
...
\begin{frame}{Step 4: VECM Estimation}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch7\_case\_vecm}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch7_case_vecm}
\end{frame}
...
\begin{frame}{Step 5: Impulse Response Functions}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch7\_case\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch7_case_irf}
\end{frame}
...
\begin{frame}{Step 6: Forecasting}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch7\_case\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch7_case_forecast}
\end{frame}
