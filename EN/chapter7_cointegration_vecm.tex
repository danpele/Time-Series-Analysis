...
\begin{frame}{Spurious Regression: Visual Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{spurious_regression.pdf}
    \end{center}
...
\begin{frame}{Cointegration: Visual Example}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{cointegrated_series.pdf}
    \end{center}
...
\begin{frame}{Error Correction Mechanism: Visual}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{error_correction.pdf}
    \end{center}
...
\begin{frame}{VECM Impulse Response Functions}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{vecm_irf.pdf}
    \end{center}
...
\begin{frame}{Example 1: Term Structure of Interest Rates}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{interest_rates_coint.pdf}
    \end{center}
...
\begin{frame}{Example 2: Pairs Trading in Finance}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{pairs_trading.pdf}
    \end{center}
...
\begin{frame}{Example 3: Purchasing Power Parity (PPP)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ppp_cointegration.pdf}
    \end{center}
