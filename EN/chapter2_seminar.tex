...
\begin{frame}{Quiz 9: Solution}
    \begin{exampleblock}{Answer: C -- Roots must be outside the unit circle}
        ...
        $\succ$ \textcolor{Crimson}{\textbf{Non-stationary}} (actually explosive)
...
\begin{frame}{Exercise 2: Solution}
    ...
    \textbf{5. Invertibility:} $|\theta| = 0.4 < 1$ $\succ$ \textcolor{Forest}{\textbf{Yes, invertible}}
\end{frame}
...
\begin{frame}{Exercise 3: Solution}
    ...
    $\succ$ \textcolor{Forest}{\textbf{Stationary}} (roots outside unit circle)
\end{frame}
