...
\begin{frame}{Data Sources and Software}
    ...
    \begin{itemize}
        \item \texttt{statsmodels} -- ARIMA models for Python
        \item \texttt{pmdarima} -- Automatic ARIMA selection
        \item \texttt{pandas} -- Time series data manipulation
    ...
    \begin{itemize}
        \item Simulated AR, MA, and ARMA processes
