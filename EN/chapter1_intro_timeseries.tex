...
\begin{frame}{White Noise vs Random Walk: Comparison}
    ...
    \end{itemize}
    }\quantlet{TSA\_ch1\_wn\_rw}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_wn_rw}
\end{frame}
...
\begin{frame}{ACF Patterns for Different Processes}
    ...
    \end{itemize}
    }\quantlet{TSA\_ch1\_acf\_examples}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_acf_examples}
\end{frame}
