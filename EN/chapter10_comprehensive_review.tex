...
\begin{frame}{Real Datasets for This Chapter}
    \begin{columns}[T]
        \begin{column}{0.32\textwidth}
            \begin{block}{\textcolor{BitcoinOrange}{Bitcoin} Returns}
                \begin{itemize}
                    \item Daily crypto data
                    \item 2019-2024
        ...
        \end{column}
        \begin{column}{0.32\textwidth}
            \begin{block}{\textcolor{Orange}{Sunspot} Numbers}
                \begin{itemize}
                    \item Monthly 1990-2023
                    \item Classic 11-year cycle
                    \item Long-period seasonality
                    \item SARIMA analysis
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.32\textwidth}
            \begin{block}{\textcolor{MainBlue}{US Unemployment}}
                \begin{itemize}
                    \item Monthly 2015-2023
