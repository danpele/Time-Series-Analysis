...
\begin{frame}{Bitcoin: Final Test Set Evaluation}
    \begin{block}{Procedure}
        Refit GARCH(1,1) on Training + Validation, evaluate on \textbf{held-out test set}.
    \end{block}
...
\begin{frame}{Summary: Model Comparison}
    ...
    \begin{tabular}{lllll}
        ...
        \midrule
        Bitcoin & Volatility clustering & GARCH(1,1) & $\sigma_t^2$ dynamics & 2.82 \\
