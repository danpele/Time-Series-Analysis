...
\begin{frame}{Train/Validation/Test Framework}
    ...
    \begin{columns}[T]
        ...
        \end{block}
    \end{columns}
    \quantlet{TSA\_../charts/train\_val\_test\_split}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/train_val_test_split}
\end{frame}
...
\begin{frame}{Bitcoin: Volatility Clustering}
    ...
    \end{exampleblock}
    \quantlet{TSA\_../charts/btc\_returns}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/btc_returns}
\end{frame}
...
\begin{frame}{Bitcoin: Evidence for GARCH}
    ...
    \end{alertblock}
    \quantlet{TSA\_../charts/btc\_acf\_squared}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/btc_acf_squared}
\end{frame}
...
\begin{frame}{Bitcoin: Final Test Set Evaluation}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/garch\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/garch_forecast}
\end{frame}
...
\begin{frame}{GARCH: Multi-Step Forecasts Converge}
    ...
    \end{exampleblock}
    \quantlet{TSA\_../charts/garch\_convergence}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/garch_convergence}
\end{frame}
...
\begin{frame}{GARCH: Rolling One-Step-Ahead Solution}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/rolling\_vs\_multistep}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/rolling_vs_multistep}
\end{frame}
...
\begin{frame}{Sunspots: The 11-Year Solar Cycle}
    ...
    \end{alertblock}
    \quantlet{TSA\_../charts/sunspots\_acf}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/sunspots_acf}
\end{frame}
...
\begin{frame}{Fourier Terms for Seasonality}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/fourier\_terms}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/fourier_terms}
\end{frame}
...
\begin{frame}{Sunspots: Forecast Results}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/sunspot\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/sunspot_forecast}
\end{frame}
...
\begin{frame}{Unemployment: Train / Validation / Test Split}
    ...
    \end{block}
    \quantlet{TSA\_../charts/unemployment\_train\_val\_test}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/unemployment_train_val_test}
\end{frame}
...
\begin{frame}{Unemployment: Preliminary Analysis}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/unemployment\_acf\_pacf}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/unemployment_acf_pacf}
\end{frame}
...
\begin{frame}{Unemployment: Stationarity Tests}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/unemployment\_stationarity}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/unemployment_stationarity}
\end{frame}
...
\begin{frame}{Unemployment: Model Selection (Validation Set)}
    ...
    \end{block}
    \quantlet{TSA\_../charts/sarima\_model\_selection}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/sarima_model_selection}
\end{frame}
...
\begin{frame}{Unemployment: SARIMA Parameters}
    ...
    \end{block}
    \quantlet{TSA\_../charts/sarima\_parameters}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/sarima_parameters}
\end{frame}
...
\begin{frame}{Unemployment: SARIMA Diagnostics}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/sarima\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/sarima_diagnostics}
\end{frame}
...
\begin{frame}{Unemployment: SARIMA Rolling Forecast}
    ...
    \end{alertblock}
    \quantlet{TSA\_../charts/sarima\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/sarima_forecast}
\end{frame}
...
\begin{frame}{Unemployment: Prophet Forecast Results}
    ...
    \end{block}
    \quantlet{TSA\_../charts/unemployment\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/unemployment_forecast}
\end{frame}
...
\begin{frame}{Unemployment: SARIMA vs Prophet Comparison}
    ...
    \begin{columns}[T]
        ...
        \end{block}
    \end{columns}
    \quantlet{TSA\_../charts/prophet\_vs\_sarima\_unemployment}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/prophet_vs_sarima_unemployment}
\end{frame}
...
\begin{frame}{VAR: Multivariate Economic Data}
    ...
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/economic\_vars}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/economic_vars}
\end{frame}
...
\begin{frame}{Granger Causality Analysis}
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/granger\_heatmap}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/granger_heatmap}
\end{frame}
...
\begin{frame}{Impulse Response Functions (IRF)}
    \begin{columns}[T]
        ...
        \end{exampleblock}
    \end{columns}
    \quantlet{TSA\_../charts/irf\_gdp\_shock}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/irf_gdp_shock}
\end{frame}
...
\begin{frame}{IRF: Unemployment Shock}
    ...
    \end{block}
    \quantlet{TSA\_../charts/irf\_unemp\_shock}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/irf_unemp_shock}
\end{frame}
...
\begin{frame}{IRF: Fed Rate Shock}
    ...
    \end{block}
    \quantlet{TSA\_../charts/irf\_fed\_shock}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/irf_fed_shock}
\end{frame}
...
\begin{frame}{VAR: Forecast (Train/Val/Test)}
    ...
    \end{block}
    \quantlet{TSA\_../charts/var\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/var_forecast}
\end{frame}
...
\begin{frame}{Summary: Model Comparison}
    ...
    \end{exampleblock}
    \quantlet{TSA\_../charts/model\_comparison}{https://github.com/QuantLet/TSA/tree/main/TSA_../charts/model_comparison}
\end{frame}
