...
\begin{frame}{GARCH: Multi-Step Forecasts Converge}
    ...
    \begin{columns}[T]
        ...
        \begin{alertblock}{The Problem}
            GARCH forecasts converge to unconditional variance $\bar{\sigma}^2 = \frac{\omega}{1-\alpha-\beta}$
        \end{alertblock}

        \column{0.5\textwidth}
        \begin{exampleblock}{Intuition}
            After a shock, volatility gradually returns to its long-run average level.
        \end{exampleblock}
    \end{columns}
\end{frame}
...
\begin{frame}{Unemployment: COVID-19 Structural Break}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{The Challenge}
            \begin{itemize}
                \item Pre-COVID: 3.5\% (50-year low)
                \item April 2020: \textbf{14.8\%} peak
                \item Largest monthly jump in US history
            \end{itemize}
        \end{block}

        \column{0.5\textwidth}
        \begin{exampleblock}{Why Not ARIMA?}
            ARIMA treats sudden jumps as \textbf{outliers}. Prophet detects \textbf{changepoints} and adapts the trend accordingly.
        \end{exampleblock}
    \end{columns}
\end{frame}
