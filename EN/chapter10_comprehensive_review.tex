...
\begin{frame}{Bitcoin: Volatility Clustering}
    ...
    \begin{exampleblock}{Observation}
        Large returns (positive or negative) tend to be followed by large returns, and small returns by small returns. This is \textbf{volatility clustering}---the key phenomenon that GARCH models capture.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{GARCH Forecasting: Rolling vs Multi-Step}
    \begin{columns}[T]
        ...
        \begin{alertblock}{Why Rolling One-Step-Ahead?}
            ...
            \end{equation}
            This produces a \textbf{flat line}!
        \end{alertblock}
        ...
        \begin{block}{Multi-Step}
            \begin{itemize}
                ...
                \item \textcolor{Crimson}{Flat line forecast}
            \end{itemize}
        \end{block}
