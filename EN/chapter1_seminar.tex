...
\begin{frame}{Quiz 4: Stationarity}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 5: Unit Root Tests}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 6: Forecast Evaluation}
    \begin{alertblock}{Question}
        Which metric is most appropriate for comparing forecast accuracy across different time series with different scales?
    \end{alertblock}
...
\begin{frame}{Quiz 7: Trend Types}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 8: ACF Interpretation}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 9: Holt's Method}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 10: White Noise}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 11: Forecast Horizon}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 12: Seasonality Detection}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 13: Cross-Validation in Time Series}
    \begin{alertblock}{Question}
...
\begin{frame}{Quiz 14: MAPE Limitation}
    \begin{alertblock}{Question}
