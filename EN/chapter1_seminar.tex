...
\begin{frame}{Quiz 2: Answer}
    \begin{exampleblock}{Answer: C -- When seasonal fluctuations grow proportionally with the level}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{sem1_decomposition.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 8: Answer}
    \begin{exampleblock}{Answer: B -- The series is likely non-stationary}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{sem1_acf_decay.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 9: Answer}
    \begin{exampleblock}{Answer: B -- A trend component}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{sem1_holt_method.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 10: Answer}
    \begin{exampleblock}{Answer: D -- Normality is NOT required}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.45\textheight, keepaspectratio]{sem1_white_noise.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 11: Answer}
    \begin{exampleblock}{Answer: C -- They become wider}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.45\textheight, keepaspectratio]{sem1_forecast_intervals.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 13: Answer}
    \begin{exampleblock}{Answer: B -- It would violate temporal ordering}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.5\textheight, keepaspectratio]{sem1_timeseries_cv.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
