...
\begin{frame}{Quiz 1: Answer}
    \begin{exampleblock}{Answer: B -- SARIMA allows only one seasonal period}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.5\textheight, keepaspectratio]{charts/ch9_quiz1_multiple_seasonality.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 2: Answer}
    \begin{exampleblock}{Answer: B -- Trigonometric, Box-Cox, ARMA, Trend, Seasonal}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch9_quiz2_tbats_components.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{TBATS components}:
        \begin{itemize}
            \item \textbf{T}rigonometric: Fourier terms for seasonality
            \item \textbf{B}ox-Cox: Variance stabilization
            \item \textbf{A}RMA: Error autocorrelation
            \item \textbf{T}rend: Damped local trend
            \item \textbf{S}easonal: Multiple seasonal periods
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Quiz 3: Answer}
    \begin{exampleblock}{Answer: B -- Allows more flexible seasonal shapes}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch9_quiz3_fourier_harmonics.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 4: Answer}
    \begin{exampleblock}{Answer: B -- Trend, seasonality, holidays, and error}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch9_quiz4_prophet_decomposition.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Prophet model}: $y(t) = g(t) + s(t) + h(t) + \varepsilon_t$
        \begin{itemize}
            \item $g(t)$: Trend (piecewise linear or logistic growth)
            \item $s(t)$: Seasonality (Fourier series)
...
\begin{frame}{Quiz 5: Answer}
    \begin{exampleblock}{Answer: B -- Known holidays and changepoints}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{charts/ch9_quiz5_prophet_vs_tbats.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 6: Answer}
    \begin{exampleblock}{Answer: B -- Multiplicative seasonality}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch9_quiz6_seasonality_mode.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 7: Answer}
    \begin{exampleblock}{Answer: B -- Adjust trend slope at specific points}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch9_quiz7_changepoints.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 8: Answer}
    \begin{exampleblock}{Answer: C -- Standard SARIMA is sufficient}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.40\textheight, keepaspectratio]{charts/ch9_quiz8_model_decision.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Quiz 9: Answer}
    \begin{exampleblock}{Answer: B -- Sampling from posterior distribution}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch9_quiz9_prophet_uncertainty.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Prophet uses Bayesian estimation}: \\
        \begin{itemize}
            \item MAP estimation for point forecasts
            \item MCMC or simulation for uncertainty intervals
...
\begin{frame}{Quiz 10: Answer}
    \begin{exampleblock}{Answer: D -- TBATS or Prophet depending on needs}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{charts/ch9_quiz10_energy_example.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Both can handle multiple seasonality}: \\
        \begin{itemize}
            \item If holiday effects are crucial $\Rightarrow$ \textbf{Prophet} (explicit holiday modeling)
            \item If automatic model selection is preferred $\Rightarrow$ \textbf{TBATS}
...
holidays = pd.DataFrame({
    ...
    'ds': pd.to_datetime(['2024-02-14', '2025-02-14',
                          '2024-03-31', '2025-04-20',  # Easter dates
...
\begin{frame}{Example: Retail Sales Forecasting with Prophet}
    ...
    \begin{block}{Scenario}
        Monthly retail sales data (2018-2023) with:
        \begin{itemize}
            \item Strong December peaks (Christmas shopping)
            \item COVID-19 impact in 2020 (structural break)
            \item Growing trend over time
        \end{itemize}
    \end{block}
...
\begin{verbatim}
model = Prophet(
    seasonality_mode='multiplicative',  # Seasonal amplitude grows
...
\end{verbatim}
    ...
    \begin{alertblock}{Key Decision}
        Used multiplicative seasonality because December effect is proportional to baseline sales level.
    \end{alertblock}
    }
\end{frame}
...
\begin{frame}{Example: Energy Demand with TBATS}
    {\small
    \begin{block}{Scenario}
        Hourly electricity demand with:
        \begin{itemize}
            \item Intraday pattern (24 hours)
            \item Weekly pattern (168 hours)
            \item Annual pattern (8760 hours)
        \end{itemize}
    \end{block}
...
# Specify multiple seasonal periods
energy_msts <- msts(energy_data,
                    seasonal.periods = c(24, 168, 8760))

# Fit TBATS - automatic selection of Fourier terms
fit <- tbats(energy_msts)
