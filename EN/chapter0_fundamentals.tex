...
\begin{frame}{Time Series Are Everywhere}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.60\textheight, keepaspectratio]{ch1_motivation_everywhere.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Why Study Time Series?}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{ch1_motivation_forecast.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Understanding Time Series Structure}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.62\textheight, keepaspectratio]{ch1_motivation_components.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Common Time Series Patterns}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.42\textheight, keepaspectratio]{ch1_ts_patterns.pdf}
    \end{center}
    \vspace{-0.2cm}
    \begin{block}{Pattern Types}
        \begin{itemize}
            ...
            \item \textbf{Cyclical}: Medium-term fluctuations (business cycles, 2--10 years)
...
\begin{frame}{Time Series: Visual Definition}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.54\textheight, keepaspectratio]{timeseries_definition.pdf}
    \end{center}
...
\begin{frame}{Types of Data: Comparison}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.52\textheight, keepaspectratio]{data_types_comparison.pdf}
    \end{center}
    \vspace{-0.2cm}
    \begin{center}
    \small
...
\begin{frame}{Examples of Time Series Data}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.54\textheight, keepaspectratio]{multiple_assets.pdf}
    \end{center}
...
\begin{frame}{Time Series Decomposition: Visual Example}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.46\textheight, keepaspectratio]{ch1_decomposition.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
...
\begin{frame}{The Cyclical Component}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.50\textheight, keepaspectratio]{ch1_cyclical_component.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\small
    \begin{columns}[T]
...
\begin{frame}{Additive vs Multiplicative: Comparison}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{additive_vs_multiplicative.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Seasonal Indices: Interpretation}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.44\textheight, keepaspectratio]{seasonal_pattern.pdf}
    \end{center}
    \begin{exampleblock}{Interpretation}
        \begin{itemize}
...
\begin{frame}{Moving Average Smoothing}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch1_moving_average.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Simple Exponential Smoothing: Effect of $\alpha$}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{simple_exp_smoothing.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Holt's Method: Visualization}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.45\textheight, keepaspectratio]{holt_method.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretation}
        \begin{itemize}
            ...
            \item $\alpha$ controls responsiveness to level changes
            \item $\beta^*$ controls responsiveness to trend changes
        \end{itemize}
    \end{exampleblock}
...
\begin{frame}{Holt-Winters: Capturing Seasonality}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{holt_winters.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Forecast Evaluation: Visual Example}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch1_forecast_eval.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Residual Diagnostics: Visualization}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.46\textheight, keepaspectratio]{residual_diagnostics.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Train / Validation / Test Split}
    ...
    \begin{center}
        \includegraphics[width=0.55\textwidth]{train_test_validation.pdf}
    \end{center}
...
\begin{frame}{Dummy Variables vs Fourier Terms}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{seasonality_fourier_dummies.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Detrending Methods: Comparison}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{detrending_methods.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Trend Estimation: Multiple Approaches}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{trend_estimation_comparison.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretation}
...
\begin{frame}{HP Filter: Effect of $\lambda$}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.52\textheight, keepaspectratio]{ch1_hp_filter_lambda.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Seasonal Adjustment: Visualization}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{seasonal_adjustment.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{block}{Result}
...
\begin{frame}{Example: Stochastic Trend (Random Walk)}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{stochastic_trend_example.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Key}
...
\begin{frame}{Side-by-Side Comparison}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{trend_comparison_sidebyside.pdf}
    \end{center}
    \vspace{-0.3cm}
