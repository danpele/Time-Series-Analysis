...
\begin{frame}{Estimating the Parameter $d$}
    ...
    {\footnotesize
    In Python: \texttt{arch} package, \texttt{statsmodels.tsa.arima.model.ARIMA} cu \texttt{order=(p,d,q)} where $d$ can be fractional.
    }
\end{frame}
...
\begin{frame}{Model Comparison: Accuracy vs Computational Cost}
    ...
    \vspace{-0.3cm}
    {\footnotesize
    \textbf{Trade-off}: Modelele ML can have slightly better accuracy, but computational cost increases significantly. For small data or interpretability, ARIMA/ARFIMA remain excellent choices.
    }
\end{frame}
...
\begin{frame}{Comparison: Results on EUR/RON}
    ...
    \begin{tabular}{l|c|c|c|c}
        ...
        \midrule
        ARIMA(1,0,1) & 0.0938 & 0.0716 & 0.12 & Yes \\
        Random Forest & 0.0626 & 0.0483 & 0.85 & Yes (features) \\
        LSTM & 0.0683 & 0.0526 & 12.3 & No \\
        \bottomrule
    \end{tabular}
    \end{center}
