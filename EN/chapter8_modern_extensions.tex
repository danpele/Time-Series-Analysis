...
\begin{frame}{ARFIMA Example: S\&P 500 Realized Volatility}
    ...
    \begin{columns}[T]
        \begin{column}{0.62\textwidth}
            \includegraphics[width=\textwidth, height=0.82\textheight, keepaspectratio]{ch8_arfima_real_data.pdf}
        \end{column}
...
\begin{frame}{From Biological to Artificial Neurons}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.45\textheight, keepaspectratio]{ch8_neuron_comparison.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Activation Functions: Why Do We Need Them?}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.52\textheight, keepaspectratio]{ch8_activation_functions.pdf}
    \end{center}
    \vspace{-0.3cm}
