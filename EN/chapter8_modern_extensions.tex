...
\newcommand{\quantlet}[2]{%
    \par\vspace{0.1cm}%
    \hfill\href{#2}{%
        \raisebox{-0.2em}{\includegraphics[height=0.9em]{ql_logo.png}}%
...
\begin{frame}{Learning Objectives}
    \begin{block}{By the end of this chapter, you will be able to:}
        \begin{itemize}
            ...
            \begin{itemize}
                \item Estimate and interpret ARFIMA models
...
\begin{frame}{Effect of Parameter $d$ on ACF}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch8_arfima_d_effect.pdf}
    \end{center}
    \vspace{-0.4cm}
    {\footnotesize
    The higher $d$, the slower autocorrelations decay. As $d \to 0.5$, autocorrelations remain significant even at very large lags.
    }\hfill\quantlet{TSA\_ch8\_arfima\_d\_effect}{https://github.com/QuantLet/TSA/tree/main/ch8_arfima_d_effect}
\end{frame}
...
\begin{frame}{Real Data Example: EUR/RON Long Memory Analysis}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch8_eurron_long_memory.pdf}
    \end{center}
    \vspace{-0.4cm}
    {\footnotesize
    ...
    }\hfill\quantlet{TSA\_ch8\_eurron\_long\_memory}{https://github.com/QuantLet/TSA/tree/main/ch8_eurron_long_memory}
\end{frame}
...
\begin{frame}{ARFIMA Example: S\&P 500 Realized Volatility}
    ...
    \begin{columns}[T]
        \begin{column}{0.62\textwidth}
            \includegraphics[width=\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch8_arfima_real_data.pdf}
        \end{column}
        \begin{column}{0.36\textwidth}
            \begin{block}{Estimation Results}
                \begin{itemize}\setlength{\itemsep}{2pt}
                    \item Data: S\&P 500 (2015--2024)
                    \item Hurst: $H = 0.92$
                    \item $d = H - 0.5 = 0.42$
                    \item Strong long memory
                \end{itemize}
            \end{block}
            \vspace{0.2cm}
            \begin{alertblock}{Key Insight}
                \begin{itemize}\setlength{\itemsep}{2pt}
                    \item Volatility has \textbf{long memory}
                    \item Shocks persist longer than ARMA
                    \item Use ARFIMA or FIGARCH!
                \end{itemize}
            \end{alertblock}
        \end{column}
    \end{columns}
\quantlet{TSA\_ch8\_arfima\_sp500}{https://github.com/QuantLet/TSA/tree/main/ch8_arfima_sp500}
\end{frame}
...
\begin{frame}{Real Example: Long Memory in Volatility}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.68\textheight, keepaspectratio]{charts/ch8_volatility_long_memory.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{From Biological to Artificial Neurons}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.45\textheight, keepaspectratio]{charts/ch8_neuron_comparison.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{The Analogy}
        \textbf{Dendrites} $\rightarrow$ \textbf{Inputs} $x_i$ \quad
        \textbf{Synapses} $\rightarrow$ \textbf{Weights} $w_i$ \quad
        \textbf{Soma} $\rightarrow$ \textbf{Sum + Activation} \quad
        \textbf{Axon} $\rightarrow$ \textbf{Output} $y$
    \end{block}
    }
\quantlet{TSA\_ch8\_neuron\_comparison}{https://github.com/QuantLet/TSA/tree/main/ch8_neuron_comparison}
\end{frame}

\begin{frame}{Recurrent Neural Networks (RNN)}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.38\textheight, keepaspectratio]{charts/ch8_rnn_unfolded.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
        ...
        \end{column}
    \end{columns}
\quantlet{TSA\_ch8\_rnn\_unfolded}{https://github.com/QuantLet/TSA/tree/main/ch8_rnn_unfolded}
\end{frame}
...
\begin{frame}{LSTM Cell Architecture}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.52\textheight, keepaspectratio]{charts/ch8_lstm_cell.pdf}
    \end{center}
    \vspace{-0.4cm}
    {\footnotesize
...
\quantlet{TSA\_ch8\_lstm\_cell}{https://github.com/QuantLet/TSA/tree/main/ch8_lstm_cell}
\end{frame}

\begin{frame}{Activation Functions: Why Do We Need Them?}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.52\textheight, keepaspectratio]{charts/ch8_activation_functions.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Time Series Cross-Validation}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.68\textheight, keepaspectratio]{charts/ch8_timeseries_cv.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Case Study: Data Overview}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.75\textheight, keepaspectratio]{charts/ch8_data_split.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
    \textbf{Train}: 1513 obs (70\%) \quad \textbf{Validation}: 324 obs (15\%) \quad \textbf{Test}: 325 obs (15\%)
    }
\quantlet{TSA\_ch8\_data\_split}{https://github.com/QuantLet/TSA/tree/main/ch8_data_split}
\end{frame}

\begin{frame}{Case Study: Model Predictions}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{charts/ch8_model_predictions.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{center}
...
\quantlet{TSA\_ch8\_model\_predictions}{https://github.com/QuantLet/TSA/tree/main/ch8_model_predictions}
\end{frame}

\begin{frame}{Case Study: Best Model Performance}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.55\textheight, keepaspectratio]{charts/ch8_best_model_prediction.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{columns}[T]
        ...
        \end{column}
    \end{columns}
\quantlet{TSA\_ch8\_best\_model}{https://github.com/QuantLet/TSA/tree/main/ch8_best_model}
\end{frame}
...
\begin{frame}{Key Takeaways}
    \begin{itemize}\setlength{\itemsep}{2pt}
        \item \textbf{No Free Lunch}:
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item No universally best method
            \item Depends on data, sample size, objectives
        \end{itemize}
        \item \textbf{Parsimony Principle}:
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Simple models often outperform complex ones
            \item Always benchmark against naive methods
        \end{itemize}
        \item \textbf{Long Memory Matters}:
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Many series exhibit long memory (volatility, hydrology)
            \item ARFIMA provides a parsimonious solution
        \end{itemize}
        \item \textbf{Feature Engineering $>$ Model Complexity}:
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Thoughtful features yield greater improvements
            \item More important than switching algorithms
        \end{itemize}
        \item \textbf{Proper Validation is Critical}:
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Time series CV prevents data leakage
            \item Provides reliable performance estimates
        \end{itemize}
    \end{itemize}
\end{frame}
