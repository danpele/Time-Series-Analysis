...
\begin{frame}{Why Univariate Models Are Not Enough}
    \vspace{-0.4cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.55\textheight, keepaspectratio]{ch5_motivation_univariate.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Types of Granger Causality}
    ...
    \begin{block}{Economic Examples}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Money $\succ$ Output? (monetarist); Stock prices $\leftrightarrow$ Volume (bidirectional)
        \end{itemize}
    \end{block}
    }
\end{frame}
...
\begin{frame}{Cross-Correlation: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch5_def_ccf.pdf}
    \end{center}
    \vspace{-0.2cm}
