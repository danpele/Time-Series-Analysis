...
% TITLE INFORMATION
%=============================================================================
\title[Chapter 6: VAR \& Granger]{Chapter 6: VAR Models and Granger Causality}
...
\begin{frame}[plain]
    ...
    \begin{center}
        ...
        {\Huge\textbf{\textcolor{MainBlue}{Chapter 6: VAR Models \& Granger Causality}}}\\[0.5cm]
        {\Large\textcolor{IDAred}{Multivariate Time Series}}
    \end{center}
    \vfill
...
\begin{frame}{Step 1: Data Visualization}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{charts/ch6_case_raw_data.pdf}
    \end{center}
\end{frame}

\begin{frame}{Step 2: Stationarity Tests}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{charts/ch6_case_stationarity.pdf}
    \end{center}
\end{frame}

\begin{frame}{Step 3: Lag Selection and VAR Estimation}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{charts/ch6_case_lag_selection.pdf}
    \end{center}
\end{frame}

\begin{frame}{Step 4: Granger Causality Tests}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{charts/ch6_case_granger.pdf}
    \end{center}
\end{frame}

\begin{frame}{Step 5: Impulse Response Functions}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{charts/ch6_case_irf.pdf}
    \end{center}
\end{frame}

\begin{frame}{Step 6: Forecasting}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{charts/ch6_case_forecast.pdf}
    \end{center}
\end{frame}
