...
\begin{frame}{Seasonality: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch4_def_seasonality.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Seasonal Difference: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch4_def_seasonal_diff.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{SARIMA: Visual Illustration}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch4_def_sarima.pdf}
    \end{center}
    \vspace{-0.2cm}
