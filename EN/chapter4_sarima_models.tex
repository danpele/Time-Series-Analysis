...
\begin{frame}{Motivating Example: Seasonality Is Everywhere}
    ...
    \quantlet{TSA\_charts/ch4\_motivation\_seasonal}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_motivation_seasonal}
\end{frame}
...
\begin{frame}{Understanding Seasonal Components}
    ...
    \quantlet{TSA\_charts/ch4\_motivation\_decomposition}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_motivation_decomposition}
\end{frame}
...
\begin{frame}{Real-World Application: Monthly Patterns}
    ...
    \quantlet{TSA\_charts/ch4\_motivation\_monthly}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_motivation_monthly}
\end{frame}
...
\begin{frame}{Why Do We Need SARIMA?}
    ...
    \quantlet{TSA\_charts/ch4\_motivation\_why\_sarima}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_motivation_why_sarima}
\end{frame}
...
\begin{frame}{Seasonality: Visual Illustration}
    ...
    \end{exampleblock}
    \quantlet{TSA\_charts/ch4\_def\_seasonality}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_def_seasonality}
\end{frame}
...
\begin{frame}{Example: Airline Passengers Data}
    ...
    \quantlet{TSA\_charts/ch4\_airline\_data}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_airline_data}
\end{frame}
...
\begin{frame}{Visualizing Seasonal Patterns}
    ...
    \quantlet{TSA\_charts/ch4\_seasonal\_boxplot}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_seasonal_boxplot}
\end{frame}
...
\begin{frame}{ACF Reveals Seasonal Structure}
    ...
    \quantlet{TSA\_charts/ch4\_acf\_seasonality}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_acf_seasonality}
\end{frame}
...
\begin{frame}{Seasonal Difference: Visual Illustration}
    ...
    \end{block}
    \quantlet{TSA\_charts/ch4\_def\_seasonal\_diff}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_def_seasonal_diff}
\end{frame}
...
\begin{frame}{Effect of Differencing Operations}
    ...
    \quantlet{TSA\_charts/ch4\_differencing\_effect}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_differencing_effect}
\end{frame}
...
\begin{frame}{ACF Before and After Differencing}
    ...
    \quantlet{TSA\_charts/ch4\_acf\_differencing}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_acf_differencing}
\end{frame}
...
\begin{frame}{SARIMA: Visual Illustration}
    ...
    \end{alertblock}
    \quantlet{TSA\_charts/ch4\_def\_sarima}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_def_sarima}
\end{frame}
...
\begin{frame}{Case Study: Airline Passengers Data}
    ...
    \quantlet{TSA\_charts/ch4\_case\_raw\_data}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_case_raw_data}
\end{frame}
...
\begin{frame}{Step 1: Transformations}
    ...
    \quantlet{TSA\_charts/ch4\_case\_transformations}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_case_transformations}
\end{frame}
...
\begin{frame}{Step 2: ACF/PACF Analysis}
    ...
    \quantlet{TSA\_charts/ch4\_case\_acf\_pacf}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_case_acf_pacf}
\end{frame}
...
\begin{frame}{Step 3: Model Comparison}
    ...
    \quantlet{TSA\_charts/ch4\_case\_model\_comparison}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_case_model_comparison}
\end{frame}
...
\begin{frame}{Step 4: Residual Diagnostics}
    ...
    \quantlet{TSA\_charts/ch4\_case\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_case_diagnostics}
\end{frame}
...
\begin{frame}{Step 5: Forecasting}
    ...
    \quantlet{TSA\_charts/ch4\_case\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_case_forecast}
\end{frame}
...
\begin{frame}{Quiz Question 1: Answer}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch4\_quiz1\_seasonal\_periods}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_quiz1_seasonal_periods}
\end{frame}
...
\begin{frame}{Quiz Question 2: Answer}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch4\_quiz2\_seasonal\_diff}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_quiz2_seasonal_diff}
\end{frame}
...
\begin{frame}{Quiz Question 5: Answer}
    ...
    \end{center}
    \quantlet{TSA\_charts/ch4\_quiz5\_seasonal\_acf}{https://github.com/QuantLet/TSA/tree/main/TSA_charts/ch4_quiz5_seasonal_acf}
\end{frame}
