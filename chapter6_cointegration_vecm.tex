% Chapter 6: Cointegration and VECM
...
% TITLE INFORMATION
%=============================================================================
\title[Chapter 6: Cointegration \& VECM]{Chapter 6: Cointegration and VECM}
...
\begin{frame}{Why Cointegration?}
    \begin{block}{The Problem with Non-Stationary Data}
        \begin{itemize}
            \item Many economic/financial time series are \textbf{non-stationary} (I(1))
            \item Standard regression with I(1) variables leads to \textbf{spurious regression}
    ...
    \begin{alertblock}{Key Insight}
        Some non-stationary series may share a common stochastic trend---they move together in the long run. This is \textbf{cointegration}.
    \end{alertblock}

    \vspace{0.3cm}

    \begin{exampleblock}{Economic Examples}
        \begin{itemize}
            \item Consumption and Income (permanent income hypothesis)
            \item Short-term and long-term interest rates (term structure)
            \item Spot and futures prices (arbitrage relationship)
            \item Exchange rates and price levels (PPP)
        \end{itemize}
    \end{exampleblock}
\end{frame}

\begin{frame}{Spurious Regression Problem}
    \begin{block}{Granger \& Newbold (1974)}
        Regressing one random walk on another independent random walk:
    ...
    \begin{alertblock}{Symptoms of Spurious Regression}
        \begin{itemize}
            \item High $R^2$ (often $> 0.9$) even though variables are unrelated
            \item Highly significant $t$-statistics
...
%=============================================================================
\section{Example: Interest Rates}
%=============================================================================

\begin{frame}{Example: Short and Long Interest Rates}
    ...
    \begin{exampleblock}{Empirical Approach}
        \begin{enumerate}
            \item Test both rates for unit roots (expect $I(1)$)
            \item Test for cointegration (expect $r = 1$)
            \item Estimate VECM
            \item Test restriction $\beta = 1$ (spread is stationary)
        \end{enumerate}
    \end{exampleblock}
\end{frame}
