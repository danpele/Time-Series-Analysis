...
\begin{frame}{Obiective de Învățare}
    ...
    \begin{enumerate}
        ...
        \vspace{0.08cm}
        \item[\textcolor{MainBlue}{\textbf{6.}}] \textbf{Gestionați} trendul și sezonalitatea prin eliminarea trendului și ajustare sezonieră
        \vspace{0.08cm}
        \item[\textcolor{MainBlue}{\textbf{7.}}] \textbf{Înțelegeți} procesele stochastice și staționaritatea
        \vspace{0.08cm}
...
\begin{frame}{Seriile de Timp Sunt Pretutindeni}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.62\textheight, keepaspectratio]{ch1_motivation_everywhere.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{De Ce Studiem Seriile de Timp?}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.62\textheight, keepaspectratio]{ch1_motivation_forecast.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Înțelegerea Structurii Seriilor de Timp}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.60\textheight, keepaspectratio]{ch1_motivation_components.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Serie de Timp: Ilustrație Vizuală}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{ch1_def_timeseries.pdf}
    \end{center}
    \vspace{0.2cm}
...
\begin{frame}{Tipare Comune în Seriile de Timp}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{ch1_ts_patterns.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Descompunerea Seriilor de Timp: Exemplu Vizual}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{ch1_decomposition.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Descompunere Multiplicativă: Date Reale}
    ...
    \begin{exampleblock}{Exemplu}
        Setul clasic Box-Jenkins pentru pasageri aerieni (1949--1960). Amplitudinea sezonieră crește cu nivelul.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Media Mobilă Centrată: Ilustrație Vizuală}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{ch1_def_moving_average.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Algoritmul Descompunerii Clasice}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Eliminarea trendului}: $D_t = X_t / \hat{T}_t$
...
\begin{frame}{Descompunerea STL: Ilustrație Vizuală}
    ...
    \begin{block}{Observație Cheie}
        STL separă seria în trend, sezonalitate și rest folosind LOESS.
    \end{block}
\end{frame}
...
\begin{frame}{Netezirea Exponențială: Efectul lui Alpha}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{ch1_exponential_smoothing.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Metode cu Trend Amortizat}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Ecuații}
            \textbf{Nivel:} $\ell_t = \alpha X_t + (1-\alpha)(\ell_{t-1} + \phi b_{t-1})$

            \textbf{Trend:} $b_t = \beta^*(\ell_t - \ell_{t-1}) + (1-\beta^*)\phi b_{t-1}$

            \textbf{Prognoză:} $\hat{X}_{t+h|t} = \ell_t + \phi\frac{1-\phi^h}{1-\phi}b_t$
        \end{block}
        \column{0.43\textwidth}
        \begin{exampleblock}{Observație Cheie}
            \begin{itemize}
                \item Când $h \to \infty$: prognoza $\to$ constantă
                \item Previne extrapolarea nerealistă
                \item Adesea cel mai bun pentru orizonturi lungi
            \end{itemize}
        \end{exampleblock}
    \end{columns}
\end{frame}
...
\begin{frame}{Validarea Încrucișată pentru Serii de Timp}
    \begin{alertblock}{Important}
        CV standard nu funcționează pentru serii de timp (dependență temporală).
    \end{alertblock}

    \vspace{0.1cm}

    \begin{block}{CV cu Origine Mobilă (Ferestre în Expansiune)}
        \begin{enumerate}
...
\begin{frame}{Separarea Train / Validare / Test}
    ...
    \begin{center}
        \includegraphics[width=0.65\textwidth]{train_test_validation.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{De Ce Eliminăm Trendul și Sezonalitatea?}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{Motive pentru eliminarea trendului:}
            \begin{itemize}
    ...
    \begin{alertblock}{Important}
        După modelarea seriei fără trend/desezonalizate, trebuie să \textbf{inversăm transformarea} pentru prognoză.
    \end{alertblock}
\end{frame}

\begin{frame}{Metode de Eliminare a Trendului}
    \textbf{Șase abordări comune pentru eliminarea trendului:}
...
\begin{frame}{Filtrul Hodrick-Prescott (HP)}
    \begin{defn}[Filtrul HP]
        \textbf{Filtrul HP} descompune o serie de timp $X_t$ în trend $\tau_t$ și ciclu $c_t$:
        \[
            X_t = \tau_t + c_t
        \]
        prin minimizarea:
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Interpretare}
            \begin{itemize}
                \item Primul termen: potrivire la date
...
\begin{frame}{Filtrul HP: Limitări}
    \begin{columns}[T]
        ...
        \begin{alertblock}{Probleme Cunoscute}
            \begin{itemize}
                ...
                \item \textbf{Non-staționar}: Presupune trend neted
            \end{itemize}
        \end{alertblock}
        \column{0.5\textwidth}
        \begin{exampleblock}{Alternative}
            \begin{itemize}
                \item \textbf{Filtre band-pass}: Baxter-King, Christiano-Fitzgerald
                \item \textbf{Filtrul Hamilton}: Bazat pe regresie
                \item \textbf{Componente neobservate}: Modele spațiu-stare
            \end{itemize}
        \end{exampleblock}
    \end{columns}
    ...
    \begin{block}{Critica lui Hamilton (2018)}
        „De ce nu ar trebui să folosiți niciodată filtrul Hodrick-Prescott" --- sugerează utilizarea regresiei pe valori întârziate.
    \end{block}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Eliminarea trendului prin regresie
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Eliminarea trendului prin diferențiere
...
\begin{frame}{Exemplu: Trend Determinist}
    ...
    \end{center}
    \vspace{-0.1cm}
    \small \textbf{Cheie:} Folosiți \textcolor{Crimson}{regresia} pentru a elimina trendul $\succ$ reziduurile sunt staționare (ACF scade rapid).
\end{frame}
...
\begin{frame}{Exemplu: Trend Stochastic (Mers Aleatoriu)}
    ...
    \end{center}
    \vspace{-0.1cm}
    \small \textbf{Cheie:} Folosiți \textcolor{Crimson}{diferențierea} pentru a elimina trendul $\succ$ diferențele sunt staționare (zgomot alb).
\end{frame}
...
\begin{frame}{Comparație Alăturată}
    ...
    \end{center}
    \vspace{-0.2cm}
    \small \textbf{Rețineți:} Determinist $\succ$ regresie. Stochastic $\succ$ diferențiere.
\end{frame}

%=============================================================================
% SECȚIUNEA 7: PROCESE STOCHASTICE
%=============================================================================
...
\begin{frame}{Zgomot Alb vs Mers Aleatoriu: Comparație}
    ...
    \begin{itemize}
        ...
        \item Mersul aleatoriu este cel mai simplu proces nestaționar (rădăcină unitară)
    \end{itemize}
    }
\end{frame}
...
\begin{frame}{Funcția de Autocorelație Parțială (PACF)}
    ...
    \begin{itemize}
        \item Pentru AR($p$): PACF \textbf{se anulează} după lag-ul $p$
        \item Pentru MA($q$): ACF \textbf{se anulează} după lag-ul $q$
    \end{itemize}
\end{frame}
...
\begin{frame}{Testul Augmented Dickey-Fuller (ADF)}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{Ipoteze:}
            \begin{itemize}
                \item $H_0$: $\gamma = 0$ (rădăcină unitară)
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item $H_1$: $\sigma_u^2 > 0$ (rădăcină unitară)
            \end{itemize}
        \end{column}
        \begin{column}{0.48\textwidth}
            \textbf{Statistica de test:}
...
\begin{frame}{Folosirea ADF și KPSS Împreună}
    ...
    \begin{enumerate}
        \item Rulați testul ADF (nulă = rădăcină unitară)
...
\begin{frame}{Concluzii Cheie}
    ...
    \begin{enumerate}
        ...
        \vspace{0.05cm}
        \item \textbf{Gestionarea Trendului}: Diferențiere (stochastic) sau regresie (determinist)
        \vspace{0.05cm}
        ...
        \vspace{0.05cm}
        \item \textbf{Teste rădăcină unitară}: ADF ($H_0$: rădăcină unitară) vs KPSS ($H_0$: staționar)
    \end{enumerate}
\end{frame}
