...
\begin{frame}{Tipare Comune în Seriile de Timp}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_ts_patterns.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Descompunerea Seriilor de Timp: Exemplu Vizual}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_decomposition.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Netezirea cu Media Mobilă}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_moving_average.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Netezirea Exponențială: Efectul lui Alpha}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_exponential_smoothing.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Evaluarea Prognozei: Exemplu Vizual}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_forecast_eval.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Comparație Alăturată}
    ...
    \end{center}
    \vspace{-0.2cm}
    \small \textbf{Rețineți:} Determinist $\rightarrow$ regresie. Stochastic $\rightarrow$ diferențiere.
\end{frame}
...
\begin{frame}{Staționar vs Nestaționar: Comparație Vizuală}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_stationarity.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Zgomot Alb vs Mers Aleatoriu: Comparație}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_wn_rw.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Tipare ACF pentru Diferite Procese}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{charts/ch1_acf_examples.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{Întrebarea Quiz 1: Răspuns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch1_quiz1_components.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Întrebarea Quiz 2: Răspuns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch1_quiz2_stationarity.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Întrebarea Quiz 3: Răspuns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch1_quiz3_acf.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Întrebarea Quiz 4: Răspuns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch1_quiz4_wn_rw.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Întrebarea Quiz 5: Răspuns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch1_quiz5_forecast_errors.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Întrebarea Quiz 6: Răspuns}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{charts/ch1_quiz6_decomposition.pdf}
    \end{center}
    \vspace{-0.2cm}
