...
plt.tight_layout()
plt.savefig('ch4_decomposition.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_decomposition.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_decomposition.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch4_acf_pacf.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_acf_pacf.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_acf_pacf.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch4_diagnostics.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_diagnostics.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_diagnostics.pdf', bbox_inches='tight', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('ch4_forecast.pdf', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_forecast.png', dpi=150, bbox_inches='tight', transparent=True)
plt.savefig('ch4_forecast.pdf', bbox_inches='tight', transparent=True)
plt.close()
