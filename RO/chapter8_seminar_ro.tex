...
\begin{frame}{Test 8: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Normalizate/standardizate}
        ...
        \textbf{Metode comune:}
        \begin{itemize}
            \item \textbf{Min-Max}: $x' = \frac{x - x_{min}}{x_{max} - x_{min}}$ $\rightarrow$ [0, 1]
            \item \textbf{Standard}: $x' = \frac{x - \mu}{\sigma}$ $\rightarrow$ media 0, std 1
        \end{itemize}
...
\begin{frame}{Problemă 3: LSTM pentru Serii de Timp}
    ...
    \begin{itemize}
        ...
        \item Early stopping pentru a evita overfitting
    \end{itemize}
\end{frame}
