...
\begin{frame}{Pasul 3: Testul Granger de cauzalitate}
    ...
    {\small
    \begin{itemize}
        \item PIB $\succ$ Inflație: Semnificativ (p $<$ 0.05) --- PIB ``cauzează Granger'' Inflația
        \item Inflație $\succ$ PIB: Semnificativ --- cauzalitate bidirecțională
...
\begin{frame}{Pasul 4: Funcții de răspuns la impuls (IRF)}
    ...
    {\small
    \begin{itemize}
        \item Șoc PIB $\succ$ efect pozitiv persistent asupra inflației
        \item Șoc Inflație $\succ$ efect negativ asupra creșterii PIB
