...
\begin{frame}{De ce contează cointegrarea?}
    ...
    \begin{alertblock}{Soluția: Cointegrarea}
        Unele serii nestaționare au un \textbf{trend stocastic comun}---se mișcă împreună pe termen lung. Această relație pe termen lung poate fi modelată!
    \end{alertblock}
...
\begin{frame}{Răspunsuri Quiz}
    {\small
    \begin{enumerate}
        \item \textbf{Cointegrare}: O combinație liniară a variabilelor este $I(0)$ (staționară). Ele au un trend stocastic comun.
