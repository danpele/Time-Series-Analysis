...
\begin{frame}{Interval de Încredere: Exemplu Numeric}
    ...
    \begin{block}{IC la 1 Pas}
        ...
        \begin{align*}
            ...
            \text{IC 95\%} &= 111 \pm 1.96 \times \sqrt{4} = 111 \pm 3.92 \\
            &= \boxed{[107.08, \; 114.92]}
        \end{align*}
    \end{block}
    ...
    \begin{block}{IC la 2 Pași (pentru $\hat{Y}_{T+2|T} = 112.8$)}
        ...
        \begin{align*}
            ...
            \text{IC 95\%} &= 112.8 \pm 1.96 \times \sqrt{14.24} = 112.8 \pm 7.40 \\
            &= \boxed{[105.40, \; 120.20]}
        \end{align*}
    \end{block}

    {\footnotesize \textbf{Notă}: IC se lărgește pe măsură ce orizontul crește!}
    }
\end{frame}
