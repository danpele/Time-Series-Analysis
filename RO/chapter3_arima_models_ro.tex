...
\begin{frame}{Ce Vom Învăța Astăzi}
    \begin{block}{Concepte Fundamentale}
        \begin{enumerate}
            ...
            \item \textbf{Metodologia Box-Jenkins}: Identificare $\to$ Eștimare $\to$ Diagnosticare
        \end{enumerate}
    \end{block}
...
\begin{frame}{Tipuri de Nestaționaritate}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Trend Determinist}
                ...
                \begin{itemize}
                    ...
                    \item Poate fi eliminăt prin \textbf{regresie}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Trend Stochastic (Rădăcină Unitate)}
                ...
                \begin{itemize}
                    ...
                    \item Trebuie eliminăt prin \textbf{diferențiere}
    ...
    \begin{alertblock}{Distincție Cheie}
        Identificarea corectă este crucială: eliminărea trendului prin regresie pentru un proces cu rădăcină unitate sau diferențierea unui proces staționar în trend duc ambele la specificăre greșită!
    \end{alertblock}
\end{frame}
...
\begin{frame}{Mers Aleatoriu cu Drift: Ilustrație Vizuală}
    ...
    \end{center}
    \vspace{-0.2cm}
    \begin{exampleblock}{Comparăție}
        Fără drift (albastru): rătăcește în jurul lui zero fără direcție. Cu drift $\mu > 0$ (roșu): trend ascendent sistematic. Ambele sunt nestaționare --- drift-ul adaugă trend determinist la rătăcirea stocastică.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Testul Phillips-Perron (PP)}
    ...
    \begin{block}{Statistică de Test}
        ...
        unde $\hat{\lambda}^2$ este o eștimare consistentă a varianței pe termen lung folosind Newey-West.
    \end{block}
...
\begin{frame}{Metodologia Box-Jenkins}
    \begin{center}
        \begin{tikzpicture}[node distance=1.5cm, every node/.style={font=\small}]
            ...
            \node[draw, rectangle, rounded corners, fill=Forest!20, minimum width=4cm, minimum height=0.8cm, below=0.8cm of id] (est) {2. Eștimare};
...
\begin{frame}{Pasul 2: Determinarea lui $p$ și $q$}
    ...
    \begin{block}{Criterii Informaționale}
        Când tiparele sunt neclare, comparăți modelele folosind:
        \begin{itemize}\setlength{\itemsep}{0pt}
...
%=============================================================================
\section{Eștimarea ARIMA}

\begin{frame}{Metode de Eștimare}
    {\small
    \hfill\begin{minipage}{0.9\textwidth}
    \begin{block}{Eștimarea prin Maximum de Verosimilitate (MLE)}
...
\begin{frame}{Ilustrație Fereastră Rulantă}
    ...
    \begin{itemize}
        ...
        \item Fereastra rulantă menține eștimarea modelului actualizată
    \end{itemize}
    }
\end{frame}
...
\begin{frame}{Studiu de Caz: Analiză ARIMA Completă}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Pasul 4}: Eștimarea modelului ARIMA
...
\begin{frame}{Pasul 3: Identificarea Modelului prin ACF/PACF}
    ...
    \begin{block}{Analiza Seriei Diferențiate}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item ACF: Spike semnificâțiv la lag 1, apoi se întrerupe $\Rightarrow$ sugerează MA(1)
...
\begin{frame}{Pasul 4: Eștimarea Modelului}
    \vspace{-0.2cm}
    {\small
...
\begin{frame}{Pasul 1: Testul ADF pentru Staționaritate}
    ...
    \begin{alertblock}{Rezultate Test ADF}
        \textbf{Seria originală}: p-value mare $\Rightarrow$ nu respingem $H_0$ (rădăcină unitate prezentă).
