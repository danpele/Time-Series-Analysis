...
\begin{frame}{Estimarea Trendului: Abordări Multiple}
    \begin{columns}[T]
        \column{0.32\textwidth}
        \begin{exampleblock}{Interpretare}
            Metode diferite captează trendul la niveluri variate de netezime.
        \end{exampleblock}
        \vspace{0.3cm}
...
\begin{frame}{Exemplu: Trend Determinist}
    \begin{columns}[T]
        ...
        \begin{exampleblock}{Cheie}
            Folosiți \textcolor{Crimson}{regresie} pentru eliminarea trendului $\rightarrow$ reziduurile sunt staționare (ACF scade rapid).
        \end{exampleblock}
        \vspace{0.3cm}
...
\begin{frame}{Exemplu: Trend Stochastic (Mers Aleatoriu)}
    \begin{columns}[T]
        \column{0.32\textwidth}
        \begin{exampleblock}{Cheie}
            Folosiți \textcolor{Crimson}{diferențiere} pentru eliminarea trendului $\rightarrow$ diferențele sunt staționare (zgomot alb).
        \end{exampleblock}
        \vspace{0.3cm}
