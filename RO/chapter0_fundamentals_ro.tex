...
\begin{frame}{Seriile de Timp Sunt Pretutindeni}
    ...
    \end{itemize}
    }\quantlet{TSA\_ch1\_motivation}{https://github.com/QuantLet/TSA/tree/main/ch1_motivation}
\end{frame}
...
\begin{frame}{De Ce Studiem Seriile de Timp?}
    ...
    \end{alertblock}
    }\quantlet{TSA\_ch1\_forecast}{https://github.com/QuantLet/TSA/tree/main/ch1_forecast}
\end{frame}
...
\begin{frame}{Înțelegerea Structurii Seriilor de Timp}
    ...
    \end{exampleblock}
    }\quantlet{TSA\_ch1\_components}{https://github.com/QuantLet/TSA/tree/main/ch1_components}
\end{frame}
...
\begin{frame}{Serie de Timp: Ilustrație Vizuală}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.54\textheight, keepaspectratio]{ch1_def_timeseries.pdf}
    \end{center}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch1\_def\_timeseries}{https://github.com/QuantLet/TSA/tree/main/ch1_def_timeseries}
\end{frame}

\begin{frame}{Tipare Comune în Seriile de Timp}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.42\textheight, keepaspectratio]{ch1_ts_patterns.png}
    \end{center}
    \vspace{-0.2cm}
    \begin{block}{Tipuri de Tipare}
        \begin{itemize}
            \item \textbf{Trend}: Creștere sau scădere pe termen lung în date
            \item \textbf{Sezonier}: Tipare periodice regulate (ex. lunar, trimestrial)
            \item \textbf{Ciclic}: Fluctuații pe termen mediu (cicluri de afaceri, 2--10 ani)
            \item \textbf{Aleatoriu}: Fără tipar sistematic -- fluctuații imprevizibile
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch1\_patterns}{https://github.com/QuantLet/TSA/tree/main/ch1\_patterns}
\end{frame}

\begin{frame}{Serie de Timp: Definiție Vizuală}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.54\textheight, keepaspectratio]{timeseries_definition.png}
    \end{center}
    ...
    \end{block}
    \quantlet{TSA\_ch1\_definition}{https://github.com/QuantLet/TSA/tree/main/ch1\_definition}
\end{frame}
...
\begin{frame}{Tipuri de Date: Comparație}
    ...
    \end{tabular}
    \end{center}
    \quantlet{TSA\_ch1\_data\_types}{https://github.com/QuantLet/TSA/tree/main/ch1\_data\_types}
\end{frame}

\begin{frame}{Exemple de Date de Tip Serie de Timp}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.54\textheight, keepaspectratio]{multiple_assets.png}
    \end{center}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch1\_examples}{https://github.com/QuantLet/TSA/tree/main/ch1\_examples}
\end{frame}
...
\begin{frame}{Descompunerea Seriilor de Timp: Exemplu Vizual}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.44\textheight, keepaspectratio]{ch1_decomposition.png}
    \end{center}
    \vspace{-0.3cm}
    {\small
    \begin{block}{Componente Explicate}
        ...
        \end{itemize}
    \end{block}
    }\quantlet{TSA\_ch1\_decomposition}{https://github.com/QuantLet/TSA/tree/main/ch1_decomposition}
\end{frame}
...
\begin{frame}{Componenta Ciclică}
    ...
    \begin{columns}[T]
        ...
        \end{alertblock}
    \end{columns}
    }\quantlet{TSA\_ch1\_cyclical}{https://github.com/QuantLet/TSA/tree/main/ch1_cyclical}
\end{frame}
...
\begin{frame}{Descompunere Aditivă: Vizualizare}
    ...
    \end{block}
    \quantlet{TSA\_ch0\_additive}{https://github.com/QuantLet/TSA/tree/main/ch0\_additive}
\end{frame}
...
\begin{frame}{Descompunere Multiplicativă: Date Reale}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.60\textheight, keepaspectratio]{airline_decomposition.png}
    \end{center}
    \vspace{-0.2cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch0\_multiplicative}{https://github.com/QuantLet/TSA/tree/main/ch0\_multiplicative}
\end{frame}

\begin{frame}{Aditivă vs Multiplicativă: Comparație}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{additive_vs_multiplicative.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{block}{Diferența Cheie}
        \begin{itemize}
            \item \textbf{Multiplicativ}: componenta sezonieră este un \textit{raport} (centrat la 1)
            \item \textbf{Aditiv}: componenta sezonieră în \textit{unități absolute} (centrată la 0)
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch0\_comparison}{https://github.com/QuantLet/TSA/tree/main/ch0\_comparison}
\end{frame}
...
\begin{frame}{Media Mobilă Centrată: Ilustrație Vizuală}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.94\textwidth, height=0.62\textheight, keepaspectratio]{ch1_def_moving_average.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretare}
        Media mobilă netezește fluctuațiile pe termen scurt, dezvăluind trendul subiacent.
    \end{exampleblock}
    \quantlet{TSA\_ch0\_ma}{https://github.com/QuantLet/TSA/tree/main/ch0\_ma}
\end{frame}
...
\begin{frame}{Indici Sezonieri: Interpretare}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.44\textheight, keepaspectratio]{seasonal_pattern.png}
    \end{center}
    \begin{exampleblock}{Interpretare}
        \begin{itemize}
        ...
        \end{itemize}
    \end{exampleblock}
    \quantlet{TSA\_ch0\_seasonal}{https://github.com/QuantLet/TSA/tree/main/ch0\_seasonal}
\end{frame}
...
\begin{frame}{Descompunerea STL: Ilustrație Vizuală}
    ...
    \end{block}
    \quantlet{TSA\_ch0\_stl}{https://github.com/QuantLet/TSA/tree/main/ch0\_stl}
\end{frame}
...
\begin{frame}{Netezirea cu Media Mobilă}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch1_moving_average.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{block}{Compromisul Dimensiunii Ferestrei}
        \begin{itemize}
            \item \textbf{Fereastră mică}: Reactivă dar zgomotoasă
            \item \textbf{Fereastră mare}: Mai netedă dar reacționează mai lent
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch1\_moving\_average}{https://github.com/QuantLet/TSA/tree/main/ch1_moving_average}
\end{frame}
...
\begin{frame}{Netezirea Exponențială Simplă: Efectul lui $\alpha$}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{simple_exp_smoothing.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Compromis}
        $\alpha$ mai mic produce prognoze mai netede; $\alpha$ mai mare urmărește datele mai îndeaproape.
    \end{exampleblock}
    \quantlet{TSA\_ch0\_ses}{https://github.com/QuantLet/TSA/tree/main/ch0\_ses}
\end{frame}
...
\begin{frame}{Metoda Holt: Vizualizare}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.45\textheight, keepaspectratio]{holt_method.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretare}
        \begin{itemize}
            ...
            \item $\alpha$ controlează reactivitatea la schimbări de nivel
            \item $\beta^*$ controlează reactivitatea la schimbări de trend
        \end{itemize}
    \end{exampleblock}
    \quantlet{TSA\_ch0\_holt}{https://github.com/QuantLet/TSA/tree/main/ch0\_holt}
\end{frame}
...
\begin{frame}{Holt-Winters: Captarea Sezonalității}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{holt_winters.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Caracteristică Cheie}
        Holt-Winters descompune seria și produce prognoze sezoniere cu trend.
    \end{exampleblock}
    \quantlet{TSA\_ch0\_hw}{https://github.com/QuantLet/TSA/tree/main/ch0\_hw}
\end{frame}
...
\begin{frame}{ETS: Ilustrație Netezire Exponențială}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.94\textwidth, height=0.62\textheight, keepaspectratio]{ch1_def_ets.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretare}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch0\_ets}{https://github.com/QuantLet/TSA/tree/main/ch0\_ets}
\end{frame}

\begin{frame}{Selecția Modelului ETS}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{ets_components.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretare}
        \small Cadrul ETS oferă o metodă sistematică pentru alegerea celui mai bun model folosind AIC/BIC.
    \end{exampleblock}
    \quantlet{TSA\_ch0\_ets\_select}{https://github.com/QuantLet/TSA/tree/main/ch0\_ets\_select}
\end{frame}
...
\begin{frame}{Evaluarea Prognozei: Exemplu Vizual}
    ...
    \end{itemize}
    }\quantlet{TSA\_ch1\_forecast\_eval}{https://github.com/QuantLet/TSA/tree/main/ch1_forecast_eval}
\end{frame}
...
\begin{frame}{Compararea Metodelor de Prognoză}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch0\_forecast\_compare}{https://github.com/QuantLet/TSA/tree/main/ch0\_forecast\_compare}
\end{frame}
...
\begin{frame}{Diagnosticarea Reziduurilor: Vizualizare}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.46\textheight, keepaspectratio]{residual_diagnostics.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Ce să Verificăm}
        ...
        \end{itemize}
    \end{exampleblock}
    \quantlet{TSA\_ch0\_residuals}{https://github.com/QuantLet/TSA/tree/main/ch0\_residuals}
\end{frame}
...
\begin{frame}{Validarea Încrucișată pentru Serii de Timp}
    ...
    \end{center}
    \quantlet{TSA\_ch0\_cv}{https://github.com/QuantLet/TSA/tree/main/ch0\_cv}
\end{frame}
...
\begin{frame}{Separarea Train / Validare / Test}
    ...
    \end{center}
    \quantlet{TSA\_ch0\_train\_split}{https://github.com/QuantLet/TSA/tree/main/ch0\_train\_split}
\end{frame}
...
\begin{frame}{Date Reale: Compararea Prognozelor}
    ...
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretare}
        \small Date pasageri companii aeriene: Holt-Winters Multiplicativă performează cel mai bine pentru date sezoniere.
    \end{exampleblock}
    \quantlet{TSA\_ch0\_real\_data}{https://github.com/QuantLet/TSA/tree/main/ch0\_real\_data}
\end{frame}

\begin{frame}{Performanța Prognozei pe Diferite Seturi de Date}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{multiple_series_comparison.pdf}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretare}
        \small Serii diferite necesită modele diferite. Datele sezoniere necesită metode sezoniere.
    \end{exampleblock}
    \quantlet{TSA\_ch0\_multi\_series}{https://github.com/QuantLet/TSA/tree/main/ch0\_multi\_series}
\end{frame}
...
\begin{frame}{Variabile Dummy vs Termeni Fourier}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{seasonality_fourier_dummies.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{block}{Comparație}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch0\_fourier}{https://github.com/QuantLet/TSA/tree/main/ch0\_fourier}
\end{frame}
...
\begin{frame}{Metode de Detrendare: Comparație}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{detrending_methods.png}
    \end{center}
    \vspace{-0.3cm}
    ...
    \end{alertblock}
    \quantlet{TSA\_ch0\_detrending}{https://github.com/QuantLet/TSA/tree/main/ch0\_detrending}
\end{frame}

\begin{frame}{Estimarea Trendului: Abordări Multiple}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{trend_estimation_comparison.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Interpretare}
        \small Metode diferite captează trendul la niveluri variate de netezime.
    \end{exampleblock}
    \quantlet{TSA\_ch0\_trend}{https://github.com/QuantLet/TSA/tree/main/ch0\_trend}
\end{frame}
...
\begin{frame}{Filtrul HP: Efectul lui $\lambda$}
    ...
    \begin{block}{Compromis}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch1\_hp\_filter}{https://github.com/QuantLet/TSA/tree/main/ch1_hp_filter}
\end{frame}
...
\begin{frame}{Filtrul HP: Extragerea Ciclului de Afaceri}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch0\_hp\_cycle}{https://github.com/QuantLet/TSA/tree/main/ch0\_hp\_cycle}
\end{frame}
...
\begin{frame}{Ajustare Sezonieră: Vizualizare}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{seasonal_adjustment.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{block}{Rezultat}
        Seria ajustată sezonier dezvăluie trendul subiacent fără fluctuațiile periodice.
    \end{block}
    \quantlet{TSA\_ch0\_seasonal\_adj}{https://github.com/QuantLet/TSA/tree/main/ch0\_seasonal\_adj}
\end{frame}
...
\begin{frame}{Exemplu: Trend Determinist}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{deterministic_trend_example.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Cheie}
        \small Folosiți \textcolor{Crimson}{regresie} pentru eliminarea trendului $\rightarrow$ reziduurile sunt staționare (ACF scade rapid).
    \end{exampleblock}
    \quantlet{TSA\_ch0\_det\_trend}{https://github.com/QuantLet/TSA/tree/main/ch0\_det\_trend}
\end{frame}

\begin{frame}{Exemplu: Trend Stochastic (Mers Aleatoriu)}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{stochastic_trend_example.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Cheie}
        \small Folosiți \textcolor{Crimson}{diferențiere} pentru eliminarea trendului $\rightarrow$ diferențele sunt staționare (zgomot alb).
    \end{exampleblock}
    \quantlet{TSA\_ch0\_stoch\_trend}{https://github.com/QuantLet/TSA/tree/main/ch0\_stoch\_trend}
\end{frame}

\begin{frame}{Comparație Alăturată}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{trend_comparison_sidebyside.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{alertblock}{Rețineți}
        {\small
        \begin{itemize}
            \item Trend determinist $\rightarrow$ regresie
            \item Trend stochastic $\rightarrow$ diferențiere
        \end{itemize}
        }
    \end{alertblock}
    \quantlet{TSA\_ch0\_trend\_compare}{https://github.com/QuantLet/TSA/tree/main/ch0\_trend\_compare}
\end{frame}
