...
\begin{frame}{Random Forest: Exemplu de Prognoză}
    ...
    \vspace{-0.3cm}
    {\footnotesize
    Modelul Random Forest antrenat pe date istorice (albastru) produce prognoze (roșu punctat) care urmăresc bine valorile reale din perioada de test (verde).
    }
\end{frame}
...
\begin{frame}{Comparație: Rezultate pe EUR/RON}
    ...
    \begin{tabular}{l|c|c|c|c}
        ...
        \midrule
        ARIMA(1,0,1) & 0.412 & 0.298 & 0.5 & Da \\
        ARFIMA(1,0.1,1) & 0.408 & 0.295 & 1.2 & Parțial \\
        Random Forest & 0.395 & 0.285 & 3.5 & Da (features) \\
        LSTM & 0.401 & 0.291 & 45.0 & Nu \\
        \bottomrule
    \end{tabular}
    \end{center}
