...
\begin{frame}{Test 2: Soluție}
    \begin{exampleblock}{Răspuns: C -- $\phi = -0.8$ (Staționar)}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{sem2_stationarity_region.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 3: Soluție}
    \begin{exampleblock}{Răspuns: B -- MA(1)}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.5\textheight, keepaspectratio]{sem2_acf_pacf_patterns.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 4: Soluție}
    \begin{exampleblock}{Răspuns: C -- Nu este invertibil ($|\theta| = 1.5 > 1$)}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{sem2_invertibility.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 6: Soluție}
    \begin{exampleblock}{Răspuns: C -- BIC mai mic este preferat}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{sem2_information_criteria.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{AIC}: $-2\ln(\hat{L}) + 2k$ \quad \textbf{BIC}: $-2\ln(\hat{L}) + k\ln(n)$ \quad BIC penalizează complexitatea mai mult $\Rightarrow$ modele mai parsimonioase
        }
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Test 11: Soluție}
    \begin{exampleblock}{Răspuns: B -- Mai puțini parametri reduc riscul de supraajustare}
        ...
        BIC penalizează complexitatea mai mult decât AIC, selectând adesea modele mai parsimonioase.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Test 13: Soluție}
    \begin{exampleblock}{Răspuns: C -- Un proces MA infinit plus o componentă deterministă}
        ...
        \textbf{Implicație:} MA($\infty$) este reprezentarea cea mai generală. Modelele ARMA sunt aproximări parsimonioase ale acestui MA infinit.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Test 14: Soluție}
    \begin{exampleblock}{Răspuns: B -- Luați diferențe de ordinul întâi}
        \begin{itemize}
            \item \textbf{Rădăcină unitară} (trend stocastic): Folosiți \textbf{diferențierea}
            \item \textbf{Trend staționar} (trend determinist): Folosiți \textbf{detrendarea} (regresie)
        \end{itemize}
