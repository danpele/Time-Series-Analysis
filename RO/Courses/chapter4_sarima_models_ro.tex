        ...
        \begin{block}{Ce face acest test?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Concluzie}: dacă un sezon are constant ranguri mai mari/mici $\succ$ sezonalitate
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Exemplu: dacă vara are întotdeauna ranguri mari $\succ$ consum de energie sezonier
                    \end{itemize}
            \end{itemize}
        \end{block}
        ...
        \begin{alertblock}{HEGY testează frecvențe multiple}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Trimestrial}: testează la 0, $\pi$, $\pm\pi/2$
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item 3 frecvențe $\succ$ o rădăcină obișnuită + două sezoniere
                    \end{itemize}
                \item \textbf{Lunar}: testează la 0, $\pi$, $\pm\pi/6$, $\pm\pi/3$, $\pm\pi/2$, $\pm 2\pi/3$, $\pm 5\pi/6$
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item 6 frecvențe $\succ$ o rădăcină obișnuită + cinci sezoniere
                    \end{itemize}
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
...
\begin{frame}{Testul HEGY: Formula de regresie (trimestrial)}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Ipoteze}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{$H_0: \pi_1=0$}: rădăcină unitară la frecvența 0 $\succ$ necesită $d=1$
                \item \textbf{$H_0: \pi_2=0$}: la frecvența $\pi$ $\succ$ necesită $D=1$
                \item \textbf{$H_0: \pi_3=\pi_4=0$}: rădăcină unitară la frecvența $\pm\pi/2$ $\succ$ necesită $D=1$
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
    }
