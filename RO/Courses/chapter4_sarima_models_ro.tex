    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{La finalul acestui capitol, veți fi capabili să:}
            \begin{enumerate}\setlength{\itemsep}{0pt}
                ...
                \item[\textcolor{MainBlue}{\textbf{3.}}] \textbf{Construiți} și estimați modele SARIMA (Seasonal Autoregressive Integrated Moving Average) cu componente sezoniere
                \item[\textcolor{MainBlue}{\textbf{4.}}] \textbf{Interpretați} tiparele ACF (Autocorrelation Function) / PACF (Partial ACF) sezoniere pentru identificarea modelului
                \item[\textcolor{MainBlue}{\textbf{5.}}] \textbf{Evaluați} prognozele prin metoda ferestrei mobile (rolling) pentru date sezoniere
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Modelele ARIMA (Autoregressive Integrated Moving Average) standard nu pot captura aceste \textbf{cicluri sezoniere repetitive}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Dreapta}: Reziduurile ARIMA încă prezintă autocorelație sezonieră $\Rightarrow$ modelul este incomplet
                \item SARIMA adaugă \textbf{termeni AR (autoregresivi) și MA (medie mobilă) sezonieri} pentru a captura aceste tipare
            \end{itemize}
        \end{exampleblock}
        }
    \end{cminipage}
...
\begin{frame}{Ce este sezonalitatea? (vizualizare)}
    \begin{center}
    ...
    \begin{cminipage}{0.95\textwidth}
            ...
            \begin{column}{0.48\textwidth}
                \begin{block}{Sezonalitate deterministă}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \end{itemize}
                        \item \textbf{Notă:} se omite o variabilă dummy și se include o constantă, sau se impune $\sum \gamma_j = 0$, pentru a evita colinearitatea perfectă
            ...
            \begin{column}{0.48\textwidth}
                \begin{block}{Sezonalitate stochastică}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item \textbf{Exemplu:} Vânzările cu amănuntul cresc tot mai mult în fiecare decembrie
                    \end{itemize}
                \end{block}
            \end{column}
        \end{columns}
        ...
        \begin{alertblock}{Cum decidem?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Confirmați cu testele HEGY (Hylleberg-Engle-Granger-Yoo) sau Canova-Hansen
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
    }
...
\begin{frame}{Sezonalitate aditivă vs multiplicativă (vizualizare)}
    \begin{center}
        ...
        \begin{columns}[T]
            ...
            \begin{block}{Multiplicativă: $Y_t = T_t \cdot S_t \cdot \varepsilon_t$}
                ...
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item Ex: Airline, vânzări cu amănuntul, PIB
                \end{itemize}
                \vspace{-2pt}
            \end{block}
        \end{columns}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item ACF la lag-urile sezoniere: descreștere lentă $\Rightarrow$ necesită diferențiere sezonieră
            \end{itemize}
        \end{exampleblock}
        }
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Ce face acest test?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Logică}: dacă media din ianuarie $\neq$ media din februarie $\neq$ \ldots $\neq$ media din decembrie
                \item Diferențe semnificative între sezoane $\Rightarrow$ sezonalitate prezentă
        ...
        \begin{alertblock}{De reținut}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Dacă adăugarea dummy sezoniere \textbf{reduce semnificativ} erorile de predicție $\Rightarrow$ sezonalitate prezentă
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
    }
...
\begin{frame}{Testul Kruskal-Wallis: intuiție}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Ce face acest test?}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Test neparametric}: verifică dacă observațiile din diferite sezoane provin din aceeași distribuție (nu necesită ipoteze despre forma distribuției)
                \item \textbf{Mecanism}: ordonează toate observațiile și înlocuiește valorile cu ranguri (1, 2, \ldots, $N$)
                \item \textbf{Verificare}: dacă rangurile sunt distribuite uniform între sezoane; compară suma rangurilor per sezon cu distribuția așteptată
                \item \textbf{Concluzie}: dacă un sezon are constant ranguri mai mari/mici $\Rightarrow$ sezonalitate
            \end{itemize}
            \vspace{-1pt}
        \end{block}
        \vspace{-2mm}
        \begin{exampleblock}{De ce să-l folosim în locul testului F?}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Fără ipoteza de normalitate} -- funcționează cu orice distribuție; ideal pentru date financiare cu cozi groase
                \item \textbf{Robust la valori extreme} -- rangurile limitează influența oricărei observații individuale
            \end{itemize}
            \vspace{-1pt}
        \end{exampleblock}
        \vspace{-2mm}
        \begin{alertblock}{Limitare}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Mai puțin puternic decât testul F când datele \emph{sunt} distribuite normal
            \end{itemize}
            \vspace{-1pt}
        \end{alertblock}
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Exemplu: Vânzări trimestriale (n=20, s=4)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Valoarea critică $\chi^2_{0.05, 3} = 7.81$. Deoarece $19.6 > 7.81$: \textbf{Respingem $H_0$} $\Rightarrow$ Sezonalitate.
            \end{itemize}
        \end{exampleblock}
        \vspace{-0.1cm}
...
\begin{frame}{Testul HEGY: ce problemă rezolvă?}
    ...
    {\scriptsize
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Întrebarea fundamentală}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Problemă}: având o serie sezonieră, trebuie să știm tipul de diferențiere (alegerea greșită duce la supra-/sub-diferențiere)
                \item \textbf{Diferențiere obișnuită} $(1-L)$? $\Rightarrow$ setăm $d=1$; \textbf{Diferențiere sezonieră} $(1-L^s)$? $\Rightarrow$ setăm $D=1$
                \item \textbf{HEGY}: testează pentru ambele tipuri de rădăcini unitare simultan! (Hylleberg, Engle, Granger, Yoo, 1990)
            \end{itemize}
            \vspace{-1pt}
        \end{block}
        \vspace{-2mm}
        \begin{exampleblock}{De ce să nu folosim doar ADF?}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{ADF}: testează doar pentru o rădăcină unitară obișnuită la frecvența zero; ignoră componentele sezoniere
        ...
        \begin{alertblock}{HEGY testează frecvențe multiple}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Trimestrial}: testează la 0, $\pi$, $\pm\pi/2$ (3 frecvențe $\Rightarrow$ o rădăcină obișnuită + două sezoniere)
                \item \textbf{Lunar}: testează la 0, $\pi$, $\pm\pi/6$, $\pm\pi/3$, $\pm\pi/2$, $\pm 2\pi/3$, $\pm 5\pi/6$ (6 frecvențe)
            \end{itemize}
            \vspace{-1pt}
        \end{alertblock}
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Regresia auxiliară HEGY}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Lag-urile $k$: alese prin AIC / BIC
            \end{itemize}
        \end{block}
        \vspace{-1mm}
        \begin{block}{Variabile transformate}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{$z_{1t}$}: $(1+L+L^2+L^3)y_t = y_t + y_{t-1} + y_{t-2} + y_{t-3}$ -- frecvență zero (trend)
                \item \textbf{$z_{2t}$}: $-(1-L+L^2-L^3)y_t = -y_t + y_{t-1} - y_{t-2} + y_{t-3}$ -- frecvență $\pi$ (alternanță semestrială)
                \item \textbf{$z_{3t}$, $z_{4t}$}: componentele de frecvență $\pm\pi/2$ (ciclu anual)
            \end{itemize}
        \end{block}
        \vspace{-1mm}
        \begin{alertblock}{Ipoteze}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{$H_0: \pi_1=0$}: rădăcină unitară la frecvența 0 $\Rightarrow$ necesită $d=1$
                \item \textbf{$H_0: \pi_2=0$}: la frecvența $\pi$ $\Rightarrow$ necesită $D=1$
                \item \textbf{$H_0: \pi_3=\pi_4=0$}: rădăcină unitară la frecvența $\pm\pi/2$ $\Rightarrow$ necesită $D=1$
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
    }
...
\begin{frame}{Testul Canova-Hansen: opusul testului HEGY}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{De ce contează?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item HEGY: ``Demonstrați că \emph{nu} există rădăcină unitară'' (conservator față de diferențiere)
                \item CH: ``Demonstrați că \emph{există} rădăcină unitară'' (conservator față de variabile dummy)
...
\begin{frame}{Testul Canova-Hansen: formula}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \end{block}
        \vspace{-0.15cm}
        \begin{block}{Statistică de test LM (Lagrange Multiplier)}
            \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \begin{alertblock}{Decizie}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Regula}: respingem $H_0$ dacă $LM > $ valoare critică $\Rightarrow$ necesară diferențierea sezonieră
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
    }
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Concluzie}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{HEGY/CH}: ``\textit{Ce tip?}'' (deterministă vs stochastică)
                \item \textbf{În practică}: pentru serii cu sezonalitate evidentă, boxplot + ACF sunt suficiente
                \item Testele formale sunt esențiale când sezonalitatea este ambiguă
            \end{itemize}
            \vspace{-2pt}
        \end{alertblock}
    \end{cminipage}
...
\begin{frame}{Transformarea Box-Cox: Stabilizarea varianței}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Familia de transformări Box-Cox}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Formula}: $Y_t^{(\lambda)} = (Y_t^\lambda - 1)/\lambda$ dacă $\lambda \neq 0$; \; $Y_t^{(\lambda)} = \ln(Y_t)$ dacă $\lambda = 0$
                \item \textbf{Cazuri speciale}: $\lambda=1$ (fără transformare), $\lambda=0$ (logaritm), $\lambda=0.5$ (rădăcină pătrată); $\lambda < 1$ comprimă valorile mari
            \end{itemize}
            \vspace{-1pt}
        \end{block}
        \vspace{-2mm}
        \begin{exampleblock}{Selectarea automată a lui $\lambda$}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Verosimilitate profilată}: maximizează log-verosimilitatea în funcție de $\lambda$ (cea mai utilizată metodă)
                \item \textbf{Metoda Guerrero (1993)}: minimizează coeficientul de variație al sub-seriilor sezoniere; preferată pentru date sezoniere
                \item \textbf{Python}: \texttt{boxcox(y)} din \texttt{scipy.stats}; \textbf{R}: \texttt{BoxCox.lambda\_(y)} din pachetul \texttt{forecast}
            \end{itemize}
            \vspace{-1pt}
        \end{exampleblock}
        \vspace{-2mm}
        \begin{alertblock}{De ce nu doar logaritm?}
            \vspace{-1pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Log ($\lambda=0$) presupune varianță proporțională cu nivelul -- nu este întotdeauna cazul ($\lambda = 0.3$ poate fi mai bun)
...
\begin{frame}{Descompunerea STL: Alternative moderne}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{STL: Seasonal-Trend decomposition using Loess (Cleveland et al., 1990)}
            \vspace{-2pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Avantaje}: sezonalitate variabilă în timp, robustă la valori aberante, orice perioadă $s$
        ...
        \begin{exampleblock}{Parametri}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Robustitate} (\texttt{robust=True}): reduce influența valorilor aberante
            \end{itemize}
            \vspace{-2pt}
        \end{exampleblock}
...
\begin{frame}{Demonstrație: diferențierea sezonieră elimină sezonalitatea deterministă}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Afirmație}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Dacă $Y_t = \mu_t + \varepsilon_t$ unde $\mu_t = \mu_{t-s}$ (medie periodică, se repetă la fiecare $s$ perioade), atunci $\Delta_s Y_t$ elimină media sezonieră
            \end{itemize}
        \end{block}
        \vspace{-1mm}
        ...
        \begin{block}{Proprietățile lui $\Delta_s Y_t = \varepsilon_t - \varepsilon_{t-s}$}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $\E[\Delta_s Y_t] = 0$ (medie constantă); $\Var(\Delta_s Y_t) = 2\sigma^2$ (varianță constantă) -- staționaritate de ordin 2
                \item \textbf{Autocovarianța}: $\gamma(s) = -\sigma^2$, $\gamma(k) = 0$ pentru $k \neq 0, s$ (ACF: un singur vârf la lag-ul $s$, apoi zero)
            \end{itemize}
        \end{block}
        \vspace{-1mm}
...
\begin{frame}{ACF înainte și după diferențiere}
    ...
    \begin{exampleblock}{}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item După $\Delta\Delta_{12}$: ACF se oprește brusc $\Rightarrow$ \textbf{staționară}
        \end{itemize}
    \end{exampleblock}
    }
    \begin{center}
...
\begin{frame}{SARIMA: Ilustrare vizuală}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Originală $\Rightarrow$ diferență obișnuită (elimină trendul) $\Rightarrow$ diferență sezonieră (elimină sezonalitatea)
...
\begin{frame}{Notația SARIMA}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Exemplu}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{SARIMA$(1,1,1)\times(1,1,1)_{12}$}: date lunare cu AR(1), MA(1), AR sezonier(1), MA sezonier(1)
                \item Include atât diferențiere obișnuită ($d=1$) cât și sezonieră ($D=1$)
            \end{itemize}
        \end{exampleblock}
    \end{cminipage}
    }
...
\begin{frame}{Exemplu: ACF/PACF pentru modelul Airline}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Concluzie}: ACF se oprește brusc $\Rightarrow$ componentă MA; PACF scade $\Rightarrow$ nu AR
                \item \textbf{Model identificat}: $(0,1,1)\times(0,1,1)_{12}$
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Ghid de identificare a modelului}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Proces pas cu pas}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Pas 1}: examinați ACF pentru descreștere lentă la lag-uri sezoniere $\Rightarrow$ diferențiere sezonieră
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Estimare prin verosimilitate maximă}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \begin{itemize}
                    \item MLE (Maximum Likelihood Estimation) condiționată (condiționată de valorile inițiale)
        ...
        \begin{block}{Considerații computationale}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Mai mulți parametri decât ARIMA $\Rightarrow$ mai multe date necesare
...
\begin{frame}{Verosimilitate exactă: descompunerea erorilor de predicție}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{De ce filtrul Kalman?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{SARIMA}: are structura unui model în spațiul stărilor
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Condiții de staționaritate}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Non-sezonier}: $\phi(z) = 0$ $\Rightarrow$ $|z| > 1$
                \item \textbf{Sezonier}: $\Phi(z^s) = 0$ $\Rightarrow$ $|z| > 1$
            \end{itemize}
        \end{block}
        ...
        \begin{block}{Condiții de invertibilitate}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Non-sezonier}: $\theta(z) = 0$ $\Rightarrow$ $|z| > 1$
                \item \textbf{Sezonier}: $\Theta(z^s) = 0$ $\Rightarrow$ $|z| > 1$
            \end{itemize}
        \end{block}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Algoritmul Hyndman-Khandakar (\texttt{auto\_arima})}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Cum funcționează selecția automată? (Hyndman \& Khandakar, 2008)}
            \vspace{-3pt}
            \begin{enumerate}\setlength{\itemsep}{0pt}
                \item \textbf{$d$}: teste KPSS (Kwiatkowski-Phillips-Schmidt-Shin) succesive ($d = 0, 1, 2$); \textbf{$D$}: testul OCSB sau Canova-Hansen ($D = 0, 1$)
        ...
        \begin{exampleblock}{Strategia de căutare}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Variații testate}: $\pm 1$ pentru fiecare ordin ($p, q, P, Q$)
                \item \textbf{Oprire}: când niciun model vecin nu îmbunătățește AICc
...
\begin{frame}{Metrica MASE: Evaluare corectă pentru serii sezoniere}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{De ce MASE și nu MAPE?}
            \vspace{-2pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item MAPE (Mean Absolute Percentage Error): nedefinit pentru $Y_t = 0$; asimetric; dependent de scară
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Procedura pas cu pas}
            ...
            \begin{enumerate}\setlength{\itemsep}{0pt}
                ...
                \item $\ldots$ repetă de $N$ ori; calculează RMSE (Root Mean Squared Error), MAE (Mean Absolute Error), MASE pe toate cele $N$ prognoze
            \end{enumerate}
            \vspace{-2pt}
        \end{exampleblock}
...
\begin{frame}{SARIMA vs Holt-Winters/ETS: Când folosim ce?}
    ...
    {\footnotesize
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Comparație --- ETS (Error-Trend-Seasonality)}
            \begin{center}
            \resizebox{\linewidth}{!}{%
            \begin{tabular}{p{2.2cm}p{4cm}p{4cm}}
                ...
                \midrule
                Abordare & Box-Jenkins (ACF/PACF, cf.\ Cap.\ 3) & Netezire exponențială \\
        ...
        \begin{exampleblock}{Ghid practic de selecție}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item \textbf{SARIMA preferat}: serii cu autocorelație complexă, sezonalitate stochastică
                \item \textbf{ETS preferat}: serii scurte, sezonalitate stabilă, prognoze rapide
...
\begin{frame}{Studiu de caz: Date despre pasagerii aerieni}
    ...
    \begin{exampleblock}{}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Trend ascendent cu amplitudine sezonieră crescătoare (sezonalitate multiplicativă)
            \item Prima decizie: aplicăm transformarea logaritmică pentru a stabiliza varianța
        \end{itemize}
    \end{exampleblock}
    }
    \begin{center}
...
\begin{frame}{Strategia de împărțire a datelor}
    \begin{cminipage}{0.95\textwidth}
        ...
        {\scriptsize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Set de antrenare (70\%)}: estimare coeficienți SARIMA ($\phi$, $\theta$, $\Phi$, $\Theta$)
            \item \textbf{Set de validare (15\%)}: comparare modele candidate, alegere cea mai mică eroare
            \item \textbf{Set de test (15\%)}: evaluare finală out-of-sample, niciodată folosit în dezvoltare
        \end{itemize}
        }
    \end{cminipage}
\end{frame}
...
\begin{frame}{Pasul 1: Transformări}
    ...
    \begin{exampleblock}{}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Transformarea log stabilizează varianța (multiplicativ $\Rightarrow$ aditiv)
...
\begin{frame}{Pasul 2: Analiza ACF/PACF}
    ...
    \begin{exampleblock}{}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item ACF: Vârf semnificativ la lag 1 și lag 12 $\Rightarrow$ MA(1), SMA(1)
...
\begin{frame}{Capcane practice în modelarea SARIMA}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{2. Număr insuficient de date}
            \vspace{-2pt}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Minimum}: 3--4 cicluri sezoniere complete (36--48 obs.\ lunare)
                \item \textbf{Recomandat}: 5+ cicluri sezoniere pentru estimare robustă
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Ce este ajustarea sezonieră?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Utilizatori}: Eurostat, US Census Bureau, BNR (Banca Națională a României)
                \item INS (Institutul Național de Statistică), BCE (Banca Centrală Europeană)
...
\begin{frame}{Rezumat}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Observație}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Principiul parcimoniei}: Modelul Airline $(0,1,1)\times(0,1,1)_{12}$ are doar 2 parametri
                \item Este remarcabil de eficient pentru multe serii economice sezoniere
            \end{itemize}
        \end{exampleblock}
    \end{cminipage}
    }
...
\begin{frame}{Întrebarea 3: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Descompunerea notației SARIMA}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{$(p,d,q)$}: Non-sezonier $\Rightarrow$ AR($p$), $d$ diferențe, MA($q$)
                \item \textbf{$(P,D,Q)_s$}: Sezonier $\Rightarrow$ SAR($P$), $D$ dif. sezoniere, SMA($Q$)
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Resurse online și cod}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch4} -- Cod Python pentru acest capitol
            \end{itemize}
            }
        \end{exampleblock}
    \end{cminipage}
