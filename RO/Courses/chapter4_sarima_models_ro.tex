...
\vfuzz=12pt  % Suppress small vertical overfull warnings from cminipage spacing
...
\begin{frame}{Sezonalitate aditivă vs multiplicativă}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.42\textheight, keepaspectratio]{additive_vs_multiplicative.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\scriptsize
    \begin{columns}[T]
...
\begin{frame}{Box-Cox pe datele Airline: Exemplu complet}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.45\textheight, keepaspectratio]{ch4_boxcox_airline.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{columns}[T]
...
\begin{frame}{ACF înainte și după diferențiere}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.58\textheight, keepaspectratio]{ch4_acf_differencing.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{exampleblock}{}
...
\begin{frame}{Exemplu: ACF/PACF pentru modelul Airline}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.42\textheight, keepaspectratio]{ch4_acf_pacf.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{columns}[T]
...
\begin{frame}{Strategia de împărțire a datelor}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.40\textheight, keepaspectratio]{train_val_test_split.pdf}
    \end{center}
    \vspace{-0.35cm}
    {\scriptsize
    \begin{exampleblock}{}
