...
\begin{frame}{Procesul de zgomot alb}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Observație}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Zgomotul alb este cel mai simplu proces staționar --- bloc de construcție pentru modelele ARMA
...
\begin{frame}{Funcția de autocorelație parțială (PACF)}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Aplicație cheie}
            \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Întrebarea 5}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Variante de răspuns}
            ...
            \textcolor{MainBlue}{\textbf{(C)}} Scade foarte lent (persistență înaltă)\\[3pt]
