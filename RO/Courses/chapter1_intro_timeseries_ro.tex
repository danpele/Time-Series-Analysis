            ...
            \begin{column}{0.45\textwidth}
                ...
                \begin{block}{Interpretare}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item AR(1) $\phi > 0$: putere la frecvențe joase
                        \item Periodograma: estimator empiric al lui $S(\omega)$
                        \item Util pt.\ detectarea sezonalității ascunse
                    \end{itemize}
                \end{block}
                }
            \end{column}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{defn}[Statistica Ljung-Box, 1978]
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $Q(m) = n(n+2)\sum_{k=1}^{m} \frac{\hat{\rho}(k)^2}{n-k} \;\xrightarrow{H_0}\; \chi^2(m)$
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{defn}[Proces local staționar (Dahlhaus, 1997)]
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Intuiție}: procesul ``arată'' staționar în vecinătăți mici de timp
            \end{itemize}
        \end{defn}
        }
        \vspace{-2mm}
        ...
        \begin{columns}[T]
            \begin{column}{0.48\textwidth}
                \begin{block}{Contrast cu staționaritatea globală}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item \textbf{Global staționar}: $f(\omega)$ constantă în timp
                        \item \textbf{Local staționar}: $f(u,\omega)$ variază neted cu $u = t/T$
                    \end{itemize}
                \end{block}
            \end{column}
            \begin{column}{0.48\textwidth}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Avantaj față de Fourier}: localizare \textit{simultană} timp-frecvență; Fourier pierde informația temporală
            \end{itemize}
        \end{block}
        }
...
\begin{frame}{Analiza wavelet vs. Fourier: comparație vizuală}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Fourier}: descompune în frecvențe globale --- nu detectează unde \textit{în timp} apar ciclurile
                \item \textbf{Wavelet}: detectează cicluri \textit{locale} --- identifică rupturi structurale și regimuri
            \end{itemize}
        \end{block}
        }
        \hfill\quantlet{TSA\_ch12\_wavelet}{https://github.com/danpele/TSA/tree/main/TSA_ch12/TSA_ch12_wavelet}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Scalograma: $|W_X(a,b)|^2$}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Frecvențe înalte $\Rightarrow$ fereastră îngustă (rezoluție temporală bună); frecvențe joase $\Rightarrow$ fereastră largă (rezoluție în frecvență bună)
            \end{itemize}
        \end{block}
        }
        ...
        \begin{columns}[T]
            \begin{column}{0.48\textwidth}
                \begin{block}{Coerența wavelet}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Măsoară \textbf{co-mișcarea} a două serii la diferite scale temporale
                        \item Analog al corelației, dar \textit{localizat} în timp și frecvență
                        \item Aplicații: relația petrol -- burse, sincronizarea ciclurilor economice
                    \end{itemize}
                \end{block}
            \end{column}
            \begin{column}{0.48\textwidth}
                \begin{exampleblock}{Descompunerea varianței wavelet}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item Scala $j$: perioade $\approx [2^{j}, 2^{j+1})$
                        \item Identifică orizonturile temporale dominante
                    \end{itemize}
                \end{exampleblock}
            \end{column}
        \end{columns}
