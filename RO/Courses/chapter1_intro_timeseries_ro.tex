    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{thm}[Wold, 1938]
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \begin{itemize}
                    \item $\varepsilon_t \sim WN(0, \sigma^2)$ $\succ$ zgomot alb, cu $\psi_0 = 1$, $\sum \psi_j^2 < \infty$
...
\begin{frame}{Procesul de mers aleatoriu}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Nestaționar!}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $\Var(X_t) = t\sigma^2$ depinde de $t$ $\succ$ mersul aleatoriu \textbf{nu este staționar}
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Mers aleatoriu cu drift}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Diferențiere}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $\Delta X_t = c + \varepsilon_t$ --- constantă plus zgomot alb $\succ$ seria diferențiată este staționară
            \end{itemize}
        \end{alertblock}
        \vspace{-2mm}
        \begin{exampleblock}{Importanța practică}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item PIB nominal, prețuri de acțiuni $\succ$ adesea modele ca RW (Random Walk --- mers aleatoriu) cu drift
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Aplicație practică}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $\phi_{hh} = 0$ pentru $h > p$ $\succ$ PACF se anulează după lag-ul $p$
            \end{itemize}
        \end{exampleblock}
    \end{cminipage}
\end{frame}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Volatilitate variabilă în timp} $\succ$ necesită modele specializate (Cap.\ 5)
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Resurse online și cod}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch1} $\succ$ Cod Python pentru acest capitol
            \end{itemize}
            }
        \end{exampleblock}
    \end{cminipage}
