...
\begin{frame}{Teorema de descompunere Wold}
    ...
    \begin{thm}[Wold, 1938]
        ...
        \begin{itemize}
            \item $\varepsilon_t \sim WN(0, \sigma^2)$ $\rightarrow$ zgomot alb
            \begin{itemize}
...
\begin{frame}{Procesul de mers aleatoriu}
    ...
    {\footnotesize $\Var(X_t) = t\sigma^2$ depinde de $t$ $\rightarrow$ mersul aleatoriu \textbf{nu este staționar}}
    \end{alertblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Volatility clustering}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item \textbf{Volatilitate variabilă în timp} $\rightarrow$ modele ARCH/GARCH (Cap. 5)
    \end{itemize}
    \end{exampleblock}
    }
    \hfill\quantlet{TSA\_ch1\_ts\_basics}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_ts_basics}
...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\small
        ``Folosind yfinance, descarcă cursul EUR/RON. Seria e staționară? Ajustează un model și prognozează cursul săptămâna viitoare. Spune-mi dacă prognoza e fiabilă.''
        }
    \end{block}
    \vspace{-1mm}
    {\small
    ...
    \vspace{-1mm}
    \begin{alertblock}{}
        {\small \textbf{Atenție}: RMSE mic și coeficienți semnificativi \textit{nu garantează} o prognoză utilă.}
    \end{alertblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 1: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch1_quiz2_stationarity.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
    ...
    \quantlet{TSA\_ch1\_stationarity}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_stationarity}
\end{frame}

\begin{frame}{Întrebarea 2: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{adf_test_visualization.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 3: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch1_stationarity.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 4: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch1_quiz4_wn_rw.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{rw_vs_stationary.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Bibliografie}
    ...
    \begin{columns}[T]
        ...
        \begin{alertblock}{Resurse Online}
            {\scriptsize
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Quantlet}: \url{https://quantlet.com} $\rightarrow$ cod statistică
                \item \textbf{Quantinar}: \url{https://quantinar.com} $\rightarrow$ tutoriale
