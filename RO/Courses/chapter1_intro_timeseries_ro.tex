    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{La finalul acestui capitol, veți fi capabili să:}
            \begin{enumerate}\setlength{\itemsep}{0pt}
                ...
                \item[\textcolor{MainBlue}{\textbf{2.}}] \textbf{Diferențiați} între staționaritatea strictă și slabă (covarianță)
                ...
                \item[\textcolor{MainBlue}{\textbf{8.}}] \textbf{Diferențiați} între procesele cu rădăcină unitate și cele staționare în trend
            \end{enumerate}
        \end{block}
    \end{cminipage}
\end{frame}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Randamente log: $r_t = \ln P_t - \ln P_{t-1}$ $\Rightarrow$ nestaționar $\to$ staționar
            \end{itemize}
        \end{block}
        }
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Modelul AR(1) (AutoRegressive de ordin 1)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $\varepsilon_t \sim WN(0, \sigma^2)$ --- WN (White Noise) = zgomot alb
            \end{itemize}
        \end{exampleblock}
        \vspace{-2mm}
...
\begin{frame}{Ergodicitatea: fundamentul inferenței din date}
    ...
    \begin{alertblock}{De ce contează ergodicitatea?}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Soluția}: Ergodicitatea permite estimarea lui $\mu$ din $\bar{X}_T$ --- media temporală converge la media populației. Fără ergodicitate, inferența nu este posibilă!
        \end{itemize}
    \end{alertblock}
    \vspace{-2mm}
...
\begin{frame}{Densitatea spectrală: domeniul frecvențelor}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{defn}[Densitatea spectrală de putere]
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Pentru un proces staționar cu $\sum_{h=-\infty}^{\infty} |\gamma(h)| < \infty$, \textbf{densitatea spectrală} este:
                \vspace{-1mm}
                \[
                ...
                \]
                \vspace{-3mm}
                \item $S(\omega)$ descompune varianța pe frecvențe: $\gamma(0) = \int_{-\pi}^{\pi} S(\omega)\, d\omega$
            \end{itemize}
        \end{defn}
        \vspace{-2mm}
        \vspace{-1mm}
            ...
            \begin{column}{0.48\textwidth}
                \begin{block}{Interpretare}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item MA(1) $\theta > 0$: putere concentrată la frecvențe joase
                    \end{itemize}
                \end{block}
            \end{column}
            \begin{column}{0.48\textwidth}
                \begin{exampleblock}{Conexiuni}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item \textbf{Perechea Fourier}: $S(\omega) \leftrightarrow \gamma(h)$ (echivalente)
                        \item Domeniul timp (ACF) $\equiv$ domeniul frecvență (spectru)
                        \item \textbf{Periodograma}: estimator empiric al lui $S(\omega)$
                        \item Util pentru detectarea sezonalității ascunse
                    \end{itemize}
                \end{exampleblock}
            \end{column}
        \end{columns}
...
\begin{frame}{Teorema de descompunere Wold}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Semnificația teoremei Wold}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Descompunere}: Orice proces staționar = \textbf{MA($\infty$)} (Moving Average de ordin infinit) + componentă deterministă
                \begin{itemize}
...
\begin{frame}{Demonstrația teoremei Wold (schiță)}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{proof}[\footnotesize Schiță de demonstrație]
            \vspace{-1mm}
            \begin{enumerate}\setlength{\itemsep}{1pt}
                \item \textbf{Spațiul Hilbert al trecutului}: Definim $\mathcal{H}_t = \overline{\mathrm{sp}}\{X_s : s \leq t\}$ --- spațiul închis generat de valorile trecute și prezente, cu produsul scalar $\langle X, Y \rangle = \mathrm{Cov}(X,Y)$.
...
\begin{frame}{Teorema Wold: ilustrare vizuală}
    \begin{cminipage}{0.95\textwidth}
        \begin{center}
            \includegraphics[height=4.0cm]{ch1_wold_decomposition.pdf}
        \end{center}
        \vspace{-2mm}
        {\footnotesize
        \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Coeficienții $\psi_j$ descresc $\Rightarrow$ șocurile recente au impact mai mare decât cele îndepărtate
            \end{itemize}
        \end{block}
        }
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Proprietăți}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $L^k X_t = X_{t-k}$ $\Rightarrow$ deplasare cu $k$ perioade; $L^0 = I$ (identitate)
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{De ce diferențiem?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \begin{itemize}
                    ...
                    \item Mers aleator: $\Delta X_t = \varepsilon_t$
                \end{itemize}
            \end{itemize}
        \end{block}
        ...
        \begin{exampleblock}{Exemple}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $I(1)$: Mers aleator $\Rightarrow$ $\Delta X_t = \varepsilon_t$ este staționar
...
\begin{frame}{Procesul de zgomot alb}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Observație}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Zgomotul alb este cel mai simplu proces staționar --- element fundamental al modelelor ARMA
                \item Există trei tipuri: slab, puternic (i.i.d.) și Gaussian (vezi diapozitivul următor)
            \end{itemize}
        \end{exampleblock}
        }
    \end{cminipage}
...
\begin{frame}{Mers aleator cu drift}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Importanța practică}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item PIB nominal, prețuri de acțiuni $\Rightarrow$ adesea modele ca RW cu drift
                \item Testul ADF: variante fără constantă, cu constantă, cu constantă și trend
            \end{itemize}
        \end{exampleblock}
        }
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Mers aleator}: ACF scade foarte lent, rămâne aproape de 1
                \item \textbf{Regulă practică}: ACF lent $\Rightarrow$ suspectăm rădăcină unitate $\Rightarrow$ test ADF
            \end{itemize}
        \end{block}
        }
        \hfill\quantlet{TSA\_ch1\_random\_walk}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_random_walk}
...
\begin{frame}{Funcția de autocorelație eșantion}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{thm}[Bartlett, 1946]
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Sub $H_0$: zgomot alb, pentru $T$ mare: $\hat{\rho}(h) \approx N(0, 1/T)$
            \end{itemize}
        \end{thm}
        \vspace{-1mm}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Reguli de identificare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{ARMA($p,q$)}: Ambele scad exponențial $\Rightarrow$ identificarea necesită criterii informaționale
            \end{itemize}
        \end{exampleblock}
        }
        \hfill\quantlet{TSA\_ch1\_acf\_patterns}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_acf_patterns}
    ...
    \begin{cminipage}{0.95\textwidth}
            ...
            \begin{column}{0.48\textwidth}
                \begin{block}{Statistica de Test}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item $\hat{\gamma}$ = coeficient OLS (Ordinary Least Squares) al $X_{t-1}$
                        \item $SE(\hat{\gamma})$ din regresia OLS
                    \end{itemize}
                \end{block}
            \end{column}
        \end{columns}
        ...
        \begin{alertblock}{Regula de decizie}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $\tau_{ADF} \geq$ val.\ critică $\Rightarrow$ \textcolor{Crimson}{Nestaționar (rădăcină unitate)}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Modelul}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $\varepsilon_t \sim WN(0, \sigma_\varepsilon^2)$ (eroare stationară), \; $u_t \sim WN(0, \sigma_u^2)$ (inovația mersului aleator)
            \end{itemize}
        \end{block}
            ...
            \begin{column}{0.48\textwidth}
                \begin{exampleblock}{Ipoteze (opus ADF)}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item \textbf{$H_1$}: $\sigma_u^2 > 0$ \; (seria este $I(1)$, rădăcina unitară)
                    \end{itemize}
                \end{exampleblock}
            \end{column}
            \begin{column}{0.48\textwidth}
        ...
        \begin{alertblock}{Regula de decizie}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $LM >$ valoarea critică $\Rightarrow$ Respingem $H_0$ $\Rightarrow$ \textcolor{Crimson}{Nestaționar}
                \item $LM \leq$ valoarea critică $\Rightarrow$ \textcolor{Forest}{Staționar}
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{ADF vs KPSS: comparație pe S\&P 500}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare comparativă}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{ADF}: $H_0$ = rădăcină unitate --- respingem $\Rightarrow$ \textcolor{Forest}{staționar}
...
\begin{frame}{Folosirea ADF și KPSS împreună}
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Testare confirmatorie}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \begin{itemize}
                    ...
                    \item Sau DF-GLS (Dickey-Fuller Generalized Least Squares)
                \end{itemize}
            \end{itemize}
        \end{block}
        ...
        \begin{exampleblock}{Flux de lucru}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Pasul 1}: Test ADF ($H_0$: rădăcina unitară)
                \item \textbf{Pasul 2}: Test KPSS ($H_0$: staționar)
                \item \textbf{Pasul 3}: Rezultate concordante $\Rightarrow$ OK
                \begin{itemize}
...
\begin{frame}{Testul Phillips-Perron (PP)}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{defn}[Phillips-Perron, 1988]
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Testează aceeași ipoteză ca ADF: $H_0$: rădăcină unitate ($\gamma = 0$)
            ...
            \begin{column}{0.48\textwidth}
                \begin{block}{Statistica PP}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item $\hat{\lambda}^2$: varianța de lungă durată (kernel Newey-West)
                        \item $s_e^2$: varianța reziduală OLS
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{ADF vs PP: când diferă?}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Divergență}: date financiare cu heteroscedasticitate --- PP preferabil
                \item \textbf{Divergență}: serii cu componentă MA negativă puternică --- ADF preferabil
                \item Practică: rulați ambele teste și comparați rezultatele
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Perioade de calm urmate de perioade de volatilitate ridicată
                \item \textbf{Volatilitate variabilă în timp} $\Rightarrow$ necesită modele specializate (Cap.\ 5)
                \item Modele ARCH (AutoRegressive Conditional Heteroskedasticity) / GARCH (Generalized ARCH)
            \end{itemize}
        \end{block}
        }
        \hfill\quantlet{TSA\_ch1\_ts\_basics}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_ts_basics}
...
\begin{frame}{Studiu de caz: PIB-ul trimestrial al României}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Analiza inițială}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Date}: PIB trimestrial România 2010--2023 (56 obs., INS --- Institutul Național de Statistică / Eurostat)
                \item \textbf{Observații}: Trend ascendent, posibil sezonier
                \begin{itemize}
                    \item Șoc structural COVID-19 vizibil
                \end{itemize}
                \item \textbf{Ipoteză}: Serie nestaționară $\Rightarrow$ testăm cu ADF și KPSS
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
...
\begin{frame}{Exercițiu AI: Gândire critică}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{enumerate}\setlength{\itemsep}{2pt}
            ...
            \item Testul ADF e specificat corect (trend, lag-uri)? Ce se schimbă dacă modificați opțiunile?
            \item Comparați prognoza modelului AI cu un benchmark naiv ($\hat{X}_{t+1} = X_t$).
            \item Dacă seria e un mers aleatoriu, are sens să ajustăm un model ARMA?
        \end{enumerate}
        }
        \vspace{-1mm}
        \begin{alertblock}{}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item {\small \textbf{Atenție}: Un RMSE (Root Mean Squared Error) mic și coeficienți semnificativi \textit{nu garantează} o prognoză utilă.}
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
\end{frame}
        ...
        \begin{columns}[T]
            ...
            \begin{exampleblock}{Ce vom învăța}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item \textbf{Selecție}: AIC (Akaike Information Criterion), BIC (Bayesian Information Criterion)
                \end{itemize}
            \end{exampleblock}
        \end{columns}
    \end{cminipage}
...
\begin{frame}{Întrebarea 2}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Variante de răspuns}
            ...
            \textcolor{MainBlue}{\textbf{(B)}} Seria are rădăcină unitate (este nestaționară)\\[3pt]
...
\begin{frame}{Întrebarea 2: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Răspuns: (B)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $H_0$: rădăcină unitate; $\tau <$ val. critică $\Rightarrow$ staționară
            \end{itemize}
        \end{exampleblock}
        }
...
\begin{frame}{Întrebarea 3}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Variante de răspuns}
            ...
            \textcolor{MainBlue}{\textbf{(A)}} Seria are rădăcină unitate (nestaționară)\\[3pt]
...
%=============================================================================
% EXTENSII: PROCESE LOCAL STAȚIONARE
%=============================================================================
\section{Extensii: Procese Local Staționare}
...
\begin{frame}{Procese local staționare}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{defn}[Proces local staționar (Dahlhaus, 1997)]
            Un proces $\{X_{t,T}\}_{t=1,\ldots,T}$ este \textbf{local staționar} dacă, la fiecare timp rescalat $u = t/T \in [0,1]$, admite o reprezentare spectrală variabilă în timp:
            \[
            X_{t,T} = \int_{-\pi}^{\pi} A\!\left(\tfrac{t}{T},\, \omega\right)\, e^{i\omega t}\, d\xi(\omega)
            \]
            unde $A(u,\omega)$ este \textbf{funcția de transfer variabilă în timp}, iar $\xi(\omega)$ este un proces cu incrementuri ortogonale.
        \end{defn}
        }
        \vspace{-2mm}
        {\scriptsize
        \begin{block}{Contrast cu staționaritatea globală}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Staționar global}: densitate spectrală $f(\omega)$ -- constantă în timp
                \item \textbf{Local staționar}: densitate spectrală $f(u,\omega)$ -- variază neted cu $u = t/T$
                \item Intuiție: procesul ``arată'' staționar în vecinătăți mici de timp
            \end{itemize}
        \end{block}
        }
        \vspace{-2mm}
        ...
        \begin{exampleblock}{Aplicații}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Randamente financiare cu \textbf{regimuri de volatilitate} variabile (ex.\ pre/post-criză)
                \item Serii macroeconomice cu \textbf{rupturi structurale} (schimbări de politică monetară)
                \item Semnale EEG/ECG cu structură spectrală nestabilă
            \end{itemize}
        \end{exampleblock}
        }
        \hfill\quantlet{TSA\_ch1\_locally\_stationary}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_locally_stationary}
    \end{cminipage}
\end{frame}

\begin{frame}{Analiza wavelet: transformate}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-3mm}
        {\scriptsize
        \begin{block}{Transformata wavelet continuă (CWT)}
            Fie $\psi(t)$ un \textbf{wavelet-mamă} cu $\int \psi(t)\,dt = 0$. Transformata wavelet a seriei $X(t)$:
            \[
            W_X(a,b) = \frac{1}{\sqrt{a}} \int_{-\infty}^{\infty} X(t)\, \psi^{*}\!\left(\frac{t-b}{a}\right) dt
            \]
            unde $a > 0$ = \textbf{scală} (frecvență inversă), $b$ = \textbf{localizare temporală}, $\psi^{*}$ = conjugata complexă.
        \end{block}
        }
        \vspace{-2mm}
        {\scriptsize
        \begin{block}{Transformata wavelet discretă (DWT)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Algoritmul Mallat}: descompunere piramidală cu filtre trece-jos/trece-sus
                \item \textbf{Analiză multirezoluție} (MRA): $X(t) = \sum_{j} D_j(t) + S_J(t)$, unde $D_j$ = detalii, $S_J$ = aproximare
            \end{itemize}
        \end{block}
        }
        \hfill\quantlet{TSA\_ch1\_wavelets}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_wavelets}
    \end{cminipage}
\end{frame}

\begin{frame}{Analiza wavelet: tipuri și avantaje}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-2mm}
        {\scriptsize
        \begin{exampleblock}{Wavelet-uri uzuale}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Haar}: discontinuu, simplu, utilizat în compresie de imagini
                \item \textbf{Daubechies} (db4): compact, utilizat în analiza semnalelor
                \item \textbf{Morlet}: complex, bun pentru analiza frecvențelor
            \end{itemize}
        \end{exampleblock}
        }
        \vspace{-2mm}
        {\scriptsize
        \begin{alertblock}{Avantaj principal față de Fourier}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Localizare \textit{simultană} timp-frecvență (principiul Heisenberg)
                \item Fourier: rezoluție perfectă în frecvență, zero în timp
                \item Wavelets: compromis adaptiv --- rezoluție variabilă în timp și frecvență
            \end{itemize}
        \end{alertblock}
        }
        \vspace{-2mm}
        {\scriptsize \textcolor{gray}{Referință: Percival, D.B. \& Walden, A.T. (2000). \textit{Wavelet Methods for Time Series Analysis}, Cambridge University Press.}}
        \hfill\quantlet{TSA\_ch1\_wavelets}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_wavelets}
    \end{cminipage}
\end{frame}

\begin{frame}{Spectrograma și scalograma}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-3mm}
        {\scriptsize
        \begin{block}{Transformata Fourier de scurtă durată (STFT)}
            Cu o fereastră $w(t)$ de lungime fixă:
            \[
            S(\tau,\omega) = \int_{-\infty}^{\infty} X(t)\, w(t-\tau)\, e^{-i\omega t}\, dt
            \]
            \textbf{Spectrograma}: $|S(\tau,\omega)|^2$ -- reprezentare timp-frecvență cu \textit{rezoluție fixă}.
        \end{block}
        }
        \vspace{-2mm}
        {\scriptsize
        \begin{block}{Scalograma}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Scalograma}: $|W_X(a,b)|^2$ -- reprezentare timp-scală cu \textit{rezoluție adaptivă}
                \item Frecvențe înalte $\Rightarrow$ fereastră temporală \textbf{îngustă}, rezoluție temporală bună
                \item Frecvențe joase $\Rightarrow$ fereastră temporală \textbf{largă}, rezoluție în frecvență bună
            \end{itemize}
        \end{block}
        }
        \vspace{-2mm}
        {\scriptsize
        \begin{alertblock}{Compromisul rezoluție timp--frecvență}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{STFT}: fereastră fixă $\Rightarrow$ rezoluție uniformă (aceeași $\Delta t$, $\Delta\omega$ peste tot)
                \item \textbf{Wavelets}: fereastră adaptivă $\Rightarrow$ $\Delta t$ mică la frecvențe înalte, $\Delta\omega$ mică la frecvențe joase
                \item Planul timp-frecvență: STFT $\to$ \textit{dale rectangulare egale}; wavelets $\to$ \textit{dale adaptive}
            \end{itemize}
        \end{alertblock}
        }
        \hfill\quantlet{TSA\_ch1\_spectrogram}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_spectrogram}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Coerența wavelet și descompunerea varianței}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Coerența wavelet}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Măsoară \textbf{co-mișcarea} a două serii la diferite scale temporale și perioade
                \item Analog al corelației clasice, dar \textit{localizat} în timp și frecvență
                \item Aplicații: relația prețuri petrol -- piețe bursiere, sincronizarea ciclurilor economice
            \end{itemize}
        \end{block}
        }
        \vspace{-2mm}
        {\scriptsize
        \begin{block}{Descompunerea varianței wavelet}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Varianța totală se descompune pe scale: $\Var(X) = \sum_{j=1}^{J} \nu_j^2$
                \item Scala $j$ corespunde fluctuațiilor cu perioade $\approx [2^{j}, 2^{j+1})$
                \item Identifică ce orizonturi temporale contribuie cel mai mult la variabilitatea seriei
            \end{itemize}
        \end{block}
        }
        \hfill\quantlet{TSA\_ch1\_wavelet\_coherence}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_wavelet_coherence}
    \end{cminipage}
\end{frame}

\begin{frame}{Pachete software pentru analiza wavelet}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-2mm}
        {\scriptsize
        \begin{exampleblock}{Pachete software principale}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Python}: \texttt{pywt} (PyWavelets) -- DWT, CWT, familii wavelet
                \item \textbf{R}: \texttt{WaveletComp} -- coerență wavelet, scalograme, teste de semnificație
        ...
        \vspace{-2mm}
        {\scriptsize
        \begin{block}{Resurse bibliografice}
            \begin{itemize}\setlength{\itemsep}{0pt}
