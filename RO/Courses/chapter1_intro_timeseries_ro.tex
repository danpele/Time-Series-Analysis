            ...
            \begin{column}{0.48\textwidth}
                \begin{block}{Interpretare}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item MA(1) $\theta > 0$: putere concentrată la frecvențe înalte
                    \end{itemize}
                \end{block}
            \end{column}
            \begin{column}{0.48\textwidth}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{ACF randamente}: $\approx 0$ (eficient); \textbf{ACF $r_t^2$}: Semnificativ (aglomerarea volatilității)
            \end{itemize}
        \end{block}
        }
...
\begin{frame}{Aglomerarea volatilității}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-0.3cm}
        \begin{center}
