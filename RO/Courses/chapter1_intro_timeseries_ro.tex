...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\small
        ``Am date zilnice cu cursul EUR/RON din ultimii 5 ani. Testează staționaritatea, ajustează un model potrivit și fă o prognoză pentru săptămâna viitoare. Evaluează acuratețea prognozei.''
        }
    \end{block}
    \vspace{-1mm}
    {\small
