...
\begin{frame}{Exemple: serii staționare vs. nestaționare}
    ...
    \hfill\quantlet{TSA\_ch1\_motivation}{Quantlets/TSA\_ch1/TSA\_ch1\_ts\_basics}
\end{frame}
...
\begin{frame}{Proces stochastic: ilustrare vizuală}
    ...
    \hfill\quantlet{TSA\_ch1\_stochastic\_process}{Quantlets/TSA\_ch1/TSA\_ch1\_stationarity}
\end{frame}
...
\begin{frame}{Staționaritatea strictă: ilustrare vizuală}
    ...
    \hfill\quantlet{TSA\_ch1\_stationarity}{Quantlets/TSA\_ch1/TSA\_ch1\_stationarity}
\end{frame}
...
\begin{frame}{Contraexemplu: slab staționar dar NU strict staționar}
    ...
    \hfill\quantlet{TSA\_ch1\_counterexample}{Quantlets/TSA\_ch1/TSA\_ch1\_stationarity}
\end{frame}
...
\begin{frame}{Ergodicitatea: ilustrare vizuală}
    \begin{center}
        \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch1_ergodicity.pdf}
    \end{center}
    \vspace{-3mm}
    {\footnotesize
    \begin{itemize}\setlength{\itemsep}{0pt}
    ...
    \hfill\quantlet{TSA\_ch1\_ergodicity}{Quantlets/TSA\_ch1/TSA\_ch1\_stationarity}
\end{frame}
...
\begin{frame}{Teorema Wold: ilustrare vizuală}
    ...
    \hfill\quantlet{TSA\_ch1\_wold\_decomposition}{Quantlets/TSA\_ch1/TSA\_ch1\_operators}
\end{frame}
...
\begin{frame}{Operatorul lag: ilustrare vizuală}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.58\textheight, keepaspectratio]{ch1_def_lag_operator.pdf}
    \end{center}
    \vspace{-2mm}
    {\footnotesize
    ...
    \hfill\quantlet{TSA\_ch1\_differencing}{Quantlets/TSA\_ch1/TSA\_ch1\_operators}
\end{frame}
...
\begin{frame}{Procesul de zgomot alb}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \begin{itemize}
            \item Necorelat $\Rightarrow$ independent
        \end{itemize}
    \end{itemize}
    \end{exampleblock}
    }
...
\begin{frame}{Zgomot alb: ilustrare vizuală}
    ...
    \end{center}
    \vspace{-3mm}
    \hfill\quantlet{TSA\_ch1\_white\_noise}{Quantlets/TSA\_ch1/TSA\_ch1\_white\_noise}
\end{frame}
...
\begin{frame}{Mers aleatoriu: vizualizare}
    ...
    \hfill\quantlet{TSA\_ch1\_random\_walk}{Quantlets/TSA\_ch1/TSA\_ch1\_random\_walk}
\end{frame}
...
\begin{frame}{Tipare de scădere ACF}
    ...
    \hfill\quantlet{TSA\_ch1\_acf\_patterns}{Quantlets/TSA\_ch1/TSA\_ch1\_acf\_patterns}
\end{frame}
...
\begin{frame}{Testul ADF: vizualizare cu S\&P 500}
    ...
    \end{center}
    \vspace{-2mm}
    \quantlet{TSA\_ch1\_unit\_root\_tests}{Quantlets/TSA\_ch1/TSA\_ch1\_unit\_root\_tests}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Analiza S\&P 500: prezentare generală}
    ...
    \hfill\quantlet{TSA\_ch1\_ts\_basics}{Quantlets/TSA\_ch1/TSA\_ch1\_ts\_basics}
\end{frame}
...
\begin{frame}{Studiu de caz: PIB-ul trimestrial al României}
    ...
    \end{center}
    \vspace{-2mm}
    \quantlet{TSA\_ch1\_case\_gdp}{Quantlets/TSA\_ch1/TSA\_ch1\_case\_gdp}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Diferențierea: transformare la staționaritate}
    \begin{columns}[T]
        \column{0.48\textwidth}
...
\begin{frame}{Întrebarea 2: Răspuns}
    ...
    \hfill\quantlet{TSA\_ch1\_unit\_root\_tests}{Quantlets/TSA\_ch1/TSA\_ch1\_unit\_root\_tests}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{alertblock}{Resurse Online}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{GitHub}: \url{https://github.com/QuantLet/TSA}
            \end{itemize}
            }
        \end{alertblock}
    \end{columns}
