...
\begin{frame}{Exemplu: AR(1) este slab staționar}
    \begin{cminipage}{0.95\textwidth}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Diferențierea}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \begin{itemize}
            \item Elimină trendul și rădăcina unitară
...
\begin{frame}{Procesul de zgomot alb}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item \textbf{Gaussian}: $\varepsilon_t \stackrel{iid}{\sim} N(0, \sigma^2)$ (necorelat $\succ$ independent)
    \end{itemize}
    \end{exampleblock}
    }
    \end{cminipage}
...
\begin{frame}{Procesul de mers aleatoriu}
    ...
    \begin{defn}[Mers Aleatoriu]
        ...
        $\succ$ \textbf{Forma explicită}: $X_t = \sum_{i=1}^{t} \varepsilon_i$
    \end{defn}
    \vspace{-2mm}
    {\footnotesize
...
\begin{frame}{Mers aleatoriu cu drift}
    ...
    \begin{defn}[Mers Aleatoriu cu Drift]
        ...
        $\succ$ \textbf{Forma explicită}: $X_t = ct + \sum_{i=1}^{t} \varepsilon_i$
    \end{defn}
    \vspace{-2mm}
    \begin{prop}[Proprietăți]
        \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Comparație ACF: staționar vs mers aleatoriu}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item \textbf{Regulă practică}: ACF lent $\succ$ suspectăm rădăcină unitară $\succ$ test ADF
    \end{itemize}
    \end{block}
    }
    \hfill\quantlet{TSA\_ch1\_random\_walk}{https://github.com/QuantLet/TSA/tree/main/TSA_ch1/TSA_ch1_random_walk}
...
\begin{frame}{Testul Augmented Dickey-Fuller (ADF)}
    ...
    \begin{alertblock}{Regula de decizie}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item $\tau_{ADF} \geq$ val.\ critică $\succ$ \textcolor{Crimson}{Nestaționar (rădăcină unitară)}
        ...
        \begin{column}{0.48\textwidth}
            \begin{exampleblock}{Ipoteze (opus ADF)}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item \textbf{$H_1$}: $\sigma_u^2 > 0$ (rădăcină unitară)
                \end{itemize}
            \end{exampleblock}
        \end{column}
        \begin{column}{0.48\textwidth}
...
\begin{frame}{Testul ADF: vizualizare cu S\&P 500}
    ...
    \begin{block}{Interpretarea testului ADF}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Ipoteza}: $H_0$: Rădăcină unitară
            \begin{itemize}
...
\begin{frame}{Testarea staționarității: ADF și KPSS}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Testul ADF}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Ipoteză}: $H_0$: Rădăcină unitară
...
\begin{frame}{Concluzii principale}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item \textbf{Teste rădăcină unitară}:
        \begin{itemize}
...
\begin{frame}{Întrebarea 2: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: (B)}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item $H_0$: rădăcină unitară; $\tau <$ val. critică $\succ$ staționară
    \end{itemize}
    \end{exampleblock}
    }
