...
\begin{frame}{Tipuri de nestaționaritate}
    ...
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{block}{Trend stochastic (rădăcină unitară)}
                \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{ACF: detectarea nestaționarității}
    ...
    \begin{exampleblock}{}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Sus}: ACF mers aleator scade foarte lent $\succ$ rădăcină unitară
...
\begin{frame}{Definiția ARIMA}
    ...
    \begin{defn}[ARIMA(p,d,q): $\phi(L)(1-L)^d Y_t = c + \theta(L)\varepsilon_t$]
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Sus}: seria ARIMA originală (nestaționară); \textbf{Jos}: după diferențiere --- ACF/PACF dezvăluie $p$, $q$
        \end{itemize}
    \end{defn}
    }
...
%=============================================================================
\section{Teste de rădăcină unitară}
...
\begin{frame}{Testarea pentru rădăcini unitate}
    ...
    \begin{block}{Teste comune de rădăcină unitară}
        \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Testul ADF}
    ...
    \begin{block}{Observație}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Stânga}: serie staționară $\succ$ ADF respinge rădăcina unitară
...
\begin{frame}{Valori critice ADF}
    ...
    \begin{block}{Regula de decizie}
        ...
        \begin{itemize}
            ...
            \item Statistică de test $\geq$ valoare critică $\succ$ Nu respingem (rădăcină unitară)
        \end{itemize}
        }
    \end{block}
    }
...
\begin{frame}{Rezumat}
    ...
    \begin{block}{Ce am învățat în acest capitol}
        \begin{itemize}\setlength{\itemsep}{1pt}
            ...
            \end{itemize}
            \item Modele ARIMA($p,d,q$) și teste de rădăcină unitară
            \begin{itemize}
...
\begin{frame}{Întrebarea 3}
    ...
    \textcolor{MainBlue}{\textbf{(C)}} Nu respingem $H_0$: seria probabil are rădăcină unitară\\[3pt]
...
\begin{frame}{Bibliografie I}
    \begin{cminipage}{0.95\textwidth}
    {\small
    \begin{block}{Teste de rădăcină unitară}
        {\small
        \begin{itemize}
