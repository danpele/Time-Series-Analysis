        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Fundamente}
                \begin{itemize}\setlength{\itemsep}{3pt}
                    ...
                    \item Modele ARIMA(p,d,q)
                    \item Teste de rădăcină unitate
                    \item Identificarea modelului ARIMA
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{exampleblock}{Aplicații}
                \begin{itemize}\setlength{\itemsep}{3pt}
                    \item Estimarea ARIMA
                    \item Diagnosticul modelului
                    \item Prognoza cu ARIMA
...
\begin{frame}{Ce vom învăța astăzi}
    \begin{block}{Concepte Fundamentale}
        \begin{enumerate}
            ...
            \item \textbf{Metodologia Box-Jenkins}: Identificare $\succ$ Estimare $\succ$ Validare
        \end{enumerate}
    \end{block}
    ...
    \begin{exampleblock}{La sfârșitul acestui curs}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Veți fi capabili să modelați și să prognozați serii de timp nestaționare precum prețurile acțiunilor, PIB și cursurile de schimb folosind modele ARIMA
        \end{itemize}
    \end{exampleblock}
\end{frame}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Trend stochastic (Rădăcină Unitate)}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item \textbf{Tip}: proces de mers aleatoriu
                    \begin{itemize}
...
\begin{frame}{Exemplu: diferențierea unui mers aleatoriu}
    ...
    \begin{exampleblock}{Mers aleatoriu la Zgomot Alb}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Fie $Y_t = Y_{t-1} + \varepsilon_t$ (mers aleatoriu). Luând prima diferență:
...
\begin{frame}{ACF: detectarea nestaționarității}
    ...
    {\footnotesize
    \begin{itemize}
        \item \textbf{Sus}: ACF mers aleatoriu scade foarte lent $\succ$ rădăcină unitate
...
\begin{frame}{Diferențierea în practică: exemplul PIB}
    ...
    {\footnotesize
    \begin{itemize}
        \item \textbf{Stânga}: PIB în niveluri $\succ$ trend ascendent clar (nestaționar)
    ...
    \begin{block}{Criterii informaționale}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{AIC}: $-2\ln(L) + 2k$; \quad \textbf{BIC}: $-2\ln(L) + k\ln(n)$\\
                  {\scriptsize ($L$ = maximul funcției de verosimilitate, $k$ = nr.\ parametri, $n$ = dimensiunea eșantionului)}
            \begin{itemize}
                \item Mai mic este mai bun
                \item BIC penalizează complexitatea mai mult
            \end{itemize}
        \end{itemize}
    \end{block}
    }
...
\begin{frame}{Algoritmi Auto-ARIMA}
    ...
    \begin{alertblock}{Atenție}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Selecția automată este utilă dar nu infailibilă
...
\begin{frame}{Prognoze pe termen lung pentru ARIMA}
    ...
    \begin{block}{Comportament când $h \to \infty$}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Fără drift}: Prognoze punctuale $\succ$ converg la ultimul nivel; IC $\succ$ tot cresc nelimitat
        \end{itemize}
    \end{block}
...
\begin{frame}{Interval de încredere: exemplu numeric}
    ...
    \begin{alertblock}{Notă}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item IC se lărgește pe măsură ce orizontul crește!
        \end{itemize}
    \end{alertblock}
    }
\end{frame}
...
\begin{frame}{Pasul 3: Identificarea modelului prin ACF/PACF}
    \begin{columns}[T]
        ...
        \begin{block}{Analiza seriei diferențiate}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{ACF}: Vârf la lag 1, apoi se anulează
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Sugerează MA(1)
                    \end{itemize}
...
\begin{frame}{Pasul 5: diagnosticul modelului}
    ...
    \begin{block}{Analiza reziduurilor}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Test Ljung-Box: $Q(10) = 5.8$, p-value $= 0.83$ $\succ$ Fără autocorelare
            \item Test Jarque-Bera: $JB = 156.4$, p-value $< 0.001$ $\succ$ Non-normal (outlier COVID)
...
\begin{frame}{Pasul 6: Prognoza cu intervale de încredere}
    ...
    \begin{alertblock}{Interval de Încredere 95\%}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item În niveluri: Prognoză PIB = \$21,652 mld, IC = [\$21,142 mld, \$22,175 mld]
        \end{itemize}
    \end{alertblock}
    }
\end{frame}
...
\begin{frame}{ACF/PACF: niveluri vs diferențiat}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.6\textheight, keepaspectratio]{ch3_acf_pacf.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{Observații}
...
\begin{frame}{Prognoza ARIMA: real vs prezis}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.6\textheight, keepaspectratio]{ch3_arima_forecast.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{Observații}
...
\begin{frame}{Diagnosticul modelului}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.6\textheight, keepaspectratio]{ch3_diagnostics.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{Observații}
...
\begin{frame}{Concluzii cheie}
    ...
    \begin{block}{Puncte Principale}
        \begin{enumerate}\setlength{\itemsep}{0pt}
            \item \textbf{Nestaționaritatea} este frecventă în datele economice $\succ$ trebuie abordată
    ...
    \begin{alertblock}{Pașii Următori}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Capitolul 4 va extinde ARIMA pentru a gestiona sezonalitatea: modele SARIMA
        \end{itemize}
    \end{alertblock}
    }
\end{frame}
...
\begin{frame}{Întrebarea 1}
    \begin{alertblock}{Întrebare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item O serie de timp $Y_t$ urmează un mers aleatoriu: $Y_t = Y_{t-1} + \varepsilon_t$. Care este $\Var(Y_t)$?
        \end{itemize}
    \end{alertblock}
...
\begin{frame}{Întrebarea 3: Răspuns}
    \begin{columns}[T]
        ...
        \begin{exampleblock}{Răspuns Corect: (C) Nu respingem $H_0$}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Statistică de test $-2.1 > -2.57$ (VC 10\%) $\succ$ Nu putem respinge la niciun nivel
