...
\begin{frame}{Soluția: diferențierea}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.58\textheight, keepaspectratio]{ch3_motivation_differencing.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Mers aleatoriu cu drift: ilustrație vizuală}
    ...
    \begin{exampleblock}{Comparație}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Ambele sunt nestaționare --- drift-ul adaugă trend determinist la rătăcirea stocastică
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Proces integrat: ilustrație vizuală}
    ...
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch3_def_integrated.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Prima diferență: ilustrație vizuală}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.58\textheight, keepaspectratio]{ch3_def_difference.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Testul ADF: ilustrație vizuală}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.58\textheight, keepaspectratio]{ch3_def_adf.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{Observație}
