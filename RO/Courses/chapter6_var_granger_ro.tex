...
\begin{frame}{Test cauzalitate Granger: exemplu numeric}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Calculul testului}
            ...
            \vspace{-0.2cm}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $F_{0.05}(2, 95) = 3.09$ $\succ$ \textbf{Respingem $H_0$}: Banii cauzează Granger producția!
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Testarea în VAR}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $\sigma_{12} = 0$ $\succ$ fără cauzalitate instantanee
            \end{itemize}
        \end{block}
...
\begin{frame}{Pasul 1: Analiză preliminară}
    ...
    \begin{block}{Rezultate}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item PIB: ACF scade rapid $\succ$ staționar; Șomaj: ACF persistent (ADF --- Augmented Dickey-Fuller: $p = 0.02$)
