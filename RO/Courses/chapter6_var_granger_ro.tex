...
\begin{frame}{Ideea cheie: variabilele interacționează}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.55\textheight, keepaspectratio]{ch5_motivation_scatter.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{Exemple de interacțiuni}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Legea lui Okun}: Creștere PIB mai mare $\succ$ șomaj mai mic
            \item \textbf{Regula Taylor}: Inflație mai mare $\succ$ rate ale dobânzii mai mari
            \item \textbf{Curba Phillips}: Compromis șomaj-inflație
        \end{itemize}
    \end{block}
    }
    \quantlet{TSA\_ch5\_motivation\_scatter}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_motivation_scatter}
\end{frame}

\begin{frame}{Relații de avans-întârziere}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.55\textheight, keepaspectratio]{ch5_motivation_leadlag.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    \quantlet{TSA\_ch5\_motivation\_leadlag}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_motivation_leadlag}
\end{frame}
...
\begin{frame}{De ce modelele univariate nu sunt suficiente}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_motivation\_univariate}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_motivation_univariate}
\end{frame}
...
\begin{frame}{Proces VAR simulat}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_var\_simulation}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_var_simulation}
\end{frame}
...
\begin{frame}{Condiția de stabilitate: interpretare vizuală}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_stability\_roots}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_stability_roots}
\end{frame}
...
\begin{frame}{Selecția lag-ului: exemplu}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_lag\_selection}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_lag_selection}
\end{frame}
...
\begin{frame}{Tipuri de cauzalitate Granger}
    ...
    \begin{tikzpicture}[
        ...
        \draw[arrow] (x1) -- (y1);
        \node[below=0.05cm of x1, xshift=1.75cm, font=\footnotesize] {Unidirecțională: $X \succ Y$};

        % Unidirectional Y -> X
        \node[box] (x2) at (0, 0) {$X$};
        \node[box] (y2) at (3.5, 0) {$Y$};
        \draw[arrow] (y2) -- (x2);
        \node[below=0.05cm of x2, xshift=1.75cm, font=\footnotesize] {Unidirecțională: $Y \succ X$};
        ...
        \node[below=0.05cm of x3, xshift=1.75cm, font=\footnotesize] {Bidirecțională: $X \succ Y$};
...
\begin{frame}{Corelație încrucișată: ilustrare vizuală}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.60\textheight, keepaspectratio]{ch5_def_ccf.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{Interpretare}
    ...
    \quantlet{TSA\_ch5\_def\_ccf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_def_ccf}
\end{frame}
...
\begin{frame}{Test cauzalitate Granger: exemplu numeric}
    ...
    \begin{block}{Calculul testului}
        ...
        \vspace{-0.3cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $F_{0.05}(2, 95) = 3.09$ $\succ$ \textbf{Respingem $H_0$}
                \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Cauzalitate instantanee}
    ...
    \begin{block}{Testarea în VAR}
        ...
        \vspace{-0.45cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $\sigma_{12} = 0$ $\succ$ nu există cauzalitate instantanee
        \end{itemize}
    \end{block}
...
\begin{frame}{Funcții de răspuns la impuls: exemplu}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_irf}
\end{frame}
...
\begin{frame}{Exemplu IRF structural}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_structural\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_structural_irf}
\end{frame}
...
\begin{frame}{FEVD: Exemplu}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_fevd}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_fevd}
\end{frame}
...
\begin{frame}{Descompunerea istorică: Exemplu}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_historical\_decomp}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_historical_decomp}
\end{frame}
...
\begin{frame}{Grafic rezumat diagnostic}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_diagnostics}
\end{frame}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item MSE crește cu orizontul $h$
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item Prognoze pe termen lung $\succ$ media necondiționată cu incertitudine $= \boldsymbol{\Gamma}(0)$
                \end{itemize}
        \end{itemize}
    \end{exampleblock}
    }
...
\begin{frame}{Prognoze VAR: Exemplu}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_var\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_var_forecast}
\end{frame}
...
\begin{frame}{Evaluare out-of-sample: VAR vs.\ AR}
    \begin{columns}[T]
        ...
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch5\_var\_rolling\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_var_rolling_forecast}
\end{frame}
...
\begin{frame}{PIB și șomaj: Date (simulate)}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_gdp\_unemployment}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_gdp_unemployment}
\end{frame}
...
\begin{frame}{Rezultate VAR estimate}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_var\_results}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_var_results}
\end{frame}
...
\begin{frame}{VAR politică monetară: IRF}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_monetary\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_monetary_irf}
\end{frame}
...
\begin{frame}{Studiu de caz: Relația dintre PIB și Șomaj}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.55\textheight, keepaspectratio]{ch6_case_raw_data.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{block}{Date}
...
\begin{frame}{Pasul 1: Analiză preliminară}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{ch6_case_stationarity.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\small
...
\begin{frame}{Pasul 2: Selecția ordinului VAR}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.58\textheight, keepaspectratio]{ch6_case_lag_selection.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
    \begin{block}{Rezultate}
...
\begin{frame}{Pasul 3: Testul Granger de cauzalitate}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.58\textheight, keepaspectratio]{ch6_case_granger.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
    \begin{block}{Rezultate}
...
\begin{frame}{Pasul 4: Funcții de răspuns la impuls (IRF)}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.58\textheight, keepaspectratio]{ch6_case_irf.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
...
\begin{frame}{Pasul 5: Descompunerea varianței (FEVD)}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.58\textheight, keepaspectratio]{ch6_case_fevd.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
...
\begin{frame}{Pasul 6: Diagnosticarea reziduurilor}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.58\textheight, keepaspectratio]{ch6_case_diagnostics.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
...
\begin{frame}{Pasul 7: Prognoza VAR}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.58\textheight, keepaspectratio]{ch6_case_forecast.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\small
...
\begin{frame}{Întrebarea 1: Răspuns}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_quiz1\_var\_stability}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_quiz1_var_stability}
\end{frame}
...
\begin{frame}{Întrebarea 2: Răspuns}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_quiz2\_granger\_causality}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_quiz2_granger_causality}
\end{frame}
...
\begin{frame}{Întrebarea 3: Răspuns}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_quiz3\_cholesky\_ordering}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_quiz3_cholesky_ordering}
\end{frame}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \begin{columns}[T]
        ...
        \end{center}
    \end{columns}
    \quantlet{TSA\_ch5\_quiz5\_fevd}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_quiz5_fevd}
\end{frame}
