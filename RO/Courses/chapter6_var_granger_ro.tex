...
\begin{frame}{Ideea cheie: variabilele interacționează}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.60\textheight, keepaspectratio]{ch5_motivation_scatter.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
    ...
    \quantlet{TSA\_charts/ch5\_motivation\_scatter}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_motivation_scatter}
\end{frame}

\begin{frame}{Relații de avans-întârziere}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.62\textheight, keepaspectratio]{ch5_motivation_leadlag.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
        \item Unele variabile \textbf{preced} altele: creșterea PIB prezice scăderea șomajului
            \begin{itemize}
                ...
                \item Corelație maximă la lag-ul 4: PIB-ul precede șomajul cu $\sim$4 trimestre (\textit{Legea lui Okun})
            \end{itemize}
    \end{itemize}
    }
    \quantlet{TSA\_charts/ch5\_motivation\_leadlag}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_motivation_leadlag}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{alertblock}{Problema}
            ...
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item ARIMA tratează fiecare variabilă \textbf{izolat}
                \item Ignoră \textbf{interacțiunile} între variabile
                \item Nu captează \textbf{efectele de feedback}
            \end{itemize}
            }
        \end{alertblock}
        \vspace{0.1cm}
        {\footnotesize
        \textbf{Exemple:} PIB--Șomaj, Dobândă--Inflație, Acțiuni--Volum, Curs--Balanță comercială
        }
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_motivation_univariate.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_motivation\_univariate}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_motivation_univariate}
\end{frame}
...
\begin{frame}{Staționaritate multivariată}
    ...
    \begin{block}{Matricea de autocovarianță}
        ...
        \vspace{-0.2cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $\boldsymbol{\Gamma}(-h) = \boldsymbol{\Gamma}(h)'$ (transpusa, nu egală!)
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Matricea funcției de corelație}
    ...
    \begin{exampleblock}{Pentru cazul bivariat}
        ...
        \vspace{-0.3cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $\rho_{ij}(h) = \frac{\gamma_{ij}(h)}{\sigma_i \sigma_j}$
            \item Interpretare
                \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{VAR(2): dinamică de ordin superior}
    ...
    \begin{block}{Specificația VAR(2)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Pentru $K=2$, $p=2$: fiecare ecuație are $1 + pK = 5$ parametri, total $K(1 + pK) = 10$ coeficienți (cu $\Sigma$: $+3$)
        \end{itemize}
    \end{block}
    ...
    \begin{alertblock}{Blestemul dimensionalității}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item VAR($p$) cu $K$ variabile are $K + pK^2$ parametri
            \item Cu $K=5$, $p=4$: $5 + 4 \times 25 = 105$ parametri!
        \end{itemize}
    \end{alertblock}
    }
\end{frame}
...
\begin{frame}{Forma companion}
    ...
    \begin{block}{Conversia VAR(p) la VAR(1)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Orice VAR($p$) poate fi scris ca VAR(1) în \textbf{forma companion}:
                \vspace{-0.15cm}
    ...
    \begin{exampleblock}{Pentru VAR(2)}
        ...
        \vspace{-0.2cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Matricea companion $\mathbf{A}$ este $Kp \times Kp$
        \end{itemize}
    \end{exampleblock}
    ...
    \begin{block}{De ce este utilă?}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Staționaritatea, prognoză și IRF sunt mai ușor de analizat în forma companion.
        \end{itemize}
    \end{block}
    }
\end{frame}
...
\begin{frame}{Proces VAR simulat}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Proces VAR(1) bivariat simulat
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Interdependența dintre serii
                    \end{itemize}
                \item Fiecare variabilă răspunde la:
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Propriul trecut
                        \item Trecutul celeilalte variabile
                    \end{itemize}
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_var_simulation.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_var\_simulation}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_var_simulation}
\end{frame}
    ...
    \begin{alertblock}{Pentru VAR(1)}
        \begin{itemize}\setlength{\itemsep}{2pt}
            ...
            \item Exemplu: Pentru $\bA_1 = \begin{pmatrix} 0.5 & 0.1 \\ 0.2 & 0.3 \end{pmatrix}$, valorile proprii sunt $\lambda_1 \approx 0.54$ și $\lambda_2 \approx 0.26$
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Ambele $< 1$ $\Rightarrow$ stabil!
                \end{itemize}
        \end{itemize}
    \end{alertblock}
\end{frame}
...
\begin{frame}{Calculul valorilor proprii: exemplu}
    ...
    \begin{exampleblock}{Soluție}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Folosind formula de gradul 2:
...
\begin{frame}{Condiția de stabilitate: interpretare vizuală}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Valorile proprii ale matricei companion
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Trebuie să fie în interiorul cercului unitate
                        \item Cele complexe vin în perechi conjugate
                    \end{itemize}
                \item VAR exploziv (nestaționar)
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Dacă vreo valoare proprie este în afara cercului
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_stability_roots.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_stability\_roots}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_stability_roots}
\end{frame}
...
\begin{frame}{Structura covarianței pentru VAR(1)}
    ...
    \begin{alertblock}{Rezolvarea ecuației Lyapunov}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Se poate rezolva prin vectorizare:
                \vspace{-0.15cm}
...
\begin{frame}{Selecția lag-ului: exemplu}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            {\small
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Date reale SUA (FRED)
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item PIB și Șomaj, $T = 140$ trimestre
                    \end{itemize}
                \item Criterii informaționale
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item AIC și BIC pentru lag $p = 1, \ldots, 10$
                        \item Pot sugera ordine diferite
                    \end{itemize}
                \item Interpretare
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Valori mici = ajustare mai bună
                        \item Ambele selectează $p = 2$
                    \end{itemize}
            \end{itemize}
            }
        \end{block}
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_lag_selection.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_lag\_selection}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_lag_selection}
\end{frame}
...
\begin{frame}{Tipuri de cauzalitate Granger}
    ...
    \begin{tikzpicture}[
        ...
        % Unidirectional X -> Y
        \node[box] (x1) at (0, 2) {$X$};
        \node[box] (y1) at (3.5, 2) {$Y$};
        \draw[arrow] (x1) -- (y1);
        \node[below=0.05cm of x1, xshift=1.75cm, font=\footnotesize] {Unidirecțională: $X \rightarrow Y$};

        % Unidirectional Y -> X
        \node[box] (x2) at (0, 0) {$X$};
        \node[box] (y2) at (3.5, 0) {$Y$};
        \draw[arrow] (y2) -- (x2);
        \node[below=0.05cm of x2, xshift=1.75cm, font=\footnotesize] {Unidirecțională: $Y \rightarrow X$};

        % Bidirectional
        \node[box] (x3) at (7.5, 2) {$X$};
        \node[box] (y3) at (11, 2) {$Y$};
        \draw[arrow] (x3.east) -- (y3.west);
        \draw[arrow] (y3.west) ++(0, -0.3) -- (x3.east |- {0, 1.7});
        \node[below=0.05cm of x3, xshift=1.75cm, font=\footnotesize] {Bidirecțională: $X \leftrightarrow Y$};

        % No causality
        \node[box] (x4) at (7.5, 0) {$X$};
        \node[box] (y4) at (11, 0) {$Y$};
        \node[below=0.05cm of x4, xshift=1.75cm, font=\footnotesize] {Fără cauzalitate};
    \end{tikzpicture}
    \end{center}
...
\begin{frame}{Corelație încrucișată: ilustrare vizuală}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{ch5_def_ccf.pdf}
    \end{center}
    \vspace{-0.2cm}
    \small Stânga: două serii înrudite. Dreapta: CCF relevă că $X$ precede $Y$ (corelații semnificative la lag-uri pozitive).

    \quantlet{TSA\_charts/ch5\_def\_ccf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_def_ccf}
\end{frame}
...
\begin{frame}{Test cauzalitate Granger: exemplu numeric}
    ...
    \begin{block}{Calculul testului}
        ...
        \vspace{-0.3cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $F_{0.05}(2, 95) = 3.09$ $\Rightarrow$ \textbf{Respingem $H_0$}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Banii cauzează Granger producția!
                \end{itemize}
        \end{itemize}
    \end{block}
    }
...
\begin{frame}{Cauzalitate instantanee}
    ...
    \begin{block}{Testarea în VAR}
        ...
        \vspace{-0.45cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $\sigma_{12} = 0$ $\Rightarrow$ nu există cauzalitate instantanee
        \end{itemize}
    \end{block}
    ...
    \begin{alertblock}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{1pt}
            \item Cauze posibile
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item \textbf{Șocuri comune} sau \textbf{agregarea datelor}
...
\begin{frame}{Cauzalitate Granger în sisteme multiple}
    ...
    \begin{exampleblock}{Statistica testului}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item $K_1$ = variabile ``cauzate'', $K_2$ = variabile ``cauzatoare''
        \end{itemize}
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Ce sunt funcțiile de răspuns la impuls?}
    ...
    \begin{block}{Reprezentarea MA($\infty$)}
        \begin{itemize}\setlength{\itemsep}{1pt}
            \item Un VAR(p) stabil poate fi scris ca:
        \end{itemize}
        \vspace{-0.2cm}
    ...
    \begin{exampleblock}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{1pt}
            \item $[\boldsymbol{\Phi}_h]_{ij}$: Efectul asupra lui $Y_i$ la $t+h$
                ...
                \end{itemize}
            \item VAR stabil: $\boldsymbol{\Phi}_h \rightarrow \mathbf{0}$ când $h \rightarrow \infty$
                \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Funcții de răspuns la impuls: exemplu}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Funcțiile de răspuns la impuls
                    \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item VAR stabil
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Răspunsurile converg la zero
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_irf.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_irf}
\end{frame}
...
\begin{frame}{VAR structural (SVAR)}
    \begin{block}{Motivație}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Șocurile VAR standard $\bepsilon_t$ sunt inovații de \textbf{formă redusă}---combinații liniare de șocuri structurale
...
\begin{frame}{Exemplu IRF structural}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item IRF structurale (Cholesky)
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Ordinea variabilelor afectează interpretarea
                    \end{itemize}
                \item Restricții contemporane
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Prima variabilă: doar propriile șocuri
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_structural_irf.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_structural\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_structural_irf}
\end{frame}
...
\begin{frame}{FEVD: Exemplu}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Proporția varianței prognozei
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Atribuibilă fiecărui șoc structural
                    \end{itemize}
                \item Dinamica temporală
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Orizonturi scurte: șocuri proprii domină
                        \item Efectele încrucișate cresc în timp
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_fevd.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_fevd}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_fevd}
\end{frame}
...
\begin{frame}{Descompunerea istorică: Exemplu}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Contribuții structurale
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Fiecare culoare = un șoc diferit
                        \item Stivuite: însumează abaterea de la medie
                    \end{itemize}
                \item Utilitate
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Identifică șocurile din episoadele istorice
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_historical_decomp.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_historical\_decomp}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_historical_decomp}
\end{frame}
...
\begin{frame}{Testarea corelației seriale}
    ...
    \begin{block}{Testul Portmanteau (Ljung-Box)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Sub $H_0$ (fără autocorelație): $Q_h \sim \chi^2_{K^2(h-p)}$
        \end{itemize}
    \end{block}
    ...
    \begin{alertblock}{Dacă este respins}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Luați în considerare creșterea ordinului lag-ului $p$ sau adăugarea de variabile suplimentare
        \end{itemize}
    \end{alertblock}
    }
\end{frame}
...
\begin{frame}{Grafic rezumat diagnostic}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item ACF reziduurilor
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Fără autocorelație semnificativă
                    \end{itemize}
                \item Distribuția reziduurilor
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Histograma $\approx$ normală
                        \item Q-Q: linia de 45°
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_diagnostics.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_diagnostics}
\end{frame}
...
\begin{frame}{Prognoze VAR: Exemplu}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Prognoze punctuale
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Linie continuă dincolo de date
                        \item Converg la media necondiționată
                    \end{itemize}
                \item Intervale de încredere
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Se lărgesc cu orizontul de prognoză
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_var_forecast.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_var\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_var_forecast}
\end{frame}
...
\begin{frame}{Evaluarea prognozei}
    ...
    \begin{block}{Evaluare out-of-sample}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Calculăm erorile de prognoză: $e_{t+h} = Y_{t+h} - \hat{Y}_{t+h|t}$
        \end{itemize}
    \end{block}
    \vspace{-0.1cm}
    ...
    \begin{exampleblock}{Testul Diebold-Mariano}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item $DM = \frac{\bar{d}}{\sqrt{\hat{\sigma}_d^2/n}} \sim N(0,1)$ unde $d_t = L(e_{1t}) - L(e_{2t})$ este diferențiala de pierdere
        \end{itemize}
    \end{exampleblock}
    }
\end{frame}
...
\begin{frame}{Evaluare out-of-sample: VAR vs.\ AR}
    \begin{columns}[T]
        ...
        \begin{block}{Metodologie generală}
            ...
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Train / Test Split
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Împărțim datele: antrenare + test
                        \item Estimăm pe train, evaluăm pe test
                    \end{itemize}
                \item De ce VAR vs.\ AR?
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item AR: ignoră celelalte variabile
                        \item VAR: exploatează interdependențele
                    \end{itemize}
        ...
        \includegraphics[width=\textwidth]{ch5_var_rolling_forecast.pdf}
        \end{column}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_var\_rolling\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_var_rolling_forecast}
\end{frame}
...
\begin{frame}{PIB și șomaj: Date (simulate)}
    \begin{columns}[T]
        \column{0.35\textwidth}
        \vspace{1cm}
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Date simulate VAR(2)
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Legea lui Okun
                        \item Tipare ciclice comune
                    \end{itemize}
                \item Sistem bivariat ideal
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Analiză VAR + cauzalitate Granger
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_gdp_unemployment.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_gdp\_unemployment}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_gdp_unemployment}
\end{frame}
...
\begin{frame}{Rezultate VAR estimate}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Coeficienți estimați
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Erori standard și statistici $t$
                    \end{itemize}
                \item Selecția modelului
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Criterii informaționale (AIC, BIC)
                        \item Diagnostic reziduuri
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_var_results.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_var\_results}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_var_results}
\end{frame}

\begin{frame}{Rezultate cauzalitate Granger}
    {\small
    \begin{block}{Rezultatele testului: PIB și șomaj (date simulate)}
        \begin{center}
        \begin{tabular}{lcccc}
            \toprule
    ...
    \begin{exampleblock}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Șomajul nu cauzează semnificativ Granger PIB (în acest eșantion simulat)
...
\begin{frame}{VAR politică monetară: IRF}
    \begin{columns}[T]
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Șoc monetar contracționist
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Creșterea ratei dobânzii
                    \end{itemize}
                \item Răspunsul variabilelor
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Producția: efect maxim la 4--6 trim.
                        \item Inflația: răspuns mai lent
                    \end{itemize}
            \end{itemize}
        \end{block}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_monetary_irf.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_monetary\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_monetary_irf}
\end{frame}
...
\begin{frame}{Studiu de caz: Relația dintre PIB și Șomaj}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch6_case_raw_data.pdf}
    \end{center}
    \vspace{-0.1cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Date reale SUA (FRED, 1990--2024): Creștere PIB și Rata Șomajului ($T = 140$ trimestre)
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Corelație negativă vizibilă între serii (Legea lui Okun)
                \item Dinamică bidirecțională: șocuri care se propagă între variabile
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_raw\_data}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_raw_data}
\end{frame}

\begin{frame}{Pasul 1: Analiză preliminară}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.60\textheight, keepaspectratio]{ch6_case_stationarity.pdf}
    \end{center}
    \vspace{-0.15cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item PIB: ACF scade rapid $\Rightarrow$ staționar; Șomaj: ACF persistent (ADF: $p = 0.02$)
        \item Relația dintre serii:
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Corelație negativă PIB--Șomaj ($\rho = -0.17$, Legea lui Okun)
                \item Cross-corelație sugerează relații dinamice bidirecționale
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_stationarity}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_stationarity}
\end{frame}

\begin{frame}{Pasul 2: Selecția ordinului VAR}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch6_case_lag_selection.pdf}
    \end{center}
    \vspace{-0.1cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Criteriile AIC și BIC sugerează VAR(2)
            ...
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_lag\_selection}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_lag_selection}
\end{frame}

\begin{frame}{Pasul 3: Testul Granger de cauzalitate}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch6_case_granger.pdf}
    \end{center}
    \vspace{-0.1cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item PIB $\rightarrow$ Șomaj: $F = 17.35$, $p < 0.001$ --- PIB ``cauzează Granger'' Șomajul
        \item Șomaj $\rightarrow$ PIB: $F = 38.93$, $p < 0.001$ --- cauzalitate bidirecțională
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Confirmare empirică a Legii lui Okun pe date reale SUA
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_granger}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_granger}
\end{frame}

\begin{frame}{Pasul 4: Funcții de răspuns la impuls (IRF)}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch6_case_irf.pdf}
    \end{center}
    \vspace{-0.1cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item Șoc Șomaj $\rightarrow$ efect pozitiv de scurtă durată asupra PIB (recuperare, 2--3 trim.)
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Asimetrie: efectele PIB asupra șomajului persistă mult mai mult decât inversul
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_irf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_irf}
\end{frame}

\begin{frame}{Pasul 5: Descompunerea varianței (FEVD)}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch6_case_fevd.pdf}
    \end{center}
    \vspace{-0.1cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \item Șomaj: dominat de șocurile PIB ($\sim$65\% la $h=1$, crescând la $\sim$92\% la $h=20$)
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Asimetrie: PIB $\to$ Șomaj mult mai puternică decât Șomaj $\to$ PIB
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_fevd}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_fevd}
\end{frame}

\begin{frame}{Pasul 6: Diagnosticarea reziduurilor}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch6_case_diagnostics.pdf}
    \end{center}
    \vspace{-0.1cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Reziduurile nu prezintă autocorelație semnificativă (ACF în limite)
        \item Non-normalitate semnificativă (JB respins) --- datorită valorilor extreme COVID-19
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Dinamica seriilor este captată; inferența necesită erori standard robuste
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_diagnostics}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_diagnostics}
\end{frame}

\begin{frame}{Pasul 7: Prognoza VAR}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.65\textheight, keepaspectratio]{ch6_case_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Prognoză pe 12 trimestre pentru ambele variabile simultan
            ...
            \end{itemize}
    \end{itemize}
    }\quantlet{TSA\_ch6\_case\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_forecast}
\end{frame}
...
\begin{frame}{Pasul 8: Rolling forecast --- VAR vs AR}
    \begin{columns}[T]
        ...
        \begin{block}{Procedura}
            {\footnotesize
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Train/Test recursiv
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item $W = 80$, re-estimare la fiecare pas
                    \end{itemize}
                \item Modele: AR(2) vs VAR(2)
                \item RMSE expanding:
                    \vspace{-0.1cm}
                    $$\text{RMSE}_t = \sqrt{\frac{1}{t}\sum_{s=1}^{t} e_s^2}$$
                    \vspace{-0.3cm}
                \item Rezultate mixte:
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Șomaj: VAR $-$10\% RMSE
                        \item PIB: VAR $+$6\% RMSE
                    \end{itemize}
            \end{itemize}
            }
        ...
        \end{column}
        \begin{column}{0.63\textwidth}
        \includegraphics[width=\textwidth]{ch6_case_rolling_forecast.pdf}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch6\_case\_rolling\_forecast}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_rolling_forecast}
\end{frame}
...
\begin{frame}{Pasul 9: Comparație out-of-sample --- AR vs VAR}
    \begin{columns}[T]
        ...
        \begin{block}{Metodologie}
            {\footnotesize
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item Prognoză recursivă
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item Estimare pe $[1, \ldots, t]$
                        \item Prognoză: $\hat{y}_{t+1|t}$
                    \end{itemize}
                \item Modele: AR(2) vs VAR(2)
                \item RMSE expanding:
                    \vspace{-0.1cm}
        ...
        \end{column}
        \begin{column}{0.63\textwidth}
        \includegraphics[width=\textwidth]{ch6_case_oos_comparison.pdf}
        \end{column}
    \end{columns}
    \quantlet{TSA\_ch6\_case\_oos\_comparison}{https://github.com/QuantLet/TSA/tree/main/TSA_ch6_case_oos_comparison}
\end{frame}
...
\begin{frame}{Lista de verificare pentru selecția modelului VAR}
    ...
    \begin{block}{Înainte de estimare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item[$\square$] Transformați la staționar dacă este necesar (diferențe, logaritmi)
...
\begin{frame}{Întrebarea 1: Răspuns}
    \begin{columns}[T]
        ...
        \begin{exampleblock}{Răspuns corect: (B) Valori proprii în interiorul cercului unitate}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $\lambda_1 = 0.879$, $\lambda_2 = 0.421$ --- ambele $|\lambda| < 1$ $\Rightarrow$ Stabil!
            \end{itemize}
        \end{exampleblock}
        \column{0.63\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_quiz1_var_stability.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_quiz1\_var\_stability}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_quiz1_var_stability}
\end{frame}

\begin{frame}{Întrebarea 2}
    \begin{alertblock}{Întrebare}
        Dacă $X$ cauzează Granger pe $Y$ la nivelul de semnificație de 5\%, care dintre următoarele afirmații este ADEVĂRATĂ?
    \end{alertblock}
...
\begin{frame}{Întrebarea 2: Răspuns}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_quiz2_granger_causality.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_quiz2\_granger\_causality}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_quiz2_granger_causality}
\end{frame}
...
\begin{frame}{Întrebarea 3: Răspuns}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_quiz3_cholesky_ordering.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_quiz3\_cholesky\_ordering}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_quiz3_cholesky_ordering}
\end{frame}

\begin{frame}{Întrebarea 4}
    \begin{alertblock}{Întrebare}
        Pentru un VAR(1) bivariat, câți parametri trebuie estimați (excluzând matricea de covarianță a erorilor)?
    \end{alertblock}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, height=0.78\textheight, keepaspectratio]{ch5_quiz5_fevd.pdf}
        \end{center}
    \end{columns}
    \quantlet{TSA\_charts/ch5\_quiz5\_fevd}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5_quiz5_fevd}
\end{frame}
...
\begin{frame}{Bibliografie II}
    ...
    \begin{exampleblock}{Resurse online și cod}
        {\small
        \begin{itemize}
            \item \textbf{Quantlet}: \url{https://quantlet.com} --- Repozitoriu de cod pentru statistică
