...
\begin{frame}{Exemplu motivant: Dinamica macroeconomică}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.55\textheight, keepaspectratio]{ch5_motivation_econ.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    \quantlet{TSA\_ch5\_motivation\_econ}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_motivation_econ}
\end{frame}
...
\begin{frame}{De ce modelele univariate nu sunt suficiente}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_motivation_univariate.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{alertblock}{Problema}
        {\small
        \begin{itemize}\setlength{\itemsep}{1pt}
            \item ARIMA tratează fiecare variabilă \textbf{izolat}; ignoră \textbf{interacțiunile} și \textbf{efectele de feedback}
        \end{itemize}
        }
    \end{alertblock}
    {\footnotesize
...
\begin{frame}{Proces VAR simulat}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_var_simulation.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Condiția de stabilitate: interpretare vizuală}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_stability_roots.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Selecția lag-ului: exemplu}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_lag_selection.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        {\small
...
\begin{frame}{Funcții de răspuns la impuls: exemplu}
    ...
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
            \item Răspunsul fiecărei variabile la un șoc unitar (zonele umbrite = intervale de încredere)
...
\begin{frame}{Exemplu IRF structural}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_structural_irf.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Descompunerea istorică: Exemplu}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_historical_decomp.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Grafic rezumat diagnostic}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_diagnostics.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Prognoze VAR: Exemplu}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_var_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Evaluare out-of-sample: VAR vs.\ AR}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_var_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{PIB și șomaj: Date (simulate)}
    ...
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
            \item Date simulate VAR(2): Legea lui Okun, tipare ciclice comune
...
\begin{frame}{Rezultate VAR estimate}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_var_results.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{VAR politică monetară: IRF}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_monetary_irf.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Pasul 8: Rolling forecast -- VAR vs AR}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch6_case_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Procedura}
        ...
        \begin{itemize}\setlength{\itemsep}{1pt}
            ...
            \item Rezultate mixte: Șomaj --- VAR $-$10\% RMSE; PIB --- VAR $+$6\% RMSE
        \end{itemize}
        }
    \end{block}
...
\begin{frame}{Pasul 9: Comparație out-of-sample -- AR vs VAR}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch6_case_oos_comparison.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Întrebarea 1: Răspuns}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_quiz1_var_stability.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Întrebarea 2: Răspuns}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_quiz2_granger_causality.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Întrebarea 3: Răspuns}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_quiz3_cholesky_ordering.pdf}
    \end{center}
    \vspace{-0.1cm}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{ch5_quiz5_fevd.pdf}
    \end{center}
    \vspace{-0.1cm}
