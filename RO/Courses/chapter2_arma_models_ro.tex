...
\begin{frame}{De ce modele ARMA?}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.60\textheight, keepaspectratio]{ch2_motivation_stationary.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\scriptsize
    \begin{exampleblock}{}
    ...
    \begin{columns}[T]
        ...
        \begin{alertblock}{\textcolor{white}{Nestaționar ($|\phi| \geq 1$)}}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \begin{itemize}
                    \item Rădăcină unitară, varianță $\to \infty$
                \end{itemize}
...
\begin{frame}{Teorema de descompunere a lui Wold}
    ...
    \begin{cminipage}{0.95\textwidth}
    \begin{center}
        \includegraphics[width=0.70\textwidth, height=0.48\textheight, keepaspectratio]{ch2_wold_representation.pdf}
    \end{center}
    \vspace{-0.3cm}
...
\begin{frame}{Metodologia Box-Jenkins}
    ...
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.50\textheight, keepaspectratio]{ch2_box_jenkins.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\scriptsize
...
\begin{frame}{Diagnosticarea reziduurilor}
    ...
    \begin{block}{Dacă modelul este corect specificat, reziduurile trebuie să fie zgomot alb}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Graficul Q-Q}: punctele pe diagonală $\succ$ distribuție normală; cozi groase $\succ$ erori non-normale
        \end{itemize}
    \end{block}
    \vspace{-0.4cm}
    \begin{alertblock}{Decizie}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textcolor{Forest}{$\checkmark$ Toate verificările OK} $\succ$ model adecvat \qquad \textcolor{Crimson}{$\times$ Nesatisfăcut} $\succ$ reveniți la identificare
        \end{itemize}
    \end{alertblock}
    }
    \end{cminipage}
...
\begin{frame}{Ce urmează?}
    ...
    \begin{block}{Capitolul 3: Modele ARIMA pentru date nestaționare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Nestaționaritate}: tipuri, teste de rădăcină unitară (ADF, PP, KPSS)
