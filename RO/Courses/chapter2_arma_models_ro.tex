        ...
        \begin{column}{0.32\textwidth}
            ...
            \begin{block}{Caracteristici cheie}
                \begin{itemize}\setlength{\itemsep}{2pt}
                    \item \textbf{Sus}: Fluctuații aleatorii, fără tipare, varianță constantă
                    \item \textbf{Jos}: ACF doar un vârf la lag 0; celelalte în limitele de semnificație $\succ$ fără dependență liniară
                \end{itemize}
            \end{block}
            }
            \vspace{0.2cm}
...
\begin{frame}{Teorema de descompunere a lui Wold}
    ...
    \vspace{0.1cm}
    \begin{center}
        \includegraphics[width=0.70\textwidth, height=0.30\textheight, keepaspectratio]{ch2_wold_representation.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Întrebarea 4: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch2_def_arma.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch2_lag_operator.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 9: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch2_quiz_ar1_variance.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 10: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch2_quiz_ma1_acf.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 11: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch2_quiz_arma11_acf.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 12: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch2_quiz_ar2_check.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
...
\begin{frame}{Întrebarea 13: Răspuns}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch2_quiz_wold.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{alertblock}{Întrebare}
