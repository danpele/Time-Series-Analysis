...
\begin{frame}{Structura modelului ARMA}
    ...
    \begin{block}{Componente}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{AR}: valorile trecute $\succ$ persistență, memorie
            \item \textbf{MA}: șocuri trecute $\succ$ răspuns la inovații
...
\begin{frame}{AIC vs BIC: selecția modelului}
    ...
    \begin{block}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{Practică}: AIC $\succ$ prognoză, BIC $\succ$ identificare
        \end{itemize}
    \end{block}
...
\begin{frame}{Rezumat}
    ...
    \begin{block}{Ce am învățat în acest capitol}
        \begin{itemize}\setlength{\itemsep}{1pt}
            ...
            \begin{itemize}
                \item Combină AR și MA; identificare $\succ$ estimare $\succ$ validare $\succ$ prognoză
            \end{itemize}
