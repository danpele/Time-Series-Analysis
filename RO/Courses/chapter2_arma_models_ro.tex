...
\begin{frame}{De ce modele ARMA?}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=0.92\textwidth, height=0.58\textheight, keepaspectratio]{ch2_motivation_stationary.pdf}
        \end{center}
        \vspace{-0.3cm}
        {\scriptsize
        \begin{exampleblock}{}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Proprietăți}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Imprevizibil}: Zgomotul alb \textit{nu} poate fi prognozat $\Rightarrow$ este pur aleatoriu
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
            ...
            \begin{columns}[T]
                ...
                \begin{column}{0.48\textwidth}
                    ...
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item \textbf{Notă}: Formula presupune $h \geq 0$; prin simetria ACVF: $\gamma(h) = \gamma(-h)$, deci $\gamma(h) = \frac{\phi^{|h|} \sigma^2}{1-\phi^2}$ pentru orice $h \in \mathbb{Z}$
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Recursie Durbin-Levinson}
            ...
            \begin{enumerate}\setlength{\itemsep}{0pt}
                ...
                \]
                \vspace{-4mm}
                \item \textbf{Actualizare}: $\phi_{k,j} = \phi_{k-1,j} - \pi_k\, \phi_{k-1,k-j}$, $j = 1, \ldots, k-1$; $\phi_{k,k} = \pi_k$
            ...
            \begin{column}{0.48\textwidth}
                \begin{alertblock}{Identificare AR($p$)}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item IC: $|\pi_k| > 1.96/\sqrt{T}$ $\Rightarrow$ semnificativ
...
\begin{frame}{Structura modelului ARMA}
    \begin{cminipage}{0.95\textwidth}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.48\textheight, keepaspectratio]{ch2_arma_structure.pdf}
        \end{center}
        \vspace{-0.3cm}
        {\scriptsize
...
\begin{frame}{Teorema de descompunere a lui Wold}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=0.70\textwidth, height=0.38\textheight, keepaspectratio]{ch2_wold_representation.pdf}
        \end{center}
        \vspace{-0.3cm}
        {\footnotesize
        \begin{block}{Teorema Wold (1938)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \;\; unde $\psi_0 = 1$, $\sum \psi_j^2 < \infty$, $\varepsilon_t \sim WN(0, \sigma^2)$
            ...
            \end{itemize}
            \textit{(Reamintire din Capitolul 1 --- pentru demonstrație, vezi secțiunea dedicată)}
        \end{block}
        }
        \quantlet{TSA\_ch2\_arma}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_arma}
    \end{cminipage}
...
\begin{frame}{Metodologia Box-Jenkins}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-2mm}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.46\textheight, keepaspectratio]{ch2_box_jenkins.pdf}
        \end{center}
        \vspace{-0.3cm}
        {\scriptsize
...
\begin{frame}{Reguli de identificare ACF/PACF}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.24\textheight, keepaspectratio]{ch2_model_identification.pdf}
        \end{center}
        \quantlet{TSA\_ch2\_acf\_pacf\_patterns}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_acf_pacf_patterns}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Principiul parcimoniei: echilibrul bias-varianță}
    \begin{cminipage}{0.95\textwidth}
        \vspace{-2mm}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.47\textheight, keepaspectratio]{ch2_parsimony.pdf}
        \end{center}
        \vspace{-0.3cm}
        {\scriptsize
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Pas 2: Rezolvare (regula lui Cramer)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item $\hat{\phi}_1 = \frac{0.75 - 0.75 \times 0.65}{0.4375} = \boxed{0.600}$ \qquad
                $\hat{\phi}_2 = \frac{0.65 - 0.75^2}{0.4375} = \boxed{0.200}$
            \end{itemize}
        \end{block}
        \vspace{-0.4cm}
        ...
        \begin{columns}[T]
            ...
            \begin{column}{0.48\textwidth}
                \begin{exampleblock}{Metrici de eroare}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        \item \textbf{MAE}: Robust la valori extreme
                        \item \textbf{RMSE}: Penalizează erorile mari
                        \item \textbf{MAPE}: Procentual, interpretabil
                    \end{itemize}
                    \textit{(vezi Capitolul 0 pentru definițiile complete ale metricilor)}
                \end{exampleblock}
            \end{column}
        \end{columns}
    \end{cminipage}
...
\begin{frame}{Întrebarea 1: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_ar_stationarity.pdf}
        \end{center}
...
\begin{frame}{Întrebarea 2: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_acf_pacf_patterns.pdf}
        \end{center}
...
\begin{frame}{Întrebarea 3: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_def_invertibility.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_ma1}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_ma1}
\end{frame}
...
\begin{frame}{Întrebarea 4: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_def_arma.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_arma}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_arma}
\end{frame}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_lag_operator.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_lag\_operator}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_lag_operator}
\end{frame}
...
\begin{frame}{Întrebarea 6: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_information_criteria.pdf}
        \end{center}
...
\begin{frame}{Întrebarea 7: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_ljung_box.pdf}
        \end{center}
...
\begin{frame}{Întrebarea 8: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_forecast_properties.pdf}
        \end{center}
...
\begin{frame}{Întrebarea 9: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_ar1_variance.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_ar1}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_ar1}
\end{frame}
...
\begin{frame}{Întrebarea 10: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_ma1_acf.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_ma1}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_ma1}
\end{frame}
...
\begin{frame}{Întrebarea 11: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_arma11_acf.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_arma}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_arma}
\end{frame}
...
\begin{frame}{Întrebarea 12: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.48\textheight, keepaspectratio]{ch2_quiz_ar2_check.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_ar2}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_ar2}
\end{frame}
...
\begin{frame}{Întrebarea 13: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.1cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.52\textheight, keepaspectratio]{ch2_quiz_wold.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_arma}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_arma}
\end{frame}
...
\begin{frame}{Întrebarea 14: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.98\textwidth, height=0.50\textheight, keepaspectratio]{ch2_quiz_ci_growth.pdf}
        \end{center}
    \end{cminipage}
    \quantlet{TSA\_ch2\_forecasting}{https://github.com/QuantLet/TSA/tree/main/TSA_ch2/TSA_ch2_forecasting}
\end{frame}
