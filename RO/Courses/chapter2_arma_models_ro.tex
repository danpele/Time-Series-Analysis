    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Proprietăți}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{Impredictibil}: Zgomotul alb \textit{nu} poate fi prezis $\succ$ este pur aleatoriu
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{PACF}: un singur vârf semnificativ la lag 1, apoi se anulează $\succ$ semnătura tipică AR(1)
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Observații}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item PACF se anulează după lag 2 $\succ$ tiparul distinctiv de identificare
            \end{itemize}
        \end{block}
        }
    \end{cminipage}
...
\begin{frame}{ACF și PACF MA(1): comparație vizuală}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{ACF}: Un singur vârf la lag 1, apoi se anulează $\succ$ semnătura tipică MA(1)
...
\begin{frame}{MA(q): ilustrație vizuală}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Observație}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Proces MA(3): semnătura distinctivă $\succ$ ACF se anulează după lag $q$ ($\rho(h) = 0$ pentru $h > 3$)
            \end{itemize}
        \end{block}
        }
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare ARMA(1,1)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Nici ACF nici PACF nu se întrerup $\succ$ indicator distinctiv pentru modele mixte
            \end{itemize}
        \end{block}
        }
