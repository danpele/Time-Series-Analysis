...
\begin{frame}{Experiment: ChatGPT vs Fundamentele}
    ...
    \begin{block}{\footnotesize Prompt $\to$ Răspuns}
        {\footnotesize
        \textbf{Tu}: ``Am date cu pasageri de aviație pe luni, din 1949 până în 1960. Analizează-le și fă o prognoză.''\\[2pt]
    ...
    \begin{enumerate}\setlength{\itemsep}{2pt}
        \item Identificați cel puțin trei erori metodologice în analiza de mai sus.
        \item Explicați de ce valoarea MAPE $= 4{,}2\%$ raportată este înșelătoare.
        \item Rescrieți codul corect și comparați rezultatele cu un benchmark sezonier naiv.
    \end{enumerate}
    }
    \vspace{-1mm}
    \begin{alertblock}{}
