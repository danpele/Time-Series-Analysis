...
\begin{frame}{De ce studiem seriile de timp?}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Obiectiv principal: prognoza}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Folosim tiparele istorice pentru a prezice valori viitoare
...
\begin{frame}{Serie de timp: ilustrație conceptuală}
    \begin{cminipage}{0.95\textwidth}
        \vspace{0.3cm}
        \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.50\textheight, keepaspectratio]{ch1_def_timeseries.pdf}
        \end{center}
        \vspace{-0.1cm}
...
\begin{frame}{Exemplu practic: date financiare reale}
    \begin{cminipage}{0.95\textwidth}
        \vspace{0.3cm}
        \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{timeseries_definition.pdf}
        \end{center}
        \vspace{-0.1cm}
        \quantlet{TSA\_ch0\_definition}{https://github.com/QuantLet/TSA/tree/main/TSA_ch0/TSA_ch0_definition}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Vârf de călătorii în iulie--august
            \end{itemize}
        \end{block}
        }
            ...
            \begin{column}{0.48\textwidth}
                \begin{alertblock}{De ce nu CV standard?}
                    \begin{itemize}\setlength{\itemsep}{0pt}
                        ...
                        \item \textbf{K-fold standard} $\Rightarrow$ scurgere de date
                    \end{itemize}
                \end{alertblock}
            \end{column}
            \begin{column}{0.48\textwidth}
...
\begin{frame}{Date reale: compararea prognozelor}
    \begin{cminipage}{0.95\textwidth}
        \vspace{0.3cm}
        \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{real_data_forecast_comparison.pdf}
        \end{center}
        \vspace{-0.1cm}
        \quantlet{TSA\_ch0\_forecast\_eval}{https://github.com/QuantLet/TSA/tree/main/TSA_ch0/TSA_ch0_forecast_eval}
        \begin{block}{Interpretare}
...
\begin{frame}{Filtrul HP: limitări}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Critica lui Hamilton (2018)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Hamilton (2018) demonstrează că filtrul HP introduce \textbf{componente ciclice spurioase}
                \item Propune alternativa: regresia $y_{t+h}$ pe $y_t, y_{t-1}, \ldots, y_{t-p}$ (implicit $h=8, p=4$ trimestrial)
                \item Avantaj: nu necesită alegerea lui $\lambda$; nu suferă de problem la capetele seriei
            \end{itemize}
        \end{alertblock}
