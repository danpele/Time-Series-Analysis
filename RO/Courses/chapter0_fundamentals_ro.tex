...
\begin{frame}{Netezirea cu media mobilă}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch1_moving_average.pdf}
    \end{center}
    \vspace{-3mm}
...
\begin{frame}{Netezirea exponențială simplă: efectul lui $\alpha$}
    ...
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{simple_exp_smoothing.pdf}
    \end{center}
    \vspace{-3mm}
...
\begin{frame}{ETS: ilustrație netezire exponențială}
    \begin{cminipage}{0.95\textwidth}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch1_def_ets.pdf}
    \end{center}
    \vspace{-3mm}
    {\footnotesize
    \begin{exampleblock}{Interpretare}
