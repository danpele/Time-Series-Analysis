...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\small
        ``Am date lunare cu numărul de pasageri ai unei companii aeriene din 1949 până în 1960. Scrie cod Python care descompune seria, identifică trendul și sezonalitatea, apoi face o prognoză pe 24 de luni. Evaluează calitatea modelului.''
        }
    \end{block}
    \vspace{-1mm}
    {\small
    ...
    \vspace{-1mm}
    \begin{alertblock}{}
        {\small \textbf{Atenție}: Codul generat de AI poate rula fără erori și arăta profesional. \textit{Asta nu înseamnă că e corect.}}
    \end{alertblock}
\end{frame}
