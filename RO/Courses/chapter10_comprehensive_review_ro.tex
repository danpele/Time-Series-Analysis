...
\begin{frame}{Bitcoin: selectarea modelului pe setul de validare}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{../charts/garch_forecast.pdf}
        \end{center}
...
\begin{frame}{Șomajul: Train / Validation / Test Split}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{../charts/unemployment_train_val_test.pdf}
        \end{center}
...
\begin{frame}{Șomajul: parametrii SARIMA}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{../charts/sarima_parameters.pdf}
        \end{center}
...
\begin{frame}{Testul Ljung-Box pentru Autocorelația Reziduurilor}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{../charts/sarima_diagnostics.pdf}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{frame}{Cauzalitatea Granger: Rezultate Empirice}
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.3cm}
        \begin{center}
            \includegraphics[width=\textwidth, keepaspectratio]{../charts/granger_heatmap.pdf}
        \end{center}
...
\begin{frame}{Întrebarea 1: Răspuns}
    ...
    \vspace{0.1cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.51\textheight, keepaspectratio]{ch10_quiz1_model_selection.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 2: Răspuns}
    ...
    \vspace{0.1cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.51\textheight, keepaspectratio]{ch10_quiz2_overfitting.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 3: Răspuns}
    ...
    \vspace{0.1cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.51\textheight, keepaspectratio]{ch10_quiz3_train_val_test.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 4: Răspuns}
    ...
    \vspace{0.1cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.51\textheight, keepaspectratio]{ch10_quiz4_granger_causality.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 5: Răspuns}
    ...
    \vspace{0.1cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.51\textheight, keepaspectratio]{ch10_quiz5_long_seasonality.pdf}
    \end{center}
