...
\begin{frame}{Bitcoin: volatility clustering}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/btc_returns.pdf}
    \end{center}
...
\begin{frame}{GARCH: prognozele multi-step converg}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/garch_convergence.pdf}
    \end{center}
...
\begin{frame}{Pete solare: ciclul solar de 11 ani}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/sunspots.pdf}
    \end{center}
...
\begin{frame}{Șomajul: Train / Validation / Test Split}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/unemployment_train_val_test.pdf}
    \end{center}
...
\begin{frame}{Șomajul: selecția modelului (set validare)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/sarima_model_selection.pdf}
    \end{center}
...
\begin{frame}{Șomajul: parametrii SARIMA}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/sarima_parameters.pdf}
    \end{center}
...
\begin{frame}{Șomajul: prognoza rolling SARIMA}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/sarima_forecast.pdf}
    \end{center}
...
\begin{frame}{Șomajul: rezultate prognoză Prophet}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/unemployment_forecast.pdf}
    \end{center}
...
\begin{frame}{Funcții de răspuns la impuls (IRF)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/irf_gdp_shock.pdf}
    \end{center}
...
\begin{frame}{IRF: șoc șomaj}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/irf_unemp_shock.pdf}
    \end{center}
...
\begin{frame}{IRF: șoc rată Fed}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/irf_fed_shock.pdf}
    \end{center}
...
\begin{frame}{VAR: Prognoza (Train/Val/Test)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{../charts/var_forecast.pdf}
    \end{center}
...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Am un set nou de date cu vânzări lunare. Fă o analiză completă a seriei de timp: descompunere, teste de staționaritate, selecție de model, prognoză și evaluare. Vreau calitate de publicare.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
...
\begin{frame}{Întrebarea 1}
    ...
    \begin{alertblock}{Întrebare}
        Ce model alegeți pentru a prognoza volatilitatea randamentelor financiare?
    \end{alertblock}

    \vspace{0.3cm}

    \begin{enumerate}[(A)]
        \item ARIMA --- captează tendințe și autocorelații
        \item GARCH --- modelează varianța condiționată
        \item Prophet --- detectează puncte de schimbare
        \item VAR --- model multivariat pentru interdependențe
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 1: Răspuns}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Răspuns Corect: (B) GARCH --- modelează varianța condiționată}
        GARCH captează volatility clustering și riscul variabil în timp. ARIMA modelează nivelul, Prophet sezonalitatea, VAR relațiile între serii --- niciunul nu modelează varianța direct.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch10_quiz1_model_selection.pdf}
    \end{center}
    \quantlet{TSA\_ch10\_quiz1\_model\_selection}{https://github.com/QuantLet/TSA/tree/main/TSA_ch10/TSA_ch10_quiz1_model_selection}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 2}
    \begin{cminipage}{0.95\textwidth}
    \begin{alertblock}{Întrebare}
        Un model SARIMA obține RMSE = 0,05 pe antrenament, dar RMSE = 2,30 pe test. Ce indică aceasta?
    \end{alertblock}

    \vspace{0.3cm}

    \begin{enumerate}[(A)]
        \item Modelul este excelent --- eroare mică pe antrenament
        \item Modelul suferă de overfitting --- memorează zgomotul
        \item Setul de test este greșit --- trebuie schimbat
        \item Diferența este normală --- nu e nicio problemă
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 2: Răspuns}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Răspuns Corect: (B) Overfitting --- memorează zgomotul}
        Un raport de $46\times$ între RMSE test și train semnalează overfitting sever. Modelul se potrivește zgomotului din antrenament și nu generalizează. Soluție: model mai simplu, validare.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch10_quiz2_overfitting.pdf}
    \end{center}
    \quantlet{TSA\_ch10\_quiz2\_overfitting}{https://github.com/QuantLet/TSA/tree/main/TSA_ch10/TSA_ch10_quiz2_overfitting}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 3}
    \begin{cminipage}{0.95\textwidth}
    \begin{alertblock}{Întrebare}
        De ce este importantă separarea datelor în train/validation/test?
    \end{alertblock}

    \vspace{0.3cm}

    \begin{enumerate}[(A)]
        \item Pentru a avea mai multe date de antrenament
        \item Pentru a preveni supraajustarea și a evalua corect
        \item Este doar o convenție, nu are importanță reală
        \item Pentru a reduce timpul de calcul
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 3: Răspuns}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Răspuns Corect: (B) Prevenirea supraajustării și evaluare corectă}
        Train: estimează parametrii. Validare: selectează modelul. Test: evaluare finală nebiasată. Amestecarea acestor roluri duce la estimări optimiste ale performanței.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch10_quiz3_train_val_test.pdf}
    \end{center}
    \quantlet{TSA\_ch10\_quiz3\_train\_val\_test}{https://github.com/QuantLet/TSA/tree/main/TSA_ch10/TSA_ch10_quiz3_train_val_test}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 4}
    \begin{cminipage}{0.95\textwidth}
    \begin{alertblock}{Întrebare}
        Cauzalitatea Granger este echivalentă cu cauzalitatea reală (structurală)?
    \end{alertblock}

    \vspace{0.3cm}

    \begin{enumerate}[(A)]
        \item Da --- dacă $X$ prezice $Y$, atunci $X$ cauzează $Y$
        \item Nu --- testează doar conținut predictiv, nu cauzalitate
        \item Depinde de numărul de lag-uri selectate
        \item Da, dacă p-value $< 0,05$
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 4: Răspuns}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Răspuns Corect: (B) Nu --- doar conținut predictiv, nu cauzalitate}
        Testul Granger verifică dacă trecutul lui $X$ îmbunătățește predicția lui $Y$. Corelații false (ex: vânzări de înghețată și înecuri) pot trece testul din cauza cauzelor comune.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch10_quiz4_granger_causality.pdf}
    \end{center}
    \quantlet{TSA\_ch10\_quiz4\_granger\_causality}{https://github.com/QuantLet/TSA/tree/main/TSA_ch10/TSA_ch10_quiz4_granger_causality}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 5}
    \begin{cminipage}{0.95\textwidth}
    \begin{alertblock}{Întrebare}
        Ce model folosiți pentru o serie cu sezonalitate lungă (ex: $s = 365$ zile)?
    \end{alertblock}

    \vspace{0.3cm}

    \begin{enumerate}[(A)]
        \item SARIMA$(p,d,q)(P,D,Q)_{365}$
        \item GARCH --- modelează variația
        \item ARIMA + Termeni Fourier sau Prophet/TBATS
        \item VAR cu 365 lag-uri
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \begin{cminipage}{0.95\textwidth}
    \begin{exampleblock}{Răspuns Corect: (C) Termeni Fourier / Prophet / TBATS}
        SARIMA$_{365}$ necesită $\sim$730 parametri sezonieri --- imposibil. Termenii Fourier cu $K=3$ folosesc doar 6 parametri. Prophet și TBATS gestionează sezonalități multiple automat.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch10_quiz5_long_seasonality.pdf}
    \end{center}
    \quantlet{TSA\_ch10\_quiz5\_long\_seasonality}{https://github.com/QuantLet/TSA/tree/main/TSA_ch10/TSA_ch10_quiz5_long_seasonality}
    \end{cminipage}
\end{frame}
...
Niciun model nu câștigă peste tot. Potriviți modelul cu datele: ARIMA pentru tendințe, SARIMA pentru sezonalitate, GARCH pentru volatilitate, VAR/VECM pentru dinamici multivariate, Prophet/TBATS pentru tipare complexe. Validați întotdeauna out-of-sample!
\end{alertblock}
\end{frame}
...
% SURSE DE DATE
%=============================================================================
\begin{frame}{Surse de Date (Sumar)}
    \begin{block}{Date Reale Folosite în Acest Capitol}
        \begin{itemize}
            \item \textbf{Bitcoin}: Yahoo Finance (BTC-USD), 2019--2025
            \item \textbf{Pete Solare}: Dataset Wolfer din Statsmodels, 1900--2008
...
\begin{frame}{Resurse Online și Cod}
    \begin{exampleblock}{}
        {\small
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA\_ch10}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch10}
        \end{itemize}
        }
    \end{exampleblock}
\end{frame}
