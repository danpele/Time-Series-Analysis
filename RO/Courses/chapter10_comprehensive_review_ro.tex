...
\begin{frame}{Bitcoin: dovezi pentru GARCH}
    ...
    \begin{block}{Observație}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item ACF descreștere lentă $\Rightarrow$ persistență ridicată a volatilității
        \end{itemize}
    \end{block}
    }
    \begin{center}
...
\begin{frame}{Cauzalitatea Granger: Rezultate empirice}
    ...
    \begin{block}{Interpretare}
        ...
        \begin{exampleblock}{Concluzii economice}
            \begin{itemize}
                \item Șomaj $\succ$ PIB ($p=0,045$): Legea lui Okun
                \item Fed $\succ$ Inflație ($p=0,087$): Transmisia politicii monetare
                \item PIB $\succ$ Șomaj: Dovezi slabe
            \end{itemize}
        \end{exampleblock}
    }
\end{frame}
...
\begin{frame}{Întrebarea 5: Răspuns}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item SARIMA$_{365}$ necesită polinoame lag de ordin 365 --- imposibil de estimat computațional. Termenii Fourier cu $K=3$ folosesc doar 6 parametri ($\sin$/$\cos$). Prophet și TBATS gestionează sezonalități multiple automat.
    \end{itemize}
    \end{exampleblock}
    }
