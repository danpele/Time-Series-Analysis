    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Limitarea modelelor ARIMA (Autoregressive Integrated Moving Average)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Această ipoteză nu este realistă pentru seriile financiare.
            \end{itemize}
        \end{alertblock}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Exemplu: Bitcoin -- evidență pentru efecte ARCH}
    ...
    \begin{block}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item ACF($r_t^2$) este semnificativ la multe lag-uri $\Rightarrow$ \textbf{efecte ARCH prezente}
            \item Varianța condiționată este predictibilă $\Rightarrow$ modelele GARCH sunt justificate
        \end{itemize}
    \end{block}
    }
    \begin{center}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Kurtosis ARCH(1): prea mică.}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Kurtosis teoretică: $\kappa = 3 \cdot \frac{1 - 0.09^2}{1 - 3 \times 0.09^2} \approx \textbf{3.05}$; \quad kurtosis empirică S\&P 500: $\kappa \approx \textbf{13.8}$
            \end{itemize}
        \end{block}
        \vspace{-0.15cm}
