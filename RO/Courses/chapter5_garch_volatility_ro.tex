...
\begin{frame}{Volatility clustering}
    ...
    \begin{block}{Observații}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_clustering}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Exemplu: Bitcoin $\succ$ volatility clustering}
    ...
    \begin{block}{Observații}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_btc\_returns}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Fapte stilizate ale randamentelor financiare}
    ...
    \quantlet{TSA\_ch5\_stylized}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Exemplu: Bitcoin $\succ$ evidență pentru efecte ARCH}
    ...
    \quantlet{TSA\_ch5\_btc\_arch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Simulare ARCH(1): Efectul parametrului $\alpha$}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_arch\_sim}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\small
    ...
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.38\textheight, keepaspectratio]{garch_conditional_variance.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Simulare GARCH(1,1): efectul persistenței}
    ...
    \quantlet{TSA\_ch5\_garch\_sim}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{GARCH vs IGARCH: comparație persistență}
    ...
    \quantlet{TSA\_ch5\_igarch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Leverage effect}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{garch_leverage_effect.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
...
\begin{frame}{Simulare EGARCH: Efect Simetric vs Asimetric}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_egarch\_sim}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{News impact curve $\succ$ EGARCH}
    ...
    \quantlet{TSA\_ch5\_nic}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Simulare GJR-GARCH/TGARCH}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_gjr\_sim}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}

\begin{frame}{Simulare TGARCH: răspuns asimetric la volatilitate}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.92\textwidth, height=0.45\textheight, keepaspectratio]{garch_tgarch_simulation.pdf}
    \end{center}
    \vspace{-0.2cm}
    \begin{block}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_tgarch\_sim}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Comparație news impact curves}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_nic\_comp}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Comparație familie GARCH}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_family}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Exemplu diagnostic}
    ...
    \begin{block}{Verificare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_diagnostic}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Comparație modele GARCH $\succ$ validare}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_comparison}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Prognoza volatilității $\succ$ Vizualizare}
    ...
    \quantlet{TSA\_ch5\_vol\_forecast}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Convergența prognozei GARCH către varianța necondiționată}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_convergence}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{VaR și ES: ilustrație grafică}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_var\_plot}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{VaR vs expected shortfall: normal vs Student-t}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_var\_es}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{VaR backtesting: vizualizare}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_backtest}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}[fragile]{VaR backtesting în Python $\succ$ rolling window}
\small
...
\end{block}
    \quantlet{TSA\_ch5\_backtest\_py}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}

\begin{frame}[fragile]{Testul Kupiec $\succ$ implementare Python}
\small
...
\begin{frame}[fragile]{Testul Christoffersen $\succ$ implementare Python}
\small
...
\begin{frame}[fragile]{Backtesting complet $\succ$ rezultate și decizie}
\small
...
\end{exampleblock}
    \quantlet{TSA\_ch5\_backtest\_full}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Prognoza volatilității cu intervale de încredere}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_vol\_ci}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}

\begin{frame}{Rolling forecast $\succ$ prognoza pas cu pas}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.38\textheight, keepaspectratio]{garch_rolling_forecast.pdf}
    \end{center}
    \vspace{-0.1cm}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch5\_rolling\_forecast}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}[fragile]{Estimare GARCH în Python $\succ$ arch}
\small
\begin{columns}[T]
...
\end{column}
\end{columns}
    \quantlet{TSA\_ch5\_garch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\end{verbatim}
\end{block}
    \quantlet{TSA\_ch5\_egarch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\end{verbatim}
\end{block}
    \quantlet{TSA\_ch5\_forecast}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\end{itemize}
\end{exampleblock}
    \quantlet{TSA\_ch5\_armagarch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Pasul 1: Datele $\succ$ randamente zilnice S\&P 500}
    ...
    \quantlet{TSA\_ch5\_sp500}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{block}{Cod Python $\succ$ estimare 4 modele candidate}
{\scriptsize
\begin{verbatim}
from arch import arch_model
models = {}
...
\begin{alertblock}{Strategie}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Estimăm modele simetrice \textbf{și} asimetrice, cu diferite distribuții
        \item Alegerea finală: \textbf{AIC/BIC} + \textbf{diagnostice} + \textbf{interpretare economică}
    \end{itemize}
\end{alertblock}
}
\end{frame}
...
\begin{frame}{Pasul 3: Parametri estimați $\succ$ comparație}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.26\textheight, keepaspectratio]{garch_sp500_volatility.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\scriptsize
    ...
    \quantlet{TSA\_ch5\_sp500\_garch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Pasul 5: Diagnostice $\succ$ EGARCH(1,1)-t}
    ...
    \quantlet{TSA\_ch5\_sp500\_diag}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Pasul 5: Leverage effect $\succ$ vizualizare}
    ...
    \begin{block}{GARCH vs EGARCH $\succ$ diferențe de volatilitate}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_sp500\_comp}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}

\begin{frame}[fragile]{Pasul 6: VaR rolling window $\succ$ S\&P 500}
    \small
...
\end{verbatim}
    ...
    \begin{exampleblock}{Caracteristici VaR rolling S\&P 500 (2017--2024)}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item VaR maxim: 22.02\% $\succ$ criză COVID-19 ($\approx$ EUR 2.202.000)
            \item VaR minim: 0.91\% $\succ$ perioadă calmă ($\approx$ EUR 91.000)
...
\begin{frame}{Pasul 6: Backtesting rolling VaR $\succ$ S\&P 500}
    ...
    \quantlet{TSA\_ch5\_sp500\_var}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Pasul 1: Datele $\succ$ randamente zilnice Bitcoin}
    ...
    \quantlet{TSA\_ch5\_btc}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
...
\begin{frame}{Pasul 2: Testarea efectelor ARCH $\succ$ Bitcoin}
    ...
    \begin{block}{Rezultate teste}
        ...
        \end{tabular}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item ACF al $r_t^2$: scădere \textbf{lentă} $\succ$ volatility clustering puternic
        \end{itemize}
    \end{block}
    }
    \quantlet{TSA\_ch5\_btc\_arch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
...
\begin{frame}{Pasul 5: Volatilitatea condiționată $\succ$ Bitcoin}
    ...
    \quantlet{TSA\_ch5\_btc\_garch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}

\begin{frame}[fragile]{Pasul 6: VaR rolling window $\succ$ Bitcoin}
    \small
...
\begin{frame}{Pasul 6: Backtesting rolling VaR $\succ$ Bitcoin}
    ...
    \quantlet{TSA\_ch5\_btc\_var}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.ipynb}
\end{frame}
    ...
    \begin{exampleblock}{Răspuns Corect: (B) Perioadele de volatilitate ridicată sunt urmate de perioade similare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Implică faptul că varianța condiționată este \textbf{predictibilă}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Perioadele de calm $\succ$ urmate de calm
                    \item Perioadele de criză $\succ$ urmate de volatilitate ridicată
                \end{itemize}
    ...
    \begin{exampleblock}{Răspuns Corect: (C) GARCH adaugă lag-uri ale varianței condiționate}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GARCH(p,q)}: $\sigma_t^2 = \omega + \sum \alpha_i \varepsilon_{t-i}^2 + \sum \beta_j \sigma_{t-j}^2$
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Adaugă lag-uri ale varianței $\succ$ captează persistența cu mai puțini parametri
    ...
    \begin{exampleblock}{Răspuns Corect: (C) $\alpha + \beta < 1$, cu $\omega > 0$, $\alpha \geq 0$, $\beta \geq 0$}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Condiția $\alpha + \beta < 1$ asigură existența varianței necondiționate finite
                ...
                \end{itemize}
            \item Când $\alpha + \beta = 1$ $\succ$ IGARCH (varianța este infinită)
