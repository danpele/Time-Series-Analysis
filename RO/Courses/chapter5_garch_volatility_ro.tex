...
\begin{frame}{Volatility clustering}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_volatility_clustering.pdf}
    \end{center}
...
\begin{frame}{Simulare ARCH(1): Efectul parametrului $\alpha$}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_arch1_simulation.pdf}
    \end{center}
...
\begin{frame}{Simulare GARCH(1,1): efectul persistenței}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_garch11_simulation.pdf}
    \end{center}
...
\begin{frame}{GARCH vs IGARCH: comparație persistență}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_igarch_comparison.pdf}
    \end{center}
...
\begin{frame}{Simulare EGARCH: Efect Simetric vs Asimetric}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_egarch_simulation.pdf}
    \end{center}
...
\begin{frame}{Simulare GJR-GARCH/TGARCH}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_gjr_simulation.pdf}
    \end{center}
...
\begin{frame}{Simulare TGARCH: răspuns asimetric la volatilitate}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_tgarch_simulation.pdf}
    \end{center}
...
\begin{frame}{Comparație news impact curves}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_nic_comparison.pdf}
    \end{center}
...
\begin{frame}{Comparație familie GARCH}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_family_comparison.pdf}
    \end{center}
...
\begin{frame}{Prognoza volatilității $\succ$ Vizualizare}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_forecast.pdf}
    \end{center}
...
\begin{frame}{VaR și ES: ilustrație grafică}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_var_illustration.pdf}
    \end{center}
...
\begin{frame}{VaR vs expected shortfall: normal vs Student-t}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_var_es_comparison.pdf}
    \end{center}
...
\begin{frame}{VaR backtesting: vizualizare}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_var_backtesting.pdf}
    \end{center}
...
\begin{frame}{Prognoza volatilității cu intervale de încredere}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_volatility_forecast.pdf}
    \end{center}
...
\begin{frame}{Pasul 5: Leverage effect $\succ$ vizualizare}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{garch_sp500_comparison.pdf}
    \end{center}
...
\begin{frame}{Pasul 2: Testarea efectelor ARCH $\succ$ Bitcoin}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{btc_squared_returns.pdf}
    \end{center}
    \quantlet{TSA\_ch5\_btc\_arch}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_btc_arch}
\end{frame}
...
\begin{frame}{Pasul 5: Volatilitatea condiționată $\succ$ Bitcoin}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ch10_bitcoin_garch.pdf}
    \end{center}
...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Descărcați randamentele zilnice S\&P 500 cu yfinance. Testați efectele ARCH, ajustați un model GARCH și prognozați volatilitatea pe 20 de zile de tranzacționare. Vreau cod Python complet.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
...
\begin{frame}{Întrebarea 1: Răspuns}
    ...
    \begin{exampleblock}{Răspuns Corect: (B) Perioadele de volatilitate ridicată sunt urmate de perioade similare}
        Volatility clustering este un fapt stilizat fundamental. Implică faptul că varianța condiționată este \textbf{predictibilă}, motivând modelele ARCH/GARCH.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{garch_quiz1_volatility_clustering.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 2: Răspuns}
    ...
    \begin{exampleblock}{Răspuns Corect: (C) GARCH adaugă lag-uri ale varianței condiționate}
        GARCH(1,1) captează aceeași persistență ca ARCH(q) cu doar 2 parametri în loc de $q$. În practică, GARCH(1,1) este suficient în 90\% din cazuri.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{garch_quiz2_arch_vs_garch.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 3: Răspuns}
    ...
    \begin{exampleblock}{Răspuns Corect: (B) Șocurile negative cresc volatilitatea mai mult; EGARCH și GJR-GARCH}
        Scăderile de preț cresc volatilitatea \textbf{mai mult} decât creșterile de aceeași magnitudine. GARCH standard folosește $\varepsilon_{t-1}^2$, pierzând informația de semn.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{garch_quiz3_leverage_effect.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 4: Răspuns}
    ...
    \begin{exampleblock}{Răspuns Corect: (C) $\alpha + \beta < 1$, cu $\omega > 0$, $\alpha \geq 0$, $\beta \geq 0$}
        Asigură existența varianței necondiționate finite: $\bar{\sigma}^2 = \frac{\omega}{1-\alpha-\beta}$. Când $\alpha + \beta = 1$ (IGARCH), varianța este infinită.
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{garch_quiz4_stationarity.pdf}
    \end{center}
...
\begin{frame}{Întrebarea 5: Răspuns}
    ...
    \begin{exampleblock}{Răspuns Corect: (C) Numărul de perioade necesare ca un șoc să se reducă la jumătate}
        $HL = \frac{\ln(0.5)}{\ln(\alpha+\beta)}$. Exemplu: S\&P 500 cu $\alpha+\beta=0.988$ dă $HL \approx 58$ zile (șocurile persistă $\sim$3 luni).
    \end{exampleblock}
    \vspace{0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{garch_quiz5_halflife.pdf}
    \end{center}
