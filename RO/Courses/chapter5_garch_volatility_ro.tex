...
\begin{frame}{IGARCH --- integrated GARCH}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Proprietăți}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Varianța necondiționată nu există (infinită) (dar procesul rămâne strict staționar, cf.\ Nelson, 1990)
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Problema GARCH standard}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Intuiție economică: Semnale negative de piață $\Rightarrow$ prețul scade $\Rightarrow$ levierul crește $\Rightarrow$ volatilitatea crește
            \end{itemize}
        \end{alertblock}
...
\begin{frame}{Proprietăți și extensii DCC}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{DCC asimetric (Cappiello, Engle \& Sheppard, 2006)}
            Extensie cu \textbf{termen de levier} pentru a capta creșterea corelațiilor în perioade de criză:
            \[
            ...
            \]
            unde $\mathbf{n}_t = \mathbb{I}(\mathbf{u}_t < 0) \odot \mathbf{u}_t$ (componenta negativă), $\bar{\mathbf{N}} = \E[\mathbf{n}_t \mathbf{n}_t']$
        \end{block}
        \begin{exampleblock}{Aplicații}
            \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{frame}{Întrebarea 5: Răspuns}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Rezolvare}
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item[(a)] $\bar{\sigma}^2 = \frac{\omega}{1 - \alpha - \beta} = \frac{0.05}{1 - 0.97} = 1.667$ $\Rightarrow$ $\bar{\sigma} = 1.291\%$ zilnic

                    $\sigma_{\text{an}} = 1.291\% \times \sqrt{252} \approx 20.5\%$
                ...
                \item[(c)] Valoare portofoliu $V = 2{,}000{,}000$ EUR, $\sigma_{T+1} = 1.291\%$:
                    ...
                    $\text{VaR}_{1\%} = \frac{3.365}{\sqrt{5/3}} \times 0.01291 \times 2{,}000{,}000$ $= \textbf{67\,300}$ EUR (\textbf{+12\%} vs Normal!)
            \end{itemize}
        \end{exampleblock}
        }
        \begin{center}
