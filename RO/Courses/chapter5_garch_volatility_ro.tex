...
\begin{frame}{Exemplu: Bitcoin $\succ$ volatility clustering}
    ...
    \begin{block}{Observații}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_btc\_returns}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Exemplu: Bitcoin $\succ$ evidență pentru efecte ARCH}
    ...
    \quantlet{TSA\_ch5\_btc\_arch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Simulare TGARCH: răspuns asimetric la volatilitate}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_tgarch\_sim}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Comparație modele GARCH $\succ$ validare}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_comparison}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Convergența prognozei GARCH către varianța necondiționată}
    ...
    \begin{block}{Interpretare}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_convergence}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\end{exampleblock}
    \quantlet{TSA\_ch5\_backtest\_full}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Rolling forecast $\succ$ prognoza pas cu pas}
    ...
    \end{exampleblock}
    \quantlet{TSA\_ch5\_rolling\_forecast}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\end{column}
\end{columns}
    \quantlet{TSA\_ch5\_garch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\end{verbatim}
\end{block}
    \quantlet{TSA\_ch5\_egarch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\end{verbatim}
\end{block}
    \quantlet{TSA\_ch5\_forecast}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Pasul 5: Diagnostice $\succ$ EGARCH(1,1)-t}
    ...
    \quantlet{TSA\_ch5\_sp500\_diag}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Pasul 6: Backtesting rolling VaR $\succ$ S\&P 500}
    ...
    \quantlet{TSA\_ch5\_sp500\_var}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Pasul 1: Datele $\succ$ randamente zilnice Bitcoin}
    ...
    \quantlet{TSA\_ch5\_btc}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Pasul 5: Volatilitatea condiționată $\succ$ Bitcoin}
    ...
    \quantlet{TSA\_ch5\_btc\_garch}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
...
\begin{frame}{Pasul 6: Backtesting rolling VaR $\succ$ Bitcoin}
    ...
    \quantlet{TSA\_ch5\_btc\_var}{https://github.com/QuantLet/TSA/blob/main/TSA_ch5/TSA_ch5_garch.py}
\end{frame}
