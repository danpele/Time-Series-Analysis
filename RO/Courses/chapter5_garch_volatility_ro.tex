...
\begin{frame}{Volatility clustering (gruparea volatilității)}
    \vspace{-0.2cm}
    {\scriptsize
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Perioadele de volatilitate mare sunt urmate de perioade de volatilitate mare; perioade calme
...
\begin{frame}{Schimbări de regim în volatilitate}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Implicații practice}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Dacă rupturile sunt prezente, persistența GARCH ($\alpha + \beta$) este \textbf{biasată în sus} $\Rightarrow$ IGARCH fals
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{alertblock}{Problema GARCH standard}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Intuiție economică: Vești proaste $\Rightarrow$ prețul scade $\Rightarrow$ levierul crește $\Rightarrow$ volatilitatea crește
            \end{itemize}
        \end{alertblock}
