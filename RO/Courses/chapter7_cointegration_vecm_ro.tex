...
\begin{frame}{Portret de cercetător: Søren Johansen}
    ...
    \begin{columns}[T]
        \begin{column}{0.25\textwidth}
            \centering
            \includegraphics[width=0.95\textwidth, height=0.25\textheight, keepaspectratio]{photo_soren_johansen.jpg}
            \\[0.05cm]
...
\begin{frame}{Pasul 2: Testul Engle-Granger de cointegrare}
    ...
    \begin{block}{Rezultate}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Regresie Engle-Granger}: Rata pe termen scurt = $\alpha$ + $\beta$ $\times$ Rata pe termen lung + $\varepsilon_t$
