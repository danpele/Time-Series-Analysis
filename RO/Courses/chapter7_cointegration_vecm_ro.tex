...
\begin{frame}{Regresia falsă: exemplu vizual}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{spurious_regression.pdf}
    \end{center}
...
\begin{frame}{Cointegrarea: exemplu vizual}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{cointegrated_series.pdf}
    \end{center}
...
\begin{frame}{Portret de cercetător: Søren Johansen}
    ...
    \begin{columns}[T]
        \begin{column}{0.28\textwidth}
            \centering
            \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{photo_soren_johansen.jpg}
            \\[0.2cm]
            {\footnotesize\textcolor{MediumGray}{*1939}}\\[0.1cm]
            \href{https://en.wikipedia.org/wiki/S\%C3\%B8ren_Johansen}{\faWikipediaW\ \textcolor{MainBlue}{\small Wikipedia (en)}}
        \end{column}
...
\begin{frame}{Testul Johansen: interpretare vizuală}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{johansen_eigenvalues.pdf}
    \end{center}
...
\begin{frame}{Mecanismul de corecție a erorilor: vizualizare}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{error_correction.pdf}
    \end{center}
...
\begin{frame}{Funcțiile de răspuns la impuls VECM}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{vecm_irf.pdf}
    \end{center}
...
\begin{frame}{Exemplu 1: structura la termen a ratelor dobânzii}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{interest_rates_coint.pdf}
    \end{center}
...
\begin{frame}{Exemplu 2: pairs trading în finanțe}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{pairs_trading.pdf}
    \end{center}
...
\begin{frame}{Exemplu 3: paritatea puterii de cumpărare (PPP)}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.78\textheight, keepaspectratio]{ppp_cointegration.pdf}
    \end{center}
