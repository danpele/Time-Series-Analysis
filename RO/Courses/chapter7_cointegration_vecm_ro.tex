...
\begin{frame}{Cointegrarea: exemplu vizual}
    ...
    \begin{exampleblock}{De reținut}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Combinația lor liniară (spread-ul) este staționară $\succ$ aceasta este cointegrarea!
        \end{itemize}
    \end{exampleblock}
    }
    \begin{center}
...
\begin{frame}{Funcțiile IRF (Impulse Response Functions) ale VECM}
    ...
    \begin{block}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Sistemul revine la echilibru $\succ$ converg către o nouă valoare pe termen lung
        \end{itemize}
    \end{block}
    }
    \begin{center}
...
\begin{frame}{Exemplu 1: structura la termen a ratelor dobânzii}
    ...
    \begin{exampleblock}{Ipoteza așteptărilor}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Spread-ul (prima de termen) este staționar $\succ$ dovadă de cointegrare!
        \end{itemize}
    \end{exampleblock}
    }
    \begin{center}
...
\begin{frame}{Pasul 1: Teste de rădăcină unitară}
    ...
    \begin{block}{Rezultate}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{ACF} (Autocorrelation Function) \textbf{niveluri}: Descreștere lentă $\succ$ nestaționaritate; după diferențiere: scădere rapidă $\succ$ I(1)
