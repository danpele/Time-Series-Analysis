...
% ============================================================================
% UNIFORM FONT SIZE — anti-shrink, anti-resize
% ============================================================================
\usepackage{etoolbox}
...
% Lock font sizes per element type
...
% Theorem-like environments (defn, thm, prop, rmk) inherit block font
...
% Romanian comma-below characters (ș/ț = U+0219/U+021B) not in T1 — map them
\usepackage{combelow}
\DeclareUnicodeCharacter{0219}{\cb{s}}
\DeclareUnicodeCharacter{021B}{\cb{t}}
\DeclareUnicodeCharacter{0218}{\cb{S}}
\DeclareUnicodeCharacter{021A}{\cb{T}}
...
% Medii numerotate — folosesc block/alertblock (font controlat de setbeamerfont)
\newcounter{defnctr}[section]
\newenvironment{defn}[1][]{\refstepcounter{defnctr}%
  \begin{block}{Definiție \thedefnctr\ifx&#1& \else\ (#1)\fi}}{\end{block}}
\newcounter{thmctr}[section]
\newenvironment{thm}[1][]{\refstepcounter{thmctr}%
  \begin{block}{Teoremă \thethmctr\ifx&#1& \else\ (#1)\fi}}{\end{block}}
\newcounter{propctr}[section]
\newenvironment{prop}[1][]{\refstepcounter{propctr}%
  \begin{block}{Propoziție \thepropctr\ifx&#1& \else\ (#1)\fi}}{\end{block}}
\newcounter{rmkctr}[section]
\newenvironment{rmk}[1][]{\refstepcounter{rmkctr}%
  \begin{alertblock}{Observație \thermkctr\ifx&#1& \else\ (#1)\fi}}{\end{alertblock}}
...
% Comenzi vectoriale boldface (utilizate în Ch6, Ch7, Ch10)
