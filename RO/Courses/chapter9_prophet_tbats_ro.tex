...
\begin{frame}{Exemplu real: vânzări cu amănuntul cu sărbători}
    \begin{center}
...
\begin{frame}{Structura modelului TBATS}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Notații}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $y_t^{(\omega)}$ $\Rightarrow$ seria transformată Box-Cox (dacă $\omega \neq 1$)
...
\begin{frame}{TBATS în practică}
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{Implementare Python}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Pachet \texttt{tbats}}: Oferă selecție automată a modelului --- selectează automat Box-Cox $\omega$, numărul de armonici $k_i$, ordinele ARMA $(p,q)$, trend amortizat vs neamortizat
            \end{itemize}
        \end{block}
...
\begin{frame}{Metrici de evaluare}
    ...
    \begin{cminipage}{0.95\textwidth}
        {\small
        \begin{defn}[Metrici de acuratețe a prognozei (cf.\ Capitolul 0)]
