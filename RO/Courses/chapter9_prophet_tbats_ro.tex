    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Problema}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Tipar zilnic $\Rightarrow$ vârf la prânz și seara
                    \item Tipar săptămânal $\Rightarrow$ mai scăzut în weekend
                    \item Tipar anual $\Rightarrow$ mai mare vara (aer condiționat) și iarna (încălzire)
                    \item Efecte sărbători $\Rightarrow$ cerere mai mică în sărbători
                \end{itemize}
            \end{itemize}
        \end{block}
