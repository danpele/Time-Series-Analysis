    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Componentele TBATS}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{A} $\succ$ Erori \textbf{ARMA} (AutoRegressive Moving Average) pentru autocorelația reziduală
        ...
        \begin{block}{Problema}
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \begin{itemize}\setlength{\itemsep}{0pt}
                    ...
                    \item Tipar anual $\succ$ mai mare vara (aer condiționat) și iarna (încălzire)
...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
            {\footnotesize
            ``Descarcă setul de date Peyton Manning Wikipedia pageviews din Prophet (sau folosește date zilnice de consum de electricitate din 2020-01-01 până în 2024-12-31, aprox.\ 1.800 observații). Folosește Facebook Prophet pentru a prognoza următoarele 30 de zile. Include sărbătorile din SUA și componentele de sezonalitate săptămânală/anuală. Compară cu TBATS. Vreau cod Python complet.''
            }
        \end{block}
        \vspace{-2mm}
        {\footnotesize
    ...
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{exampleblock}{Resurse online și cod}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch9} $\succ$ Cod Python pentru acest capitol
            \end{itemize}
            }
        \end{exampleblock}
    \end{cminipage}
