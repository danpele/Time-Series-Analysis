...
\begin{frame}{Exemplu real: memorie lungă în volatilitate}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.31\textheight, keepaspectratio]{ch8_volatility_long_memory.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\scriptsize
...
\begin{frame}{Time series cross-validation}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.41\textheight, keepaspectratio]{ch8_timeseries_cv.pdf}
    \end{center}
...
\begin{frame}{Energie: de ce Prophet și TBATS?}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.47\textheight, keepaspectratio]{ch9_multiple_seasonality.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
