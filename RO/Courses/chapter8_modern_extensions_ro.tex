...
\begin{frame}{Energie: de ce Prophet și TBATS?}
    ...
    \begin{block}{Soluția: modele cu sezonalitate multiplă}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{TBATS} (Trigonometric, Box-Cox, ARMA, Trend, Seasonal): perioade $[24, 168, 8766]$ $\Rightarrow$ Fourier pentru fiecare sezon
            \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Formule principale -- Rezumat}
    \begin{cminipage}{0.95\textwidth}
        ...
        \begin{block}{ARFIMA(p,d,q)}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $\phi(L)(1-L)^d Y_t = \theta(L)\varepsilon_t$ \quad $d \in \mathbb{R}$ ($d < 0.5$ pentru staționaritate): memorie lungă
            \end{itemize}
        \end{block}
        \vspace{-0.1cm}
...
\begin{frame}{Vizualizare: predicții vs valori reale}
    ...
    \begin{block}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item Toate modelele captează tiparul general
