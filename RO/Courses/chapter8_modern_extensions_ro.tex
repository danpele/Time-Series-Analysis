...
\begin{frame}{Comparație ACF: memorie scurtă vs lungă}
    ...
    }\quantlet{TSA\_ch8\_acf\_comparison}{https://github.com/QuantLet/TSA/tree/main/ch8_acf_comparison}
\end{frame}
...
\begin{frame}{Efectul parametrului $d$ asupra ACF}
    ...
    \vspace{-0.2cm}
    {\footnotesize
    Cu cât $d$ este mai mare, cu atât autocorelațiile scad mai lent. Pentru $d \to 0.5$, autocorelațiile rămân semnificative chiar și la lag-uri foarte mari.
    }\quantlet{TSA\_ch8\_arfima\_d\_effect}{https://github.com/QuantLet/TSA/tree/main/ch8_arfima_d_effect}
\end{frame}
...
\begin{frame}{Exponentul Hurst: interpretare vizuală}
    ...
    }\quantlet{TSA\_ch8\_hurst\_interpretation}{https://github.com/QuantLet/TSA/tree/main/ch8_hurst_interpretation}
\end{frame}
...
\begin{frame}{ARIMA vs ARFIMA: comparație simulată}
    ...
    \vspace{-0.2cm}
    {\footnotesize
    \textbf{ARIMA} (stânga): ACF scade \textbf{exponențial} -- șocurile sunt ``uitate'' rapid\\
    \textbf{ARFIMA} (dreapta, $d=0.35$): ACF scade \textbf{hiperbolic} -- șocurile persistă mult timp
    }\quantlet{TSA\_ch8\_arima\_vs\_arfima}{https://github.com/QuantLet/TSA/tree/main/ch8_arima_vs_arfima}
\end{frame}
...
\begin{frame}{Exemplu date reale: analiza memoriei lungi EUR/RON}
    ...
    \vspace{-0.2cm}
    {\footnotesize
    \textbf{Randamente} (stânga): $H \approx 0.50$, $d \approx 0$ -- \textbf{memorie scurtă} (piață eficientă)\\
    \textbf{Randamente pătrate} (dreapta): $H \approx 0.65$, $d \approx 0.15$ -- \textbf{memorie lungă} în volatilitate
    }\quantlet{TSA\_ch8\_eurron\_long\_memory}{https://github.com/QuantLet/TSA/tree/main/ch8_eurron_long_memory}
\end{frame}
...
\begin{frame}{Exemplu real: memorie lungă în volatilitate}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.72\textheight, keepaspectratio]{ch8_volatility_long_memory.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_volatility\_long\_memory}{https://github.com/QuantLet/TSA/tree/main/ch8_volatility_long_memory}
\end{frame}
...
\begin{frame}{Feature engineering: ilustrare}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.75\textheight, keepaspectratio]{ch8_feature_engineering.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_feature\_engineering}{https://github.com/QuantLet/TSA/tree/main/ch8_feature_engineering}
\end{frame}
...
\begin{frame}{Random Forest: exemplu de prognoză}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.72\textheight, keepaspectratio]{ch8_rf_prediction.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_rf\_prediction}{https://github.com/QuantLet/TSA/tree/main/ch8_rf_prediction}
\end{frame}
...
\begin{frame}{Arhitectura celulei LSTM}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.75\textheight, keepaspectratio]{ch8_lstm_architecture.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_lstm\_architecture}{https://github.com/QuantLet/TSA/tree/main/ch8_lstm_architecture}
\end{frame}
...
\begin{frame}{Time series cross-validation}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch8_timeseries_cv.pdf}
    \end{center}
    \vspace{-0.2cm}
    ...
    }\quantlet{TSA\_ch8\_timeseries\_cv}{https://github.com/QuantLet/TSA/tree/main/ch8_timeseries_cv}
\end{frame}
...
\begin{frame}{Comparație modele: acuratețe vs cost computațional}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.72\textheight, keepaspectratio]{ch8_case_comparison.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_model\_comparison}{https://github.com/QuantLet/TSA/tree/main/ch8_model_comparison}
\end{frame}
...
\begin{frame}{Bitcoin: evoluția prețului și randamentele}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.55\textheight, keepaspectratio]{ch10_bitcoin_overview.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\small
    \begin{block}{Observații cheie}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Creștere exponențială a prețului --- distribuție puternic \textbf{leptokurtotică}
            \item Randamentele zilnice: medie $\approx 0.15\%$, volatilitate $\approx 3.5\%$
            \item Volatility clustering evident --- perioadele de criză (2018, 2020, 2022)
    ...
    \begin{block}{Analiză ACF}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item ACF randamente pătrate: scădere \textbf{lentă, hiperbolică}
                ...
                \end{itemize}
            \item ARFIMA pe volatilitate $>$ ARMA --- captează persistența șocurilor
        \end{itemize}
    \end{block}
    }
\end{frame}
...
\begin{frame}{Energie: de ce Prophet și TBATS?}
    ...
    \begin{block}{Soluția: modele cu sezonalitate multiplă}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{TBATS}: perioade $[24, 168, 8766]$ --- Fourier pentru fiecare sezon
                \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Energie: concluzii și recomandări practice}
    \begin{block}{Lecții învățate}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item TBATS: cel mai bun \textbf{out-of-the-box} --- fără reglaj de hiperparametri
        \end{itemize}
    \end{block}
    \vspace{0.1cm}
    ...
    \end{alertblock}
    \vspace{0.1cm}
    {\footnotesize \textit{Detalii complete despre Prophet și TBATS $\rightarrow$ Capitolul 9.}}
\end{frame}
...
\begin{frame}{Vizualizarea seriei EUR/RON}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.72\textheight, keepaspectratio]{ch8_case_raw_data.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_case\_raw\_data}{https://github.com/QuantLet/TSA/tree/main/ch8_case_raw_data}
\end{frame}

\begin{frame}{Analiză ACF: randamente vs randamente pătrate}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.72\textheight, keepaspectratio]{ch8_case_acf_analysis.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_case\_acf\_analysis}{https://github.com/QuantLet/TSA/tree/main/ch8_case_acf_analysis}
\end{frame}
...
\begin{frame}{Random Forest: importanța features}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.70\textheight, keepaspectratio]{ch8_case_feature_importance.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_case\_feature\_importance}{https://github.com/QuantLet/TSA/tree/main/ch8_case_feature_importance}
\end{frame}
...
\begin{frame}{LSTM: curba de învățare}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.70\textheight, keepaspectratio]{ch8_case_lstm_training.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_case\_lstm\_training}{https://github.com/QuantLet/TSA/tree/main/ch8_case_lstm_training}
\end{frame}
...
\begin{frame}{Vizualizare: predicții vs valori reale}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.72\textheight, keepaspectratio]{ch8_case_predictions.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    ...
    }\quantlet{TSA\_ch8\_case\_predictions}{https://github.com/QuantLet/TSA/tree/main/ch8_case_predictions}
\end{frame}
...
\begin{frame}{Comparație modele: metrici de performanță}
    ...
    }\quantlet{TSA\_ch8\_case\_comparison}{https://github.com/QuantLet/TSA/tree/main/ch8_case_comparison}
\end{frame}
