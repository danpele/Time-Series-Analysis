...
\begin{frame}{Comparație ACF: memorie scurtă vs lungă}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.48\textheight, keepaspectratio]{ch8_acf_comparison.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
...
\begin{frame}{Efectul parametrului $d$ asupra ACF}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.45\textheight, keepaspectratio]{ch8_arfima_d_effect.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{exampleblock}{Interpretare}
...
\begin{frame}{Exponentul Hurst: interpretare vizuală}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.50\textheight, keepaspectratio]{ch8_hurst_interpretation.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{exampleblock}{Interpretare}
...
\begin{frame}{Exemplu date reale: analiza memoriei lungi EUR/RON}
    \begin{center}
        \includegraphics[width=0.88\textwidth, height=0.50\textheight, keepaspectratio]{ch8_eurron_long_memory.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{exampleblock}{Interpretare}
...
\begin{frame}{Exemplu ARFIMA: Volatilitatea Realizată S\&P 500}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.75\textwidth, height=0.35\textheight, keepaspectratio]{ch8_arfima_real_data.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Feature engineering: ilustrare}
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.90\textwidth, height=0.48\textheight, keepaspectratio]{ch8_feature_engineering.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{exampleblock}{Interpretare}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{Ideea Cheie}
                \begin{itemize}\setlength{\itemsep}{2pt}
                    \item Procesează \textbf{secvențe} pas cu pas
                    \item Starea ascunsă $h_t$ transportă \textbf{memoria}
                    \item Actualizare: $h_t = \tanh(W_h h_{t-1} + W_x x_t)$
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.50\textwidth}
            \begin{alertblock}{Problema Gradientului care Dispare}
                \begin{itemize}\setlength{\itemsep}{2pt}
                    \item \textbf{Gradient}: derivata pentru actualizarea ponderilor
                    \item Secvențe lungi: $\frac{\partial L}{\partial h_1} \propto \prod W_h \to 0$
                    \item Pașii timpurii \textbf{nu mai învață}
                    \item \textbf{Soluția}: porțile LSTM/GRU
                \end{itemize}
            \end{alertblock}
        \end{column}
    \end{columns}
...
\begin{frame}{Celula LSTM: Diagrama Detaliată}
    ...
    \vspace{-0.2cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.55\textheight, keepaspectratio]{ch8_lstm_cell.pdf}
    \end{center}
    \vspace{-0.3cm}
    {\footnotesize
    \begin{columns}[T]
...
\begin{frame}{Studiu de Caz: Performanța Celui Mai Bun Model}
    ...
    \begin{columns}[T]
        \begin{column}{0.46\textwidth}
            \begin{block}{Random Forest Câștigă}
                \begin{itemize}\setlength{\itemsep}{1pt}
                    \item MAPE: \textbf{2.2\%}
                    \item Captează pattern-urile săptămânale
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.46\textwidth}
            \begin{alertblock}{De ce RF a fost mai bun?}
                \begin{itemize}\setlength{\itemsep}{1pt}
                    \item Feature engineering bun
