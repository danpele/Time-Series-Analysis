...
\begin{frame}{Foundation Models: Previzualizare EUR/RON}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.40\textheight, keepaspectratio]{ch8_foundation_comparison.pdf}
    \end{center}

    \begin{alertblock}{Pentru un tratament complet, vezi Capitolul 11}
        Capitolul 11 oferă o analiză detaliată a arhitecturilor foundation models (Chronos, TimesFM, Lag-Llama, Moirai, TimeGPT), strategii de tokenizare, zero-shot vs fine-tuning și studii de caz extinse pe multiple domenii.
    \end{alertblock}
    }
    \end{cminipage}
