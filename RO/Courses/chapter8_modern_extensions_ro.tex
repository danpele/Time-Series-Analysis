...
%=============================================================================
\section{Foundation Models: Studiu de Caz EUR/RON}
%=============================================================================

\begin{frame}{Foundation Models: Zero-Shot pe EUR/RON}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Date}: EUR/RON (2019--2025) --- Modele clasice vs Chronos/TimesFM (zero-shot, fără antrenare)
                \item \textbf{Stânga}: Comparație RMSE și MAE între toate modelele
                \item \textbf{Dreapta}: Îmbunătățire relativă față de ARIMA (baseline)
            \end{itemize}
        \end{block}
    }
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{ch8_foundation_comparison.pdf}
    \end{center}
    \quantlet{TSA\_ch8\_foundation\_comparison}{https://github.com/QuantLet/TSA/tree/main/TSA_ch8/TSA_ch8_foundation_comparison}
\end{frame}

\begin{frame}{Chronos și TimesFM: detaliu predicții}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{block}{Interpretare}
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Chronos} (Amazon): arhitectură T5, tokenizare în intervale discrete; interval de încredere 80\%
                \item \textbf{TimesFM} (Google): decoder-only cu patching; prognoză zero-shot
                \item Ambele modele aplicate \emph{fără antrenare} pe datele EUR/RON --- transfer learning pur
            \end{itemize}
        \end{block}
    }
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.48\textheight, keepaspectratio]{ch8_foundation_predictions.pdf}
    \end{center}
    \quantlet{TSA\_ch8\_foundation\_predictions}{https://github.com/QuantLet/TSA/tree/main/TSA_ch8/TSA_ch8_foundation_predictions}
\end{frame}

\begin{frame}{Comparație Finală: Clasic vs Foundation}
    \begin{cminipage}{0.95\textwidth}
    \begin{center}
    {\small
    \begin{tabular}{l|c|c|c|c}
        ...
        MLP/LSTM & 0.0162 & 0.0072 & 0.52 & Nu \\
        \midrule
        Chronos (zero-shot) & \multicolumn{4}{c}{\textit{Rulați scriptul pentru rezultate}} \\
        TimesFM (zero-shot) & \multicolumn{4}{c}{\textit{Rulați scriptul pentru rezultate}} \\
        \bottomrule
    \end{tabular}
    }
    \end{center}
    {\scriptsize \textit{Rândurile foundation models populate de \texttt{generate\_ch8\_eurron\_foundation.py} când pachetele sunt instalate.}}

    \vspace{0.1cm}

    \begin{alertblock}{Concluzii cheie}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Foundation models oferă prognoză \textbf{zero-shot} --- fără pipeline de antrenare
            \item Pe piețe eficiente (EUR/RON), ARIMA clasic este un \textbf{baseline puternic}
            \item Foundation models excelează la sarcini \textbf{cross-domain} și prototipare rapidă
        \end{itemize}
    \end{alertblock}
    \end{cminipage}
\end{frame}
