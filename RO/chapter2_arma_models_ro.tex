...
\newcommand{\quantlet}[2]{%
    \par\vspace{0.15cm}
    \hfill\href{#2}{%
        \raisebox{-0.2em}{\includegraphics[height=1.2em]{ql_logo.png}}%
        \textcolor{MainBlue}{\footnotesize\ #1}%
    }%
}
...
\begin{frame}{AR(1): Ilustrație Vizuală}
    ...
    {\footnotesize
    \begin{itemize}
        \item \textbf{$\phi$ pozitiv (ex. 0.8)}: Fluctuații persistente, netede
            \begin{itemize}
                \item Valorile tind să rămână pe aceeași parte a mediei
                \item Revenire graduală la medie --- aspect de ``trend''
            \end{itemize}
        \item \textbf{$\phi$ negativ (ex. -0.8)}: Comportament oscilant
            \begin{itemize}
                \item Valorile alternează în jurul mediei
                \item Schimbări rapide de semn --- aspect ``agitat''
            \end{itemize}
        \item $|\phi|$ mai mare $\Rightarrow$ revenire mai lentă la medie, persistență mai mare
    \end{itemize}
    }
...
\begin{frame}{MA(1): Ilustrație Vizuală}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.52\textheight, keepaspectratio]{ch2_def_ma1.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
...
\begin{frame}{ARMA: Ilustrație Vizuală}
    \begin{center}
        \includegraphics[width=0.95\textwidth, height=0.52\textheight, keepaspectratio]{ch2_def_arma.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
