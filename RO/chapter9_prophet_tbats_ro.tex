% Capitolul 9: Prophet și TBATS pentru Sezonalități Multiple
% Abordări moderne pentru tipare sezoniere complexe
...
% TITLE INFORMATION
%=============================================================================
\title[Capitolul 9: Prophet și TBATS]{Capitolul 9: Prophet și TBATS}
...
\begin{frame}{Exemplu: Date Orare cu Sezonalități Multiple}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_multiple_seasonality.pdf}
    \end{center}
\end{frame}

\begin{frame}{Exemplu Real: Cerere de Electricitate}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_electricity_demand.pdf}
    \end{center}
\end{frame}

\begin{frame}{Exemplu Real: Vânzări Retail cu Sărbători}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_retail_sales.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{TBATS: Ce Înseamnă?}
    ...
    \begin{exampleblock}{Inovația Cheie}
        ...
        \]
        unde $m_i$ este perioada sezonieră $i$ și $k_i$ este numărul de armonici.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{TBATS: Sezonalitate Trigonometrică}
    \begin{block}{De Ce Termeni Fourier/Trigonometrici?}
        \begin{enumerate}
            \item \textbf{Parcimonios}: Mai puțini parametri decât variabilele dummy
...
\begin{frame}{Aproximarea Fourier a Sezonalității}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_fourier_approximation.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Exemplu Descompunere TBATS}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_tbats_decomposition.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Descompunerea Componentelor Prophet}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_prophet_components.pdf}
    \end{center}
\end{frame}

\begin{frame}{Detectarea Changepoints în Trend}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_changepoint_detection.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Prophet: Efecte de Sărbători}
    \begin{block}{Modelul de Sărbători}
        ...
        \]
        unde $Z(t)$ este o matrice indicator pentru sărbători și $\bm{\kappa}$ sunt efectele sărbătorilor.
    \end{block}
...
\begin{frame}{Sezonalitate Aditivă vs Multiplicativă}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_additive_vs_multiplicative.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Comparație Prophet vs TBATS: Prognoze}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_prophet_vs_tbats.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Ghid Selecție Model}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{charts/ch9_model_selection_guide.pdf}
    \end{center}
\end{frame}
