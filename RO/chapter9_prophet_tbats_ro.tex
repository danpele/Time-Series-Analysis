...
\begin{frame}{Exemplu: Date Orare cu Sezonalități Multiple}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_multiple_seasonality.pdf}
    \end{center}
\end{frame}

\begin{frame}{Exemplu Real: Cerere de Electricitate}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_electricity_demand.pdf}
    \end{center}
\end{frame}

\begin{frame}{Exemplu Real: Vânzări Retail cu Sărbători}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_retail_sales.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Aproximarea Fourier a Sezonalității}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_fourier_approximation.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Exemplu Descompunere TBATS}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_tbats_decomposition.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Descompunerea Componentelor Prophet}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_prophet_components.pdf}
    \end{center}
\end{frame}

\begin{frame}{Detectarea Changepoints în Trend}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_changepoint_detection.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Sezonalitate Aditivă vs Multiplicativă}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_additive_vs_multiplicative.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Comparație Prophet vs TBATS: Prognoze}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_prophet_vs_tbats.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Ghid Selecție Model}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.82\textheight, keepaspectratio]{ch9_model_selection_guide.pdf}
    \end{center}
\end{frame}
