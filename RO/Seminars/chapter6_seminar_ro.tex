...
\begin{frame}{Test 3: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Trecutul lui $X$ ajută la predicția lui $Y$}
        ...
        \vspace{-0.2cm}
        {\footnotesize
        \textbf{Cheie}: Relație predictivă, \emph{nu} cauzalitate adevărată.
        }
    \end{exampleblock}
...
\begin{frame}{Test 7: Răspuns}
    \begin{exampleblock}{Răspuns: B -- BIC (Criteriul Informațional Bayesian)}
        \textbf{Comparația penalizărilor} (pentru $k$ parametri, $n$ observații):
        \begin{itemize}
            \item AIC: $-2\ln L + 2k$
...
\begin{frame}{Testul 8: Cauzalitate Granger -- Testul Formal}
    \begin{alertblock}{Întrebare}
        ``$X$ cauzează Granger $Y$'' înseamnă:
    \end{alertblock}
...
\begin{frame}{Problema 3: Soluție}
    \begin{exampleblock}{Soluție}
        ...
        \vspace{0.3cm}
        \textbf{Concluzie}: Cauzalitate unidirecțională: Bani $\succ$ PIB
