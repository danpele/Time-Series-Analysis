...
\begin{frame}{Cuprins Seminar}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \vspace{0.15cm}
        \item \textbf{Formule Cheie} -- Formule esențiale
    \end{itemize}
    \end{cminipage}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{align*}
                ...
                &= X_t - 2X_{t-1} + X_{t-2}
            \end{align*}
                \item Aceasta este \textbf{diferența de ordinul doi} a lui $X_t$.
            \end{itemize}
        \end{column}
...
\begin{frame}{Test 2: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Condiția de staționaritate AR(1):} $|\phi| < 1$
                \item Verificarea fiecărei opțiuni:
...
\begin{frame}{Test 3: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Regula cheie de identificare:}
                \item ACF se anulează după lag $q$ $\Rightarrow$ MA($q$)
                \item PACF se anulează după lag $p$ $\Rightarrow$ AR($p$)
                \item Aici: ACF se anulează la lag 1, PACF descrește $\Rightarrow$ \textbf{MA(1)}
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
...
\begin{frame}{Test 4: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            \begin{exampleblock}{Răspuns: C}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Nu este invertibil ($|\theta| = 1.5 > 1$)
                \end{itemize}
            \end{exampleblock}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Invertibilitatea MA(1):} Necesită $|\theta| < 1$
                \item Echivalent: rădăcina lui $\theta(z) = 1 + \theta z = 0$ trebuie să fie în afara cercului unitate.
                \item Aici: $z = -1/1.5 = -0.67$ este \textbf{în interior}.
                \item $\Rightarrow$ \textcolor{Crimson}{\textbf{Nu este invertibil}}
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
            \includegraphics[width=\textwidth]{ch2_ma1.pdf}
...
\begin{frame}{Test 5: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Notația cu polinoame lag:}
...
\begin{frame}{Test 6: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \end{align*}
                \item BIC penalizează complexitatea \textbf{mai mult} decât AIC (pentru $n > 7$).
                \item $\Rightarrow$ BIC favorizează modele mai simple.
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
...
\begin{frame}{Test 7: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            \begin{exampleblock}{Răspuns: C}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Autocorelație semnificativă în reziduuri
                \end{itemize}
            \end{exampleblock}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Testul Ljung-Box:}
                \item $H_0$: Reziduurile sunt zgomot alb
                \item $H_1$: Autocorelație prezentă
                \item valoare-p = 0.02 $<$ 0.05
                \item $\Rightarrow$ \textcolor{Crimson}{\textbf{Respingem $H_0$}}
                \item Modelul este \textbf{inadecvat} --- încercați alte ordine.
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
...
\begin{frame}{Test 8: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Formula de prognoză AR(1):}
            $$\hat{X}_{n+h|n} = \mu + \phi^h(X_n - \mu)$$
                \item Deoarece $|\phi| = 0.6 < 1$:
            $$\lim_{h \to \infty} \phi^h = 0$$
                \item $\Rightarrow$ Prognozele converg la $\mu$. \textbf{Revenire la medie.}
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
...
\begin{frame}{Test 9: Rădăcinile AR(2)}
    \begin{cminipage}{0.95\textwidth}
    \begin{alertblock}{Întrebare}
        Un proces AR(2) are rădăcinile caracteristice (ale $\phi(z) = 1 - \phi_1 z - \phi_2 z^2 = 0$) $z_1 = 0.8$ și $z_2 = -0.5$. Este staționar?
    \end{alertblock}
...
\begin{frame}{Test 9: Răspuns}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            \begin{exampleblock}{Răspuns: C}
                \begin{itemize}\setlength{\itemsep}{0pt}
                    \item Rădăcinile trebuie să fie în afara cercului unitate
                \end{itemize}
            \end{exampleblock}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item \textbf{Condiția de staționaritate:} Rădăcinile lui $\phi(z) = 0$ trebuie să fie \textbf{în afara} cercului unitate ($|z| > 1$).
                \item Aici:
                \item $|z_1| = 0.8 < 1$ \incorrect
                \item $|z_2| = 0.5 < 1$ \incorrect
                \item Ambele în interior $\Rightarrow$ \textcolor{Crimson}{\textbf{Nestaționar}}
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
...
\begin{frame}{Test 10: Proprietățile MA(q)}
    ...
    \vspace{0.5cm}
    \begin{block}{Variante de răspuns}
    \textcolor{MainBlue}{\textbf{(A)}} Descrește exponențial\\[3pt]
    \textcolor{MainBlue}{\textbf{(B)}} Se anulează după lag 2\\[3pt]
    \textcolor{MainBlue}{\textbf{(C)}} Se anulează după lag 1\\[3pt]
    \textcolor{MainBlue}{\textbf{(D)}} Nu se anulează niciodată
    \end{block}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Exercițiul 1: Soluție}
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            {\small Dat: $c = 2$, $\phi = 0.7$, $\sigma^2 = 9$}
...
\begin{frame}{Discuție 2: Evaluarea Prognozei}
    ...
    \vspace{0.3cm}
    \textbf{Indiciu:} Gândiți-vă la Ipoteza Piețelor Eficiente și la ce captează ARMA vs. volatility clustering.
    \end{cminipage}
\end{frame}
...
%=============================================================================
\begin{frame}{Exercițiu de Replicare: Box \& Jenkins (1970)}
    \begin{cminipage}{0.95\textwidth}
        \begin{block}{Obiectiv}
            Replicați analiza seriei ``Airline Passengers'' (seria G din Box \& Jenkins, 1970) cu date actualizate.
        \end{block}
        \begin{enumerate}\setlength{\itemsep}{2pt}
            {\small
            \item Descărcați seria lunară de pasageri aerieni din România (INS sau Eurostat, 2010--2024)
            \item Aplicați transformarea $\ln$ și diferențierea $(1-B)(1-B^{12})$
            \item Identificați ordinul ARIMA folosind ACF/PACF (comparați cu Fig.\ 9.2 din Box \& Jenkins)
            \item Estimați modelul ARIMA$(0,1,1)(0,1,1)_{12}$ --- ``airline model''
            \item Verificați reziduurile: Ljung-Box, normalitate, ACF reziduuri
            \item \textbf{Întrebare}: Modelul airline este încă adecvat pentru date moderne? Ce s-a schimbat?
            }
        \end{enumerate}
        {\tiny Ref: Box, G.E.P.\ \& Jenkins, G.M.\ (1970). \textit{Time Series Analysis: Forecasting and Control}, Holden-Day.}
    \end{cminipage}
\end{frame}
%=============================================================================
% BIBLIOGRAFIE
