...
\begin{frame}[shrink=5]{Exercițiu AI 2: Prompt Refinement pentru ARMA}
    \begin{cminipage}{0.95\textwidth}
    \begin{block}{Sarcina}
...
\begin{frame}{Bibliografie II}
    ...
    \begin{exampleblock}{Resurse online si cod}
        ...
        \begin{itemize}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch2} --- Cod Python pentru fiecare capitol
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
