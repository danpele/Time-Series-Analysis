...
\begin{frame}{Test 1: Ordinul de Integrare}
    ...
    \begin{exampleblock}{Răspuns: C -- $I(2)$}
        ...
        \textbf{În practică}: Nivelurile prețurilor pot fi $I(2)$ când inflația însăși este nestaționară.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Test 2: Proprietățile Mersului Aleatoriu}
    ...
    \begin{exampleblock}{Răspuns: B -- $t \cdot \sigma^2$}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.9\textwidth, height=0.30\textheight, keepaspectratio]{sem3_rw_variance.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 3: Ipotezele Testului ADF}
    ...
    \begin{exampleblock}{Răspuns: B -- Seria are o rădăcină unitară}
        ...
        \textbf{Ipoteze}: $H_0: \gamma = 0$ (rădăcină unitară, nestaționară) vs $H_1: \gamma < 0$ (staționară)
...
\begin{frame}{Test 6: KPSS vs ADF}
    ...
    \begin{exampleblock}{Răspuns: B -- Ipoteze nule inversate}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.33\textheight, keepaspectratio]{sem3_adf_kpss.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 7: Supradiferențierea}
    ...
    \begin{exampleblock}{Răspuns: B -- Autocorelație negativă artificială}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.33\textheight, keepaspectratio]{sem3_overdifferencing.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 9: Puterea Testului de Rădăcină Unitară}
    ...
    \begin{exampleblock}{Răspuns: B -- Rădăcina aproape dar nu egală cu 1}
        ...
        \textbf{Putere scăzută}: Probabilitate mare de eroare de tip II (eșec în respingerea lui $H_0$ fals).
        \textbf{Soluții}: dimensiuni mai mari ale eșantionului, testul Phillips-Perron (robust la heteroscedasticitate), teste de rădăcină unitară pe paneluri (serii multiple).
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Test 10: Selecția Modelului ARIMA}
    ...
    \begin{exampleblock}{Răspuns: B -- ARIMA(0,1,1)}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.32\textheight, keepaspectratio]{sem3_arima_flowchart.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 11: Staționaritate în Trend vs Staționaritate în Diferențe}
    ...
    \begin{exampleblock}{Răspuns: B -- Eliminarea trendului determinist prin regresie}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.30\textheight, keepaspectratio]{sem3_trend_vs_diff.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 12: Invertibilitatea ARIMA}
    ...
    \begin{exampleblock}{Răspuns: C -- Nestaționară și neinvertibilă}
        \textbf{Staționaritate}: $d=1$ înseamnă o rădăcină unitară $\Rightarrow$ \textcolor{Crimson}{Nestaționară}

        \textbf{Invertibilitate}: Polinomul MA este $\theta(z) = 1 + 1.2z$; rădăcină: $z = -1/1.2 = -0.833$ (în interiorul cercului unitate). Invertibilitatea necesită rădăcina în afara cercului unitate, iar $|\theta_1| = 1.2 > 1$ $\Rightarrow$ \textcolor{Crimson}{Neinvertibilă}.
...
\begin{frame}{Test 13: Regresia Falsă}
    ...
    \begin{exampleblock}{Răspuns: B -- $R^2$ ridicat și statistici t semnificative (fals)}
        ...
        \textbf{Simptome}: $R^2$ ridicat (adesea $>$ 0.9) între serii neînrudite, statistici $t$ semnificative, statistică Durbin-Watson foarte scăzută ($\ll 2$), reziduuri nestaționare.
...
\begin{frame}{Test 14: Prognoza pe Termen Lung}
    ...
    \begin{exampleblock}{Răspuns: C -- O extrapolare liniară a trendului}
        ...
        \textbf{Diferențe cheie}: ARMA staționară: prognozele $\to$ media necondiționată;
