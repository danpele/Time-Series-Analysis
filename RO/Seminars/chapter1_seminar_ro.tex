...
\begin{frame}[fragile]{Exercițiu Python 1: Import și Vizualizare\quantlet{TSA\_ch1\_ts\_basics}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch1/TSA\_ch1\_ts\_basics}}
...
\begin{frame}[fragile]{Exercițiu Python 4: Testarea Staționarității\quantlet{TSA\_ch1\_unit\_root\_tests}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch1/TSA\_ch1\_unit\_root\_tests}}
...
\begin{frame}{Studiu de Caz: Indicele S\&P 500\quantlet{TSA\_ch1\_ts\_basics}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch1/TSA\_ch1\_ts\_basics}}
    \begin{columns}[T]
...
\begin{frame}{Descompunerea Seriilor de Timp: Exemplu Real\quantlet{TSA\_ch1\_case\_gdp}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch1/TSA\_ch1\_case\_gdp}}
    \begin{columns}[T]
        \column{0.35\textwidth}
        \begin{block}{Observații}
        {\small
...
\begin{frame}{Testarea Staționarității: Rezultate ADF\quantlet{TSA\_ch1\_unit\_root\_tests}{https://github.com/QuantLet/TSA/tree/main/TSA\_Ch1/TSA\_ch1\_unit\_root\_tests}}
    \begin{columns}[T]
        \column{0.35\textwidth}
        \begin{block}{Observații}
        {\small
...
\begin{frame}{Exercițiu AI: Testarea staționarității cu AI}
    \begin{block}{Sarcina}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Cereți unui AI să testeze staționaritatea pentru indicele S\&P 500 (perioada 2020--2025)
            \item Evaluați critic rezultatul
        \end{itemize}
    \end{block}
    ...
    \begin{enumerate}
        \item \textit{„Testează dacă S\&P 500 este staționar"}
        \item \textit{„Descarcă S\&P 500 2020--2025, aplică ADF și KPSS pe prețuri și randamente, interpretează $H_0$"}
    \end{enumerate}
    ...
    \begin{itemize}\setlength{\itemsep}{1pt}
        \item AI-ul a aplicat testele pe prețuri SAU pe randamente?
        \item A interpretat corect ipotezele nule diferite (ADF vs KPSS)?
        \item A recomandat diferențiere? A verificat staționaritatea post-diferențiere?
        \item A menționat limitările testelor (dimensiunea eșantionului, rupturi structurale)?
    \end{itemize}
\end{frame}

\begin{frame}{Exercițiu AI: Om vs.\ AI --- Prognoză}
    \begin{block}{Sarcina}
        \begin{itemize}\setlength{\itemsep}{0pt}
