...
\begin{frame}{Cuprins Seminar}
    ...
    \vspace{0.3cm}
    {\footnotesize \textit{Notă: Unele întrebări introductive din Seminarul 0 sunt reluate aici pentru consolidare.}}
\end{frame}
...
\begin{frame}{Test 1: Răspuns}
    \begin{exampleblock}{Răspuns: C -- Observațiile sunt independente și identic distribuite}
        \textbf{Întrebare:} Care \emph{nu} este o caracteristică a datelor de tip serie de timp?
...
\begin{frame}{Test 2: Răspuns}
    \begin{exampleblock}{Răspuns: C -- Când fluctuațiile sezoniere cresc proporțional cu nivelul}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.60\textheight, keepaspectratio]{sem1_decomposition.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 4: Răspuns}
    \begin{exampleblock}{Răspuns: C -- Nestaționar deoarece varianța crește cu timpul}
        ...
        \end{itemize}
        Deoarece varianța nu este constantă, procesul încalcă condiția de staționaritate. Soluție: \textbf{diferențierea} dă $\Delta X_t = \varepsilon_t$ care \emph{este} staționară.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Test 7: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Regresie pe timp}
        ...
        \textbf{De ce nu diferențiere?} Diferențierea unui trend determinist dă: $\Delta Y_t = \beta + \Delta\varepsilon_t$, care elimină trendul dar lasă o constantă. Pentru trenduri \textit{stochastice} (rădăcini unitare), diferențierea este corectă.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Test 8: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Seria este probabil nestaționară}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{sem1_acf_decay.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 9: Răspuns}
    \begin{exampleblock}{Răspuns: B -- O componentă de trend}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.60\textheight, keepaspectratio]{sem1_holt_method.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 10: Răspuns}
    \begin{exampleblock}{Răspuns: D -- Normalitatea \emph{nu} este necesară}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{sem1_white_noise.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 11: Răspuns}
    \begin{exampleblock}{Răspuns: C -- Devin mai largi}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.58\textheight, keepaspectratio]{sem1_forecast_intervals.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 13: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Ar încălca ordonarea temporală}
        \vspace{-0.2cm}
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.62\textheight, keepaspectratio]{sem1_timeseries_cv.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Adevărat sau Fals: Răspunsuri (Setul 2)}
    ...
    \begin{enumerate}
        ...
        {\small \textcolor{MediumGray}{Diferențierea elimină trendurile stochastice (rădăcinile unitare).}}

        \vspace{0.15cm}

        \item PACF-ul unui MA(1) se anulează după lag 1. \hfill \textbf{\textcolor{Crimson}{FALS}}

        {\small \textcolor{MediumGray}{ACF-ul se anulează pentru MA. PACF descrește pentru procesele MA.}}
...
\begin{frame}{Studiu de Caz: Indicele S\&P 500}
    \vspace{-0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth, height=0.55\textheight, keepaspectratio]{sp500_prices_returns.pdf}
    \end{center}
    \vspace{-0.2cm}
    {\footnotesize
    \begin{itemize}
