...
\begin{frame}{Cuprins Seminar}
    ...
    \begin{enumerate}
        ...
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{7.}}] \textbf{Exercițiu cu asistență AI} -- Gândire critică
    \end{enumerate}
\end{frame}
...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Folosind yfinance, descarcă datele BTC-USD. E staționară? Dacă nu, fă-o staționară. Pot folosi randamentele pentru a prezice prețul viitor? Arată-mi.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
