...
\begin{frame}{Test 1: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- SARIMA permite o singură perioadă sezonieră}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{ch9_quiz1_multiple_seasonality.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Esențial}: Datele orare au pattern-uri zilnice (24h), săptămânale (168h) și anuale (8760h). Parametrul unic $m$ din SARIMA nu poate captura simultan toate acestea.
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 2: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Trigonometric, Box-Cox, ARMA, Trend, Seasonal}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.38\textheight, keepaspectratio]{ch9_quiz2_tbats_components.pdf}
        \end{center}
        \vspace{-3mm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}\parsep=0pt
            \item \textbf{Componentele TBATS}:
...
\begin{frame}{Test 3: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Permite forme sezoniere mai flexibile}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.35\textheight, keepaspectratio]{ch9_quiz3_fourier_harmonics.pdf}
        \end{center}
        \vspace{-3mm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Compromis}: Mai multe armonice = mai multă flexibilitate dar și mai mulți parametri.
...
\begin{frame}{Test 4: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Trend, sezonalitate, sărbători și eroare}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.40\textheight, keepaspectratio]{ch9_quiz4_prophet_decomposition.pdf}
        \end{center}
        \vspace{-3mm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}\parsep=0pt
            \item \textbf{Modelul Prophet}: $y(t) = g(t) + s(t) + h(t) + \varepsilon_t$
...
\begin{frame}{Test 5: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Sărbători și puncte de schimbare cunoscute}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.38\textheight, keepaspectratio]{ch9_quiz5_prophet_vs_tbats.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Avantaje Prophet}: Integrare ușoară a sărbătorilor, analyst-in-the-loop, gestionează date lipsă, componente interpretabile.
            \item \textbf{Avantaje TBATS}: Selecție automată a modelului, gestionează sezonalitate complexă fără expertiză de domeniu.
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 6: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Sezonalitate multiplicativă}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.46\textheight, keepaspectratio]{ch9_quiz6_seasonality_mode.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Esențial}: Când amplitudinea sezonieră se scalează cu nivelul, folosiți multiplicativ.
            \item \textbf{Aditiv}: $y = g(t) + s(t)$ (efect sezonier constant)
            \item \textbf{Multiplicativ}: $y = g(t) \cdot (1 + s(t))$ (efect sezonier proporțional)
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 7: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Ajustează panta trendului în puncte specifice}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.42\textheight, keepaspectratio]{ch9_quiz7_changepoints.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Puncte de schimbare}: Permit trend liniar pe porțiuni cu pante diferite.
            $g(t) = (k + \mathbf{a}(t)^\top \boldsymbol{\delta}) \cdot t + (m + \mathbf{a}(t)^\top \boldsymbol{\gamma})$
            \item Prophet detectează automat punctele de schimbare sau le puteți specifica manual.
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 8: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: C -- SARIMA standard este suficient}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.46\textheight, keepaspectratio]{ch9_quiz8_model_decision.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Principiul parcimoniei}: Folosiți cel mai simplu model care se potrivește datelor.
            \item Cu doar sezonalitate săptămânală ($m=7$), SARIMA funcționează bine.
            \item Folosiți TBATS/Prophet când \textit{aveți nevoie} de sezonalități multiple sau funcționalități speciale.
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 9: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Eșantionează din distribuția posterioară}
        \begin{center}
            \includegraphics[width=0.85\textwidth, height=0.35\textheight, keepaspectratio]{ch9_quiz9_prophet_uncertainty.pdf}
        \end{center}
        \vspace{-3mm}
        {\scriptsize
        \begin{itemize}\setlength{\itemsep}{0pt}\parsep=0pt
            \item \textbf{Prophet folosește estimare Bayesiană}:
            ...
            \item Notă: implicit, Prophet folosește estimare MAP. Intervalele de predicție provin din simularea punctelor de schimbare viitoare ale trendului și adăugarea variabilității reziduale istorice, nu din eșantionare posterioară completă (MCMC este opțional via \texttt{mcmc\_samples > 0}).
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 10: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: D -- TBATS sau Prophet în funcție de necesități}
        ...
        {\footnotesize
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Ambele pot gestiona sezonalitate multiplă}:
...
\begin{frame}{Problemă 1: Soluție}
    ...
    \begin{exampleblock}{Soluție: 6 parametri}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Fiecare armonică} necesită 2 parametri (coeficienți sinus și cosinus):
        \end{itemize}
        $$s(t) = \sum_{k=1}^{K} \left[ a_k \cos\left(\frac{2\pi k t}{m}\right) + b_k \sin\left(\frac{2\pi k t}{m}\right) \right]$$

        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Cu $K=3$ armonice:
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item $k=1$: $a_1, b_1$ (frecvența fundamentală)
                \item $k=2$: $a_2, b_2$ (prima armonică)
                \item $k=3$: $a_3, b_3$ (a doua armonică)
            \end{itemize}
            \item \textbf{Total}: $2 \times K = 2 \times 3 = 6$ parametri
            \item \textbf{Notă}: Maximum util $K = \lfloor m/2 \rfloor = 3$ pentru $m=7$.
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Problemă 2: Soluție}
    ...
    \begin{exampleblock}{Soluție: Sezonalitate multiplicativă}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Analiză}: Verificați dacă amplitudinea sezonieră este proporțională cu nivelul.
        \end{itemize}
        ...
        \vspace{0.3cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Observație cheie}: \textit{Raportul} rămâne constant (2.5), nu diferența!
            \begin{itemize}\setlength{\itemsep}{0pt}
                \item Aditiv ar însemna: Iulie întotdeauna +600 față de Ianuarie
                \item Dar 2020: $1000 - 400 = 600$; 2023: $2000 - 800 = 1200$
            \end{itemize}
            \item \textbf{Concluzie}: Folosiți multiplicativ: \texttt{seasonality\_mode='multiplicative'}
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
    \quantlet{TSA\_ch9\_additive\_vs\_multiplicative}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_additive_vs_multiplicative}
...
\begin{frame}{Problemă 3: Soluție}
    ...
    \begin{exampleblock}{Soluție}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \end{itemize}
            \item \textbf{Total parametri sezonieri}: $2(K_1 + K_2) = 2(5+3) = 16$
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Problemă 4: Soluție}
    ...
    \begin{exampleblock}{Soluție}
        ...
        \vspace{0.2cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Notă}: Folosiți \texttt{lower\_window=-1, upper\_window=1} pentru a captura efecte pe zile adiacente.
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
    \quantlet{TSA\_ch9\_prophet\_components}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_prophet_components}
...
\begin{frame}{Indicii pentru Soluții}
    ...
    {\footnotesize
    \begin{block}{Indicii}
        \begin{enumerate}\setlength{\itemsep}{1pt}\parsep=0pt
            ...
            \item Pattern-ul are:
                \begin{itemize}\setlength{\itemsep}{0pt}\parsep=0pt\topsep=0pt
...
\begin{frame}{Bibliografie II}
    ...
    \begin{exampleblock}{Resurse Online și Cod}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch9} --- Cod Python pentru acest seminar
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
