...
\begin{frame}{Cuprins Seminar}
    ...
    \begin{enumerate}
        ...
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{4.}}] \textbf{Exemple Rezolvate} -- Soluții detaliate
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{5.}}] \textbf{Subiecte de Discuție} -- Gândire critică
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{6.}}] \textbf{Exerciții cu asistență AI} -- Inteligență artificială aplicată
    \end{enumerate}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Test 1: Răspuns}
    \quantlet{TSA\_ch9\_prophet\_tbats}{https://github.com/QuantLet/TSA/tree/main/TSA_ch9/TSA_ch9_prophet_tbats}
    \begin{exampleblock}{Răspuns: B -- SARIMA permite o singură perioadă sezonieră}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.55\textheight, keepaspectratio]{ch9_quiz1_multiple_seasonality.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 2: Răspuns}
    \vspace{0.1cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.38\textheight, keepaspectratio]{ch9_quiz2_tbats_components.pdf}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Test 3: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Permite forme sezoniere mai flexibile}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.48\textheight, keepaspectratio]{ch9_quiz3_fourier_harmonics.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 4: Răspuns}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.40\textheight, keepaspectratio]{ch9_quiz4_prophet_decomposition.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
    {\small
...
\begin{frame}{Test 5: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Sărbători și puncte de schimbare cunoscute}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.58\textheight, keepaspectratio]{ch9_quiz5_prophet_vs_tbats.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 6: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Sezonalitate multiplicativă}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.58\textheight, keepaspectratio]{ch9_quiz6_seasonality_mode.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 7: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Ajustează panta trendului în puncte specifice}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.52\textheight, keepaspectratio]{ch9_quiz7_changepoints.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 8: Răspuns}
    \begin{exampleblock}{Răspuns: C -- SARIMA standard este suficient}
        \begin{center}
            \includegraphics[width=0.88\textwidth, height=0.58\textheight, keepaspectratio]{ch9_quiz8_model_decision.pdf}
        \end{center}
        \vspace{-0.2cm}
        {\footnotesize
...
\begin{frame}{Test 9: Răspuns}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.42\textheight, keepaspectratio]{ch9_quiz9_prophet_uncertainty.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
    {\small
...
\begin{frame}{Test 10: Răspuns}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.82\textwidth, height=0.42\textheight, keepaspectratio]{ch9_quiz10_energy_example.pdf}
    \end{center}
    \vspace{-0.1cm}
    \begin{block}{Observații}
    {\small
...
\begin{frame}{Adevărat/Fals: Soluții}
    ...
    \begin{enumerate}\setlength{\itemsep}{0pt}
        ...
        \\ \textcolor{MediumGray}{Lansat în 2017, proiectat pentru prognoză „analyst in the loop" la scară largă.}
        \item TBATS poate gestiona cel mult două perioade sezoniere. \hfill \textcolor{Crimson}{\textbf{FALS}}
        \\ \textcolor{MediumGray}{TBATS poate gestiona orice număr de perioade sezoniere (ex. zilnic, săptămânal, anual).}
        \item În Prophet, trendul implicit este creștere logistică. \hfill \textcolor{Crimson}{\textbf{FALS}}
        \\ \textcolor{MediumGray}{Implicit este liniar pe porțiuni. Creșterea logistică trebuie specificată explicit.}
        \item Termenii Fourier aproximează sezonalitatea folosind funcții sinus și cosinus. \hfill \textcolor{Forest}{\textbf{ADEVĂRAT}}
        \\ \textcolor{MediumGray}{$s(t) = \sum_{k=1}^{K}[a_k \cos(2\pi kt/m) + b_k \sin(2\pi kt/m)]$}
        \item Prophet necesită date de serii de timp echidistante. \hfill \textcolor{Crimson}{\textbf{FALS}}
        \\ \textcolor{MediumGray}{Prophet gestionează elegant datele lipsă și timestamp-urile neregulate.}
        \item Transformarea Box-Cox din TBATS stabilizează varianța. \hfill \textcolor{Forest}{\textbf{ADEVĂRAT}}
        \\ \textcolor{MediumGray}{$y^{(\lambda)} = (y^\lambda - 1)/\lambda$ pentru $\lambda \neq 0$; $\log(y)$ pentru $\lambda = 0$.}
    \end{enumerate}
    }
\end{frame}
...
\begin{frame}[shrink=5]{Indicii pentru Soluții}
    \vspace{-0.3cm}
    {\scriptsize
    \begin{block}{Indicii}
...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Folosind Prophet, prognozează traficul lunar pe Wikipedia pentru pagina 'Bitcoin'. Adaugă sărbători și puncte de schimbare. Cât de bună e prognoza?''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
    ...
    \begin{enumerate}\setlength{\itemsep}{0pt}
        ...
        \item AI validează pe un set de test separat sau evaluează doar pe date de antrenare?
        \item Punctele de schimbare sunt detectate automat sau specificate manual?
        \item Sezonalitatea multiplă (săptămânală + anuală) este configurată corect?
        \item Intervalele de incertitudine din Prophet sunt calibrate? AI le verifică?
    \end{enumerate}
    }
    \vspace{-2mm}
    \begin{alertblock}{}
