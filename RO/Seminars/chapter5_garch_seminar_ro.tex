...
\begin{frame}{Cuprins Seminar}
    ...
    \begin{enumerate}
        ...
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{4.}}] \textbf{Flux de lucru Python} -- Implementare practică
        \vspace{0.15cm}
        \item[\textcolor{MainBlue}{\textbf{5.}}] \textbf{Rezumat} -- Sinteză finală
        \vspace{0.15cm}
...
\begin{frame}{Răspuns Întrebarea 1}
    ...
    \begin{block}{Explicație}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_volatility}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_volatility}
\end{frame}
...
\begin{frame}{Răspuns Întrebarea 2}
    ...
    \end{block}
    \quantlet{TSA\_ch5\_garch11}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_garch11}
\end{frame}
...
\begin{frame}{Răspuns Întrebarea 6}
    ...
    \begin{block}{EGARCH(1,1)}
        ...
        \end{itemize}
    \end{block}
    \quantlet{TSA\_ch5\_news\_impact}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_news_impact}
\end{frame}
...
\begin{frame}{Răspuns Întrebarea 8}
    ...
    \end{block}
    \quantlet{TSA\_ch5\_arch\_effect}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_arch_effect}
\end{frame}
...
\begin{frame}{Răspuns Întrebarea 10}
    ...
    \end{block}
    \quantlet{TSA\_ch5\_stylized\_facts}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_stylized_facts}
\end{frame}
...
\begin{frame}{Soluție Problema 1}
    ...
    \end{block}
    \quantlet{TSA\_ch5\_garch11\_params}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_garch11_params}
\end{frame}
...
\begin{frame}{Soluție Problema 3}
    ...
    \end{alertblock}
    \quantlet{TSA\_ch5\_var}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_var}
\end{frame}
...
\end{verbatim}
    \quantlet{TSA\_ch5\_python\_garch}{https://github.com/QuantLet/TSA/tree/main/TSA_ch5/TSA_ch5_python_garch}
\end{frame}
...
\begin{frame}{Exercițiu AI: Gândire critică}
    ...
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        {\footnotesize
        ``Folosind yfinance, descarcă randamentele BTC-USD. Testează efectul ARCH, ajustează un model GARCH(1,1) și calculează VaR la 95\%. Arată-mi rezultatele.''
        }
    \end{block}
    \vspace{-2mm}
    {\footnotesize
    ...
    \begin{enumerate}\setlength{\itemsep}{0pt}
        ...
        \item AI testează pentru efectul ARCH (Ljung-Box pe $r_t^2$) înainte de a ajusta GARCH?
        \item Distribuția inovațiilor este Gaussiană sau Student-t? AI justifică alegerea?
        \item Verificați dacă $\alpha_1 + \beta_1 < 1$ (condiție de staționaritate). AI o verifică?
        \item VaR-ul calculat folosește volatilitatea condiționată sau necondiționată?
    \end{enumerate}
    }
    \vspace{-2mm}
    \begin{alertblock}{}
