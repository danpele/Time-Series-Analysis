...
\begin{frame}{Test 9: Răspuns}
    \begin{exampleblock}{Răspuns: B -- Există cel mult un vector de cointegrare}
        {\footnotesize \textbf{Notă}: (B) descrie ipoteza nulă $H_0: r \leq 1$, ceea ce este ceea ce testul testează. (C) descrie ipoteza alternativă $H_1: r > 1$, nu ceea ce testul ``testează dacă''.}
...
\begin{frame}{Problema 1: Soluție}
    \begin{exampleblock}{Soluție: Da, sunt cointegrate}
        ...
        \vspace{0.2cm}
        \textbf{Interpretare}: Consumul și venitul au un trend comun. Vectorul de cointegrare este aproximativ $(1, -0.85)$, consistent cu ipoteza venitului permanent.
    \end{exampleblock}
    \quantlet{TSA\_ch7\_case\_cointegration}{https://github.com/QuantLet/TSA/tree/main/TSA_ch7/TSA_ch7_case_cointegration}
\end{frame}
