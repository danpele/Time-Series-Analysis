...
\begin{frame}{Cuprins Seminar}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item \textbf{Test: Modele ARFIMA și Memorie Lungă} -- Verificare cunoștințe
        \vspace{0.15cm}
        \item \textbf{Test: Machine Learning pentru Serii de Timp} -- Verificare cunoștințe
        \vspace{0.15cm}
        \item \textbf{Test: Rețele LSTM} -- Verificare cunoștințe
        \vspace{0.15cm}
        ...
        \vspace{0.15cm}
        \item \textbf{Recapitulare} -- Concluzii cheie
    \end{itemize}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Test 1: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Memorie lungă și persistență}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Interpretare Exponent Hurst:}
            \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Test 2: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: C -- Orice valoare reală}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Diferențiere fracționară}: $(1-L)^d$ cu $d \in \mathbb{R}$
            \item \textbf{Interpretare valori $d$:}
            \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \end{itemize}
            \item \textbf{Relația cu Hurst}: $d = H - 0.5$
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 3: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: C -- Volatilitatea}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Fapte stilizate din finanțe:}
            \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \end{itemize}
            \item {\footnotesize Acest fapt stilizat este baza modelelor FIGARCH și HAR-RV.}
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 4: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Caracteristici lag și statistici rolling}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Feature Engineering pentru Serii de Timp:}
            \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \end{itemize}
            \item \textbf{Important}: Transformă problema de prognoză în problemă de regresie supervizată!
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 5: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Încalcă ordinea temporală}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Problema cu k-fold standard:}
            \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \end{itemize}
            \item \textbf{Soluția: Time Series Split (Walk-Forward)}
        \end{itemize}
        \begin{center}
...
\begin{frame}{Test 6: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Identifică caracteristicile predictive}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Utilizări ale importanței variabilelor:}
            \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Test 7: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: B -- Rezolvă problema gradienților}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \end{itemize}
            \item Gradienții pot „curge" prin cell state fără degradare!
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
...
\begin{frame}{Test 9: Răspuns}
    ...
    \begin{exampleblock}{Răspuns: D -- Parametrul $d$}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item $d$ este specific modelelor ARFIMA, nu LSTM!
            \item \textbf{Hiperparametri LSTM:}
            \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \end{itemize}
            \item \textbf{Tuning}: Căutare pe grilă (\emph{grid search}) sau optimizare bayesiană cu validare încrucișată temporală
        \end{itemize}
    \end{exampleblock}
    \end{cminipage}
    \quantlet{TSA\_ch8\_lstm\_architecture}{https://github.com/QuantLet/TSA/tree/main/TSA_ch8/TSA_ch8_lstm_architecture}
...
\begin{frame}{Problemă 3: Cod LSTM}
    ...
    \begin{exampleblock}{Cod Keras/TensorFlow}
        ...
        \texttt{model.fit(X\_train, y\_train, epochs=50, validation\_split=0.1)}
        }
    \end{exampleblock}
...
\begin{frame}{Bibliografie II}
    ...
    \begin{exampleblock}{Resurse Online și Cod}
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item \textbf{GitHub TSA}: \url{https://github.com/QuantLet/TSA/tree/main/TSA_ch8} --- Cod Python pentru acest seminar
        \end{itemize}
        }
    \end{exampleblock}
    \end{cminipage}
