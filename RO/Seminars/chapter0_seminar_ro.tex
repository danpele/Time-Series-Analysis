...
\begin{frame}{Cuprins Seminar}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \vspace{0.15cm}
        \item \textbf{Adevărat/Fals} -- Verificări conceptuale
        \vspace{0.15cm}
...
\begin{frame}{Quiz 2: Răspuns}
    ...
    {\footnotesize
        \begin{block}{Variante de răspuns}
            \textcolor{MainBlue}{\textbf{(A)}} Când tiparul sezonier are amplitudine constantă \incorrect\\[2pt]
            \textcolor{MainBlue}{\textbf{(B)}} Când varianța seriei este stabilă în timp \incorrect\\[2pt]
            \textcolor{MainBlue}{\textbf{(C)}} \textbf{\textcolor{Forest}{Când fluctuațiile sezoniere cresc proporțional cu nivelul}} \correct\\[2pt]
            \textcolor{MainBlue}{\textbf{(D)}} Când seria nu are componentă de trend \incorrect
        \end{block}

        \vspace{0.05cm}

        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.22\textheight, keepaspectratio]{additive_vs_multiplicative.png}
        \end{center}
        \vspace{-0.2cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Quiz 4: Răspuns}
    ...
    {\footnotesize
        \begin{block}{Variante de răspuns}
            \textcolor{MainBlue}{\textbf{(A)}} $X_t, X_{t+1}, X_{t+2}, X_{t+3}, X_{t+4}$ \incorrect\\[2pt]
            \textcolor{MainBlue}{\textbf{(B)}} $X_{t-4}, X_{t-3}, X_{t-2}, X_{t-1}, X_t$ \incorrect\\[2pt]
            \textcolor{MainBlue}{\textbf{(C)}} \textbf{\textcolor{Forest}{$X_{t-2}, X_{t-1}, X_t, X_{t+1}, X_{t+2}$}} \correct\\[2pt]
            \textcolor{MainBlue}{\textbf{(D)}} $X_{t-1}, X_t, X_{t+1}$ \incorrect
        \end{block}

        \vspace{0.05cm}

        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.22\textheight, keepaspectratio]{ch1_moving_average.png}
        \end{center}
        \vspace{-0.2cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
...
\begin{frame}{Quiz 6: Răspuns}
    ...
    {\footnotesize
        \begin{block}{Variante de răspuns}
            \textcolor{MainBlue}{\textbf{(A)}} Datele seriilor de timp sunt prea mici \incorrect\\[2pt]
            \textcolor{MainBlue}{\textbf{(B)}} \textbf{\textcolor{Forest}{Ar încălca ordonarea temporală (viitorul prezicând trecutul)}} \correct\\[2pt]
            \textcolor{MainBlue}{\textbf{(C)}} Validarea încrucișată este întotdeauna invalidă \incorrect\\[2pt]
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth, height=0.22\textheight, keepaspectratio]{ch8_timeseries_cv.png}
        \end{center}
        \vspace{-0.2cm}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Principiu}: datele viitoare nu pot fi folosite pentru a prezice trecutul. Se recomandă CV cu fereastră mobilă/în expansiune.
        \end{itemize}
    }
    \end{exampleblock}
...
\begin{frame}{Adevărat sau Fals? --- Răspunsuri}
    ...
    \begin{tabular}{p{7.5cm}cc}
        ...
        \midrule
        1. Prognozele SES sunt plate (constante pentru toate orizonturile). & \textcolor{Forest}{\textbf{A}} & {\scriptsize Fără trend} \\[0.08cm]
        2. RMSE penalizează erorile mari mai mult decât MAE. & \textcolor{Forest}{\textbf{A}} & {\scriptsize Erori pătratice} \\[0.08cm]
        3. Descompunerea multiplicativă necesită date pozitive. & \textcolor{Forest}{\textbf{A}} & {\scriptsize Nu se poate aplica pe valori negative} \\[0.08cm]
        4. Un $\alpha$ mai mare înseamnă mai multă netezire. & \textcolor{Crimson}{\textbf{F}} & {\scriptsize $\alpha$ mare = mai puțin neted} \\[0.08cm]
        5. Setul de test se folosește pentru ajustarea hiperparametrilor. & \textcolor{Crimson}{\textbf{F}} & {\scriptsize Folosiți validare.} \\[0.08cm]
        6. Naive sezonier folosește valoarea de acum un sezon. & \textcolor{Forest}{\textbf{A}} & {\scriptsize $\hat{X}_{t+h} = X_{t+h-m}$} \\[0.08cm]
        7. MAPE poate fi infinit dacă valorile reale sunt zero. & \textcolor{Forest}{\textbf{A}} & {\scriptsize Împărțire la zero} \\
        \bottomrule
    \end{tabular}
    \end{center}
    \end{cminipage}
