...
\begin{frame}{Exercițiu AI 1: Prompt Engineering}
    \begin{block}{Sarcina}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Scrieți un prompt prin care să cereți unui asistent AI să aplice descompunerea STL pe date lunare de pasageri aerieni
            \item Apoi \textbf{evaluați rezultatul}
        \end{itemize}
    \end{block}

    \vspace{0.3cm}

    \textbf{Comparați aceste prompt-uri:}
    \begin{enumerate}
        \item \textit{``Descompune această serie de timp''}
        \item \textit{``Aplică STL pe AirPassengers, period=12, afișează trend, sezonalitate, reziduu''}
    \end{enumerate}

    \vspace{0.3cm}

    \textbf{Evaluați rezultatul AI:}
    \begin{itemize}
        \item Perioada sezonieră este corectă?
        \item Descompunerea este aditivă sau multiplicativă? Este adecvată?
        \item Reziduurile seamănă cu zgomot alb?
        \item Ați alege o altă metodă? De ce?
    \end{itemize}
\end{frame}

\begin{frame}{Exercițiu AI 2: Găsește erorile}
    \begin{block}{Scenariu}
        {\small Un asistent AI a produs această analiză a prețurilor acțiunilor:}
        \begin{enumerate}
            \item A reprezentat grafic seria brută de prețuri
            \item A calculat ACF --- a găsit autocorelație puternică
            \item A concluzionat: ``autocorelația mare înseamnă prognoză bună''
            \item A aplicat Holt-Winters cu $\alpha=0.9$, $\beta=0.1$
            \item A raportat MAPE = 1.2\% pe setul de antrenare
        \end{enumerate}
    \end{block}

    \vspace{0.3cm}

    \textbf{Identificați toate erorile:}
    \begin{enumerate}
        \item AI-ul a testat staționaritatea? Ce test este necesar?
        \item Este corect că ``ACF mare $\Rightarrow$ prognoză bună''?
        \item Ce implică $\alpha = 0.9$ despre netezire?
        \item De ce MAPE pe setul de antrenare este înșelător?
        \item Ce ar trebui făcut diferit?
    \end{enumerate}
\end{frame}

\begin{frame}{Exercițiu AI 3: Om vs.\ AI --- Prognoză}
    \begin{block}{Sarcina}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item Folosiți setul de date \texttt{AirPassengers} din \texttt{statsmodels}
        \end{itemize}
    \end{block}
    ...
    {\small
    \textbf{Pasul 1 --- Abordare manuală:}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Examinați datele vizual (trend, sezonalitate)
        \item Alegeți tipul de descompunere cu justificare
        \item Aplicați Holt-Winters, selectați parametrii
        \item Evaluați pe setul de test (ultimele 24 de luni)
    \end{itemize}

    \vspace{0.1cm}

    \textbf{Pasul 2 --- Abordare AI:}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Cereți unui AI să ``prognozeze pasagerii aerieni pe 24 de luni''
        \item Înregistrați metodologia și codul AI-ului
    \end{itemize}

    \vspace{0.1cm}

    \textbf{Pasul 3 --- Comparați și reflectați:}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Care abordare a obținut RMSE/MAPE mai mic?
        \item AI-ul a verificat staționaritatea? A folosit o împărțire corectă?
        \item Ce ați observat voi, dar AI-ul a omis (sau invers)?
    \end{itemize}
    }
\end{frame}
