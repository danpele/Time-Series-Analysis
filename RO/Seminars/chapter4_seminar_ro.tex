...
\begin{frame}{Vizual: Diferența Sezonieră}
    ...
    \quantlet{TSA\_ch4\_def\_seasonal\_diff}{https://github.com/QuantLet/TSA/tree/main/TSA_ch4/TSA_ch4_seasonal_diff}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Vizual: Structura Modelului SARIMA}
    ...
    \quantlet{TSA\_ch4\_def\_sarima}{https://github.com/QuantLet/TSA/tree/main/TSA_ch4/TSA_ch4_sarima_model}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Vizual: Modele de Sezonalitate}
    ...
    \quantlet{TSA\_ch4\_def\_seasonality}{https://github.com/QuantLet/TSA/tree/main/TSA_ch4/TSA_ch4_seasonality}
    \end{cminipage}
\end{frame}
...
\begin{frame}{Test 18: Compararea Modelelor}
    ...
    \begin{block}{Variante de răspuns}
        ...
        \textcolor{MainBlue}{\textbf{(B)}} Modelul B ar trebui preferat datorită parsimoniei în ciuda AIC mai mare\\[3pt]
...
\begin{frame}{Analiza ACF/PACF După Diferențiere}
    ...
    \end{cminipage}
    \quantlet{TSA\_ch4\_acf\_pacf}{https://github.com/QuantLet/TSA/tree/main/TSA_ch4/TSA_ch4_acf_seasonality}
\end{frame}
...
\begin{frame}{Exercițiu IA 2: Rafinarea prompturilor pentru SARIMA}
    \begin{cminipage}{0.95\textwidth}
    \begin{block}{Sarcină}
...
\begin{frame}{Ce urmează?}
    ...
    \begin{block}{Seminarul 5: Modele GARCH și Volatilitate}
        \begin{itemize}\setlength{\itemsep}{0pt}
            \item \textbf{Clustering al volatilității}: De ce randamentele financiare au varianță variabilă în timp
            \item \textbf{Modele ARCH/GARCH}: Modelarea heteroscedasticității condiționate
            \item \textbf{Extensii}: EGARCH, GJR-GARCH, efecte de levier
            \item \textbf{Aplicații}: Value-at-Risk și managementul riscului
        \end{itemize}
    \end{block}
    \end{minipage}
    \end{center}
