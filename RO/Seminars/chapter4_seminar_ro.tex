...
\begin{frame}{Test 1: Diferențierea Sezonieră}
    ...
    \begin{exampleblock}{Răspuns: B -- Calculează $Y_t - Y_{t-12}$}
        ...
        \textbf{Efect}: Elimină tiparul sezonier anual stabil
...
\begin{frame}{Test 13: Supradiferențierea}
    ...
    \begin{exampleblock}{Răspuns: B -- Seria a fost supradiferențiată}
        {\small
        \textbf{Semnătură}: ACF la lag 1 $\approx -0.5$ $\Rightarrow$ supradiferențiere la $d$; ACF la lag $s$ $\approx -0.5$ $\Rightarrow$ supradiferențiere la $D$
...
\begin{frame}{Test 16: Componenta AR Sezonieră}
    ...
    \begin{exampleblock}{Răspuns: C -- Persistență sezonieră puternică ($\Phi_1 = 0.8$)}
        ...
        \textbf{Interpretare}: Dependență liniară puternică ($\Phi_1 = 0.8$) de aceeași perioadă din anul trecut. Notă: $\Phi_1$ este un coeficient de regresie, nu $R^2$; autocorelația la lag 12 este $\rho_{12} = \Phi_1 = 0{,}8$
