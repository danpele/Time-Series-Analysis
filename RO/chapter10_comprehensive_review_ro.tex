...
\begin{frame}{Bitcoin: Evaluarea Finală pe Setul de Test}
    \begin{block}{Procedură}
        Reestimăm GARCH(1,1) pe Antrenament + Validare, evaluăm pe \textbf{setul de test păstrat}.
    \end{block}
    ...
    \begin{columns}[T]
        ...
        \begin{tabular}{lc}
            ...
            \midrule
            Volatilitate MAE & 2,64 \\
            Volatilitate RMSE & 2,82 \\
            \bottomrule
        \end{tabular}
        \end{center}
...
\begin{frame}{Sumar: Comparație Modele}
    ...
    \begin{tabular}{lllll}
        ...
        \midrule
        Bitcoin & Clustering volatilitate & GARCH(1,1) & dinamica $\sigma_t^2$ & 2,82 \\
