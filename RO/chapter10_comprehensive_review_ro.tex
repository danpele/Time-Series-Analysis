...
\begin{frame}{GARCH: Prognozele Multi-Step Converg}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{../charts/garch_convergence.pdf}
    \end{center}

    \begin{columns}[T]
        \column{0.5\textwidth}
        \begin{alertblock}{Problema}
            Prognozele GARCH converg la varianța necondiționată $\bar{\sigma}^2 = \frac{\omega}{1-\alpha-\beta}$
        \end{alertblock}

        \column{0.5\textwidth}
        \begin{exampleblock}{Intuiție}
            După un șoc, volatilitatea revine treptat la nivelul mediu pe termen lung.
        \end{exampleblock}
    \end{columns}
\end{frame}
...
\begin{frame}{Șomajul: Ruptura Structurală COVID-19}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{../charts/unemployment.pdf}
    \end{center}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Provocarea}
            \begin{itemize}
                \item Pre-COVID: 3,5\% (minim pe 50 ani)
                \item Aprilie 2020: \textbf{14,8\%} vârf
                \item Cel mai mare salt lunar din istoria SUA
            \end{itemize}
        \end{block}

        \column{0.5\textwidth}
        \begin{exampleblock}{De ce nu ARIMA?}
            ARIMA tratează salturile bruște ca \textbf{outlieri}. Prophet detectează \textbf{puncte de schimbare} și adaptează trendul.
        \end{exampleblock}
    \end{columns}
\end{frame}
...
\begin{frame}{Analiza Cauzalității Granger}
    \begin{columns}[T]
        ...
        \begin{exampleblock}{Concluzii Economice}
            \begin{itemize}
                \item Șomaj $\rightarrow$ PIB ($p=0,045$): Legea Okun
                \item Fed $\rightarrow$ Inflație ($p=0,087$): Politica monetară funcționează
            \end{itemize}
        \end{exampleblock}
    \end{columns}
\end{frame}
