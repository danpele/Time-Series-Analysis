...
\begin{frame}{Seturi de Date Reale pentru Acest Capitol}
    \begin{columns}[T]
        \begin{column}{0.32\textwidth}
            \begin{block}{\textcolor{BitcoinOrange}{Bitcoin} Randamente}
                \begin{itemize}
                    \item Date zilnice crypto
                    \item 2019-2024
                    \item Volatilitate extremă
                    \item ARIMA + GARCH
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.32\textwidth}
            \begin{block}{\textcolor{Orange}{Pete Solare}}
                \begin{itemize}
                    \item Lunar 1990-2023
                    \item Ciclu clasic de 11 ani
                    \item Sezonalitate lungă
                    \item Analiză SARIMA
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.32\textwidth}
            \begin{block}{\textcolor{MainBlue}{Șomaj SUA}}
                \begin{itemize}
                    \item Lunar 2015-2023
                    \item Bureau of Labor Stats
                    \item Șocul COVID-19
                    \item Rupturi structurale
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
