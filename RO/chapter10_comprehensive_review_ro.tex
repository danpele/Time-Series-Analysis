...
\subtitle{Analiză Completă a Seriilor de Timp cu Date Reale}
...
\begin{frame}{Step 1: Staționaritate Testing}
    \begin{columns}[T]
...
\begin{frame}{Step 3: ARIMA Model for Returns}
    \textbf{Selecția Modelului using AIC/BIC:}
...
\begin{frame}{Step 1: Descompunere Analysis}
    \begin{center}
...
%=============================================================================
\section{Selecția Modelului: A Practical Guide}
...
\begin{frame}{Selecția Modelului Summary}
    \begin{table}[h]
        \footnotesize
        \centering
...
\begin{frame}{Recomandări Finale}
    \begin{enumerate}
        ...
        \item \textbf{Test Assumptions}: Staționaritate, normality, independence
