...
\begin{frame}{Bitcoin: Clustering-ul Volatilității}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../charts/btc_returns.pdf}
    \end{center}

    \vspace{0.2cm}

    \begin{exampleblock}{Observație}
        Randamentele mari (pozitive sau negative) tind să fie urmate de randamente mari, iar cele mici de cele mici. Acesta este \textbf{clustering-ul volatilității}---fenomenul cheie pe care modelele GARCH îl captează.
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Prognoza GARCH: Rolling vs Multi-Step}
    \begin{columns}[T]
        ...
        \begin{alertblock}{De ce Rolling One-Step-Ahead?}
            ...
            \end{equation}
            Aceasta produce o \textbf{linie dreaptă}!
        \end{alertblock}

        \vspace{0.2cm}

        \begin{block}{Multi-Step}
            \begin{itemize}
                \item Converge la $\bar{\sigma}^2$
                \item \textcolor{Crimson}{Prognoză linie dreaptă}
            \end{itemize}
        \end{block}

        \begin{exampleblock}{Rolling 1-Step}
            \begin{itemize}
        ...
        \begin{center}
            \includegraphics[width=\textwidth]{../charts/rolling_vs_multistep.pdf}
        \end{center}
    \end{columns}
\end{frame}
