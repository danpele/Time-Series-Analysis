...
\begin{frame}{Tipuri de Nestaționaritate}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Trend Determinist}
                ...
                \begin{itemize}
                    ...
                    \item Poate fi eliminat prin \textbf{detrendare}
                    \item Șocurile au efecte temporare
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{block}{Trend Stocastic (Rădăcină Unitate)}
    ...
    \begin{alertblock}{Distincție Cheie}
        Identificarea corectă este crucială: detrendarea unui proces cu rădăcină unitate sau diferențierea unui proces staționar cu trend duc ambele la specificare greșită!
    \end{alertblock}
\end{frame}
...
\begin{frame}{Vizualizarea Diferenței}
    ...
    \begin{itemize}
        ...
        \item \textbf{Dreapta}: Trend stocastic -- șocurile se acumulează permanent
...
\begin{frame}{Exemplu ARIMA(1,1,0)}
    ...
    \begin{block}{Interpretare}
        \begin{itemize}\setlength{\itemsep}{0pt}
            ...
            \item $Y_t$ în sine are un trend stocastic
...
%=============================================================================
\section{Aplicație pe Date Reale: PIB SUA}

\begin{frame}{PIB Real SUA: O Serie Nestaționară}
    \vspace{-0.3cm}
    \begin{center}
    ...
    {\small
    \begin{itemize}
        \item Trend ascendent clar -- nestaționar în niveluri
        \item Necesită diferențiere înainte de modelarea ARMA
    \end{itemize}
    }
\end{frame}

\begin{frame}{Efectul Diferențierii}
    \vspace{-0.3cm}
    \begin{center}
    ...
    {\small
    \begin{itemize}
        \item \textbf{Stânga}: PIB în niveluri -- nestaționar (trend clar)
        \item \textbf{Dreapta}: Rata de creștere PIB -- staționară (fluctuează în jurul mediei)
    \end{itemize}
    }
\end{frame}
