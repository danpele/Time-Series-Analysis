...
\begin{frame}{Quiz 2: Solution}
    \textbf{Answer: C -- $\phi = -0.8$ (Stationary)}
...
\begin{frame}{Quiz 4: Solution}
    \textbf{Answer: C -- Not invertible ($|\theta| = 1.5 > 1$)}
...
\begin{frame}{Quiz 6: Solution}
    \textbf{Answer: C -- Lower BIC is preferred}
...
\begin{frame}{Quiz 9: AR(2) Roots}
    \textbf{Question:} An AR(2) process has characteristic roots $z_1 = 0.8$ and $z_2 = -0.5$. Is it stationary?
...
\begin{frame}{Quiz 9: Solution}
    ...
    \vspace{0.3cm}
    \textbf{Explanation:} For AR stationarity, roots of $\phi(z) = 0$ must lie \textbf{outside} the unit circle, i.e., $|z| > 1$.
...
\begin{frame}{Quiz 10: Solution}
    ...
    \vspace{0.3cm}
    \textbf{Explanation:} For MA($q$), the ACF is exactly zero for lags $> q$.
...
\begin{frame}{Quiz 11: ARMA Parsimony}
    \textbf{Question:} Why might ARMA(1,1) be preferred over AR(5) even if both fit equally well?
...
\begin{frame}{Quiz 11: Solution}
    ...
    \vspace{0.3cm}
    \textbf{Explanation:} Parsimony principle: prefer simpler models.
...
\begin{frame}{Quiz 12: Residual Diagnostics}
    \textbf{Question:} After fitting an ARMA model, the residual ACF shows a significant spike at lag 5. This suggests:
...
\begin{frame}{Quiz 12: Solution}
    ...
    \vspace{0.3cm}
    \textbf{Explanation:} Good residuals should be white noise with no significant ACF.
...
\begin{frame}{Quiz 13: Wold Decomposition}
    \textbf{Question:} The Wold decomposition theorem states that any stationary process can be written as:
...
\begin{frame}{Quiz 13: Solution}
    ...
    \vspace{0.3cm}
    \textbf{Explanation:} Wold's theorem: Any stationary process can be written as:
...
\begin{frame}{Quiz 14: Unit Root vs Trend Stationary}
    \textbf{Question:} How do you make a unit root process stationary?
